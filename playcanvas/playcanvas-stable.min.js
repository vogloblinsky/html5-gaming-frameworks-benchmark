...
b||e.splice(c,1))}else this._callbacks[e]&&delete this._callbacks[e];else this._callbacks=null;return this},fire:function(e,a,b,c,d,f,g,h,p){if(!e||!this._callbacks||!this._callbacks[e])return this;var l;this._callbackActive||(this._callbackActive={});this._callbackActive[e]?(this._callbackActive[e]===this._callbacks[e]&&(this._callbackActive[e]=this._callbackActive[e].slice()),l=this._callbacks[e].slice()):this._callbackActive[e]=this._callbacks[e];for(var k=0;k<(l||this._callbackActive[e]).length;k++){var m=
(l||this._callbackActive[e])[k];m.callback.call(m.scope,a,b,c,d,f,g,h,p);m.callback.once&&(m=this._callbacks[e].indexOf(m),-1!==m&&(this._callbackActive[e]===this._callbacks[e]&&(this._callbackActive[e]=this._callbackActive[e].slice()),this._callbacks[e].splice(m,1)))}l||(this._callbackActive[e]=null);return this},once:function(e,a,b){a.once=!0;this.on(e,a,b);return this},hasEvent:function(e){return this._callbacks&&this._callbacks[e]&&0!==this._callbacks[e].length}};pc.extend(pc,function(){var e=function(a){this._index={};this._key=a||null};e.prototype={addItem:function(a){for(var b=a.tags._list,d=0;d<b.length;d++)this.add(b[d],a)},removeItem:function(a){for(var b=a.tags._list,d=0;d<b.length;d++)this.remove(b[d],a)},add:function(a,c){this._index[a]&&-1!==this._index[a].list.indexOf(c)||(this._index[a]||(this._index[a]={list:[]},this._key&&(this._index[a].keys={})),this._index[a].list.push(c),this._key&&(this._index[a].keys[c[this._key]]=c))},remove:function(a,
c){if(this._index[a]&&(!this._key||this._index[a].keys[c[this._key]])){var b=this._index[a].indexOf(c);-1!==b&&(this._index[a].list.splice(b,1),this._key&&delete this._index[a].keys[c[this._key]],0===this._index[a].list.length&&delete this._index[a])}},find:function(a){var b=this,d={},f=[],g,h,e,l,k,m=function(a,c){return b._index[a].list.length-b._index[c].list.length};for(g=0;g<a.length;g++){l=a[g];if(l instanceof Array){if(0===l.length)continue;if(1===l.length)l=l[0];else{e=!1;for(h=0;h<l.length;h++)if(!this._index[l[h]]){e=
!0;break}if(e)continue;l=l.slice(0).sort(m);k=l.slice(1);1===k.length&&(k=k[0]);for(h=0;h<this._index[l[0]].list.length;h++)e=this._index[l[0]].list[h],(this._key?!d[e[this._key]]:-1===f.indexOf(e))&&e.tags.has(k)&&(this._key&&(d[e[this._key]]=!0),f.push(e));continue}}if(l&&"string"===typeof l&&this._index[l])for(h=0;h<this._index[l].list.length;h++)e=this._index[l].list[h],this._key?d[e[this._key]]||(d[e[this._key]]=!0,f.push(e)):-1===f.indexOf(e)&&f.push(e)}return f}};var a=function(a){this._index=
...
9!==b?", ":"";return a+"]"},transpose:function(){var a=this.data,b;b=a[1];a[1]=a[3];a[3]=b;b=a[2];a[2]=a[6];a[6]=b;b=a[5];a[5]=a[7];a[7]=b;return this}};Object.defineProperty(e,"IDENTITY",{get:function(){var a=new e;return function(){return a}}()});Object.defineProperty(e,"ZERO",{get:function(){var a=new e(0,0,0,0,0,0,0,0,0);return function(){return a}}()});return{Mat3:e}}());pc.extend(pc,function(){var e=function(a,b,c,d,f,g,h,e,l,k,m,q,n,r,u,v){a&&16===a.length?this.data=new Float32Array(a):(this.data=new Float32Array(16),"number"===typeof a?(this.data[0]=a,this.data[1]=b,this.data[2]=c,this.data[3]=d,this.data[4]=f,this.data[5]=g,this.data[6]=h,this.data[7]=e,this.data[8]=l,this.data[9]=k,this.data[10]=m,this.data[11]=q,this.data[12]=n,this.data[13]=r,this.data[14]=u,this.data[15]=v):this.setIdentity())};e.prototype={add2:function(a,b){var c=a.data,d=b.data,f=this.data;
...
1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]},mul2:function(a,b){var c,d,f,g,h,e,l,k,m,q,n,r,u,v,A,z,t,w,y,x;z=a.data;var B=b.data,C=this.data;c=z[0];d=z[1];f=z[2];g=z[3];h=z[4];e=z[5];l=z[6];k=z[7];m=z[8];q=z[9];n=z[10];r=z[11];u=z[12];v=z[13];A=z[14];z=z[15];t=B[0];w=B[1];y=B[2];x=B[3];C[0]=c*t+h*w+m*y+u*x;C[1]=d*t+e*w+q*y+v*x;C[2]=f*t+l*w+n*y+A*x;C[3]=g*t+k*w+r*y+z*x;t=B[4];w=B[5];y=B[6];x=B[7];C[4]=c*t+h*w+m*y+u*x;C[5]=d*t+e*w+q*y+v*x;C[6]=f*t+l*w+n*y+A*x;C[7]=g*t+k*w+r*y+
z*x;t=B[8];w=B[9];y=B[10];x=B[11];C[8]=c*t+h*w+m*y+u*x;C[9]=d*t+e*w+q*y+v*x;C[10]=f*t+l*w+n*y+A*x;C[11]=g*t+k*w+r*y+z*x;t=B[12];w=B[13];y=B[14];x=B[15];C[12]=c*t+h*w+m*y+u*x;C[13]=d*t+e*w+q*y+v*x;C[14]=f*t+l*w+n*y+A*x;C[15]=g*t+k*w+r*y+z*x;return this},mul:function(a){return this.mul2(this,a)},transformPoint:function(a,b){var c=this.data,d=a.data;b=void 0===b?new pc.Vec3:b;return b.set(d[0]*c[0]+d[1]*c[4]+d[2]*c[8]+c[12],d[0]*c[1]+d[1]*c[5]+d[2]*c[9]+c[13],d[0]*c[2]+d[1]*c[6]+d[2]*c[10]+c[14])},transformVector:function(a,
...
f,g){c.sub2(d,f).normalize();b.copy(g).normalize();a.cross(b,c).normalize();b.cross(c,a);f=this.data;f[0]=a.x;f[1]=a.y;f[2]=a.z;f[3]=0;f[4]=b.x;f[5]=b.y;f[6]=b.z;f[7]=0;f[8]=c.x;f[9]=c.y;f[10]=c.z;f[11]=0;f[12]=d.x;f[13]=d.y;f[14]=d.z;f[15]=1;return this}}(),setFrustum:function(a,b,c,d,f,g){var h,e,l,k,m;h=2*f;e=b-a;l=d-c;k=g-f;m=this.data;m[0]=h/e;m[1]=0;m[2]=0;m[3]=0;m[4]=0;m[5]=h/l;m[6]=0;m[7]=0;m[8]=(b+a)/e;m[9]=(d+c)/l;m[10]=(-g-f)/k;m[11]=-1;m[12]=0;m[13]=0;m[14]=-h*g/k;m[15]=0;return this},
setPerspective:function(a,b,c,d,f){f?(a=c*Math.tan(a*Math.PI/360),f=a/b):(f=c*Math.tan(a*Math.PI/360),a=f*b);return this.setFrustum(-a,a,-f,f,c,d)},setOrtho:function(a,b,c,d,f,g){var h=this.data;h[0]=2/(b-a);h[1]=0;h[2]=0;h[3]=0;h[4]=0;h[5]=2/(d-c);h[6]=0;h[7]=0;h[8]=0;h[9]=0;h[10]=-2/(g-f);h[11]=0;h[12]=-(b+a)/(b-a);h[13]=-(d+c)/(d-c);h[14]=-(g+f)/(g-f);h[15]=1;return this},setFromAxisAngle:function(a,b){var c,d,f,g,h,e,l,k,m;b*=pc.math.DEG_TO_RAD;c=a.x;d=a.y;f=a.z;g=Math.cos(b);h=Math.sin(b);e=
1-g;l=e*c;k=e*d;m=this.data;m[0]=l*c+g;m[1]=l*d+h*f;m[2]=l*f-h*d;m[3]=0;m[4]=l*d-h*f;m[5]=k*d+g;m[6]=k*f+h*c;m[7]=0;m[8]=l*f+h*d;m[9]=k*f-c*h;m[10]=e*f*f+g;m[11]=0;m[12]=0;m[13]=0;m[14]=0;m[15]=1;return this},setTranslate:function(a,b,c){var d=this.data;d[0]=1;d[1]=0;d[2]=0;d[3]=0;d[4]=0;d[5]=1;d[6]=0;d[7]=0;d[8]=0;d[9]=0;d[10]=1;d[11]=0;d[12]=a;d[13]=b;d[14]=c;d[15]=1;return this},setScale:function(a,b,c){var d=this.data;d[0]=a;d[1]=0;d[2]=0;d[3]=0;d[4]=0;d[5]=b;d[6]=0;d[7]=0;d[8]=0;d[9]=0;d[10]=
c;d[11]=0;d[12]=0;d[13]=0;d[14]=0;d[15]=1;return this},invert:function(){var a,b,c,d,f,g,h,e,l,k,m,q,n,r,u,v,A,z,t,w,y,x,B,C,F,K,L,J,G,D;D=this.data;a=D[0];b=D[1];c=D[2];d=D[3];f=D[4];g=D[5];h=D[6];e=D[7];l=D[8];k=D[9];m=D[10];q=D[11];n=D[12];r=D[13];u=D[14];v=D[15];A=a*g-b*f;z=a*h-c*f;t=a*e-d*f;w=b*h-c*g;y=b*e-d*g;x=c*e-d*h;B=l*r-k*n;C=l*u-m*n;F=l*v-q*n;K=k*u-m*r;L=k*v-q*r;J=m*v-q*u;G=A*J-z*L+t*K+w*F-y*C+x*B;0===G?this.setIdentity():(G=1/G,D[0]=(g*J-h*L+e*K)*G,D[1]=(-b*J+c*L-d*K)*G,D[2]=(r*x-u*y+
v*w)*G,D[3]=(-k*x+m*y-q*w)*G,D[4]=(-f*J+h*F-e*C)*G,D[5]=(a*J-c*F+d*C)*G,D[6]=(-n*x+u*t-v*z)*G,D[7]=(l*x-m*t+q*z)*G,D[8]=(f*L-g*F+e*B)*G,D[9]=(-a*L+b*F-d*B)*G,D[10]=(n*y-r*t+v*A)*G,D[11]=(-l*y+k*t-q*A)*G,D[12]=(-f*K+g*C-h*B)*G,D[13]=(a*K-b*C+c*B)*G,D[14]=(-n*w+r*z-u*A)*G,D[15]=(l*w-k*z+m*A)*G);return this},set:function(a){var b=this.data;b[0]=a[0];b[1]=a[1];b[2]=a[2];b[3]=a[3];b[4]=a[4];b[5]=a[5];b[6]=a[6];b[7]=a[7];b[8]=a[8];b[9]=a[9];b[10]=a[10];b[11]=a[11];b[12]=a[12];b[13]=a[13];b[14]=a[14];b[15]=
a[15];return this},setIdentity:function(){var a=this.data;a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return this},setTRS:function(a,b,c){var d,f,g,h,e,l,k,m,q,n,r,u,v;d=a.x;f=a.y;a=a.z;g=b.x;h=b.y;e=b.z;l=b.w;b=c.x;k=c.y;c=c.z;m=g+g;q=h+h;n=e+e;r=g*m;u=g*q;g*=n;v=h*q;h*=n;e*=n;m*=l;q*=l;l*=n;n=this.data;n[0]=(1-(v+e))*b;n[1]=(u+l)*b;n[2]=(g-q)*b;n[3]=0;n[4]=(u-l)*k;n[5]=(1-(r+e))*k;n[6]=(h+m)*k;n[7]=0;n[8]=(g+q)*c;n[9]=(h-
m)*c;n[10]=(1-(r+v))*c;n[11]=0;n[12]=d;n[13]=f;n[14]=a;n[15]=1;return this},transpose:function(){var a,b=this.data;a=b[1];b[1]=b[4];b[4]=a;a=b[2];b[2]=b[8];b[8]=a;a=b[3];b[3]=b[12];b[12]=a;a=b[6];b[6]=b[9];b[9]=a;a=b[7];b[7]=b[13];b[13]=a;a=b[11];b[11]=b[14];b[14]=a;return this},invertTo3x3:function(a){var b,c,d,f,g,h,e,l,k,m;b=this.data;a=a.data;m=b[0];var q=b[1],n=b[2];k=b[4];var r=b[5];h=b[6];l=b[8];var u=b[9];g=b[10];b=g*r-h*u;c=-g*q+n*u;d=h*q-n*r;f=-g*k+h*l;g=g*m-n*l;h=-h*m+n*k;e=u*k-r*l;l=-u*
m+q*l;k=r*m-q*k;m=m*b+q*f+n*e;if(0===m)return console.warn("pc.Mat4#invertTo3x3: Matrix not invertible"),this;m=1/m;a[0]=m*b;a[1]=m*c;a[2]=m*d;a[3]=m*f;a[4]=m*g;a[5]=m*h;a[6]=m*e;a[7]=m*l;a[8]=m*k;return this},getTranslation:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[12],this.data[13],this.data[14])},getX:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[0],this.data[1],this.data[2])},getY:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[4],this.data[5],
...
c+d*b*g;this.z=a*b*g-d*f*c;this.w=a*b*c+d*f*g;return this},setFromMat4:function(a){var b,c,d,f,g,h,e,l,k,m,q;a=a.data;b=a[0];c=a[1];d=a[2];f=a[4];g=a[5];h=a[6];e=a[8];l=a[9];a=a[10];k=1/Math.sqrt(b*b+c*c+d*d);m=1/Math.sqrt(f*f+g*g+h*h);q=1/Math.sqrt(e*e+l*l+a*a);b*=k;c*=k;d*=k;f*=m;g*=m;h*=m;e*=q;l*=q;a*=q;k=b+g+a;0<=k?(b=Math.sqrt(k+1),this.w=.5*b,b=.5/b,this.x=(h-l)*b,this.y=(e-d)*b,this.z=(c-f)*b):b>g?b>a?(b=Math.sqrt(b-(g+a)+1),this.x=.5*b,b=.5/b,this.w=(h-l)*b,this.y=(c+f)*b,this.z=(d+e)*b):
(b=Math.sqrt(a-(b+g)+1),this.z=.5*b,b=.5/b,this.w=(c-f)*b,this.x=(e+d)*b,this.y=(l+h)*b):g>a?(b=Math.sqrt(g-(a+b)+1),this.y=.5*b,b=.5/b,this.w=(e-d)*b,this.z=(h+l)*b,this.x=(f+c)*b):(b=Math.sqrt(a-(b+g)+1),this.z=.5*b,b=.5/b,this.w=(c-f)*b,this.x=(e+d)*b,this.y=(l+h)*b);return this},slerp:function(a,b,c){var d,f,g,h,e,l;d=a.x;f=a.y;g=a.z;a=a.w;h=b.x;e=b.y;l=b.z;b=b.w;var k=a*b+d*h+f*e+g*l;0>k&&(b=-b,h=-h,e=-e,l=-l,k=-k);if(1<=Math.abs(k))return this.w=a,this.x=d,this.y=f,this.z=g,this;var m=Math.acos(k),
q=Math.sqrt(1-k*k);if(.001>Math.abs(q))return this.w=.5*a+.5*b,this.x=.5*d+.5*h,this.y=.5*f+.5*e,this.z=.5*g+.5*l,this;k=Math.sin((1-c)*m)/q;c=Math.sin(c*m)/q;this.w=a*k+b*c;this.x=d*k+h*c;this.y=f*k+e*c;this.z=g*k+l*c;return this},transformVector:function(a,b){void 0===b&&(b=new pc.Vec3);var c=a.x,d=a.y,f=a.z,g=this.x,h=this.y,e=this.z,l=this.w,k=l*c+h*f-e*d,m=l*d+e*c-g*f,q=l*f+g*d-h*c,c=-g*c-h*d-e*f;b.x=k*l+c*-g+m*-e-q*-h;b.y=m*l+c*-h+q*-g-k*-e;b.z=q*l+c*-e+k*-h-m*-g;return b},toString:function(){return"["+
...
A-t;A+=t;t=r-w;r+=w;a<u&&(u=a);v>c&&(c=v);z<e&&(e=z);A>d&&(d=A);t<n&&(n=t);r>f&&(f=r);b[0]=.5*(u+c);b[1]=.5*(e+d);b[2]=.5*(n+f);g[0]=.5*(c-u);g[1]=.5*(d-e);g[2]=.5*(f-n)},copy:function(a){this.center.copy(a.center);this.halfExtents.copy(a.halfExtents);this.type=a.type},clone:function(){return new pc.BoundingBox(this.center.clone(),this.halfExtents.clone())},intersects:function(a){var b=this.getMax(),c=this.getMin(),d=a.getMax();a=a.getMin();return c.x<=d.x&&b.x>=a.x&&c.y<=d.y&&b.y>=a.y&&c.z<=d.z&&
b.z>=a.z},_intersectsRay:function(d,f){for(var h=e.copy(this.getMin()).sub(d.origin).data,g=a.copy(this.getMax()).sub(d.origin).data,k=d.direction.data,m=0;3>m;m++)0===k[m]?(h[m]=0>h[m]?-Number.MAX_VALUE:Number.MAX_VALUE,g[m]=0>g[m]?-Number.MAX_VALUE:Number.MAX_VALUE):(h[m]/=k[m],g[m]/=k[m]);k=b.set(Math.min(h[0],g[0]),Math.min(h[1],g[1]),Math.min(h[2],g[2])).data;h=c.set(Math.max(h[0],g[0]),Math.max(h[1],g[1]),Math.max(h[2],g[2])).data;g=Math.max(Math.max(k[0],k[1]),k[2]);(h=Math.min(Math.min(h[0],
h[1]),h[2])>=g&&0<=g)&&f.copy(d.direction).scale(g).add(d.origin);return h},_fastIntersectsRay:function(f){var h=f.direction;e.sub2(f.origin,this.center);c.set(Math.abs(e.x),Math.abs(e.y),Math.abs(e.z));b.mul2(e,h);if(c.x>this.halfExtents.x&&0<=b.x||c.y>this.halfExtents.y&&0<=b.y||c.z>this.halfExtents.z&&0<=b.z)return!1;d.set(Math.abs(h.x),Math.abs(h.y),Math.abs(h.z));a.cross(h,e);a.set(Math.abs(a.x),Math.abs(a.y),Math.abs(a.z));return a.x>this.halfExtents.y*d.z+this.halfExtents.z*d.y||a.y>this.halfExtents.x*
...
g.normalize?!1:g.normalize,size:g.components*e[g.type]};this.elements.push(f);this.size+=f.size;g.semantic===pc.SEMANTIC_TEXCOORD0?this.hasUv0=!0:g.semantic===pc.SEMANTIC_TEXCOORD1?this.hasUv1=!0:g.semantic===pc.SEMANTIC_COLOR&&(this.hasColor=!0)}c=g=0;for(d=this.elements.length;c<d;c++)f=this.elements[c],f.offset=g,f.stride=this.size,g+=f.size}}}());pc.extend(pc,function(){var e=function(a,b,c,d,f){this.usage=d||pc.BUFFER_STATIC;this.format=b;this.numVertices=c;this.numBytes=b.size*c;a._vram.vb+=this.numBytes;this.device=a;this.bufferId=this.device.gl.createBuffer();f&&this.setData(f)||(this.storage=new ArrayBuffer(this.numBytes))};e.prototype={destroy:function(){if(this.bufferId){var a=this.device,b=a.gl;b.deleteBuffer(this.bufferId);a._vram.vb-=this.storage.byteLength;this.bufferId=null;a.boundBuffer=null;a.vertexBuffers.length=0;a.vbOffsets.length=
0;a.attributesInvalidated=!0;for(var c in a.enabledAttributes)b.disableVertexAttribArray(c);a.enabledAttributes={}}},getFormat:function(){return this.format},getUsage:function(){return this.usage},getNumVertices:function(){return this.numVertices},lock:function(){return this.storage},unlock:function(){var a=this.device.gl,b;switch(this.usage){case pc.BUFFER_STATIC:b=a.STATIC_DRAW;break;case pc.BUFFER_DYNAMIC:b=a.DYNAMIC_DRAW;break;case pc.BUFFER_STREAM:b=a.STREAM_DRAW;break;case pc.BUFFER_GPUDYNAMIC:b=
this.device.webgl2?a.DYNAMIC_COPY:a.STATIC_DRAW}a.bindBuffer(a.ARRAY_BUFFER,this.bufferId);a.bufferData(a.ARRAY_BUFFER,this.storage,b)},setData:function(a){if(a.byteLength!==this.numBytes)return console.error("VertexBuffer: wrong initial data size: expected "+this.numBytes+", got "+a.byteLength),!1;this.storage=a;this.unlock();return!0}};return{VertexBuffer:e}}());pc.extend(pc,function(){var e=function(a,b,c,d){this.usage=d||pc.BUFFER_STATIC;this.format=b;this.numIndices=c;this.device=a;c=this.device.gl;this.bufferId=c.createBuffer();var f;b===pc.INDEXFORMAT_UINT8?(f=1,this.glFormat=c.UNSIGNED_BYTE):b===pc.INDEXFORMAT_UINT16?(f=2,this.glFormat=c.UNSIGNED_SHORT):b===pc.INDEXFORMAT_UINT32&&(f=4,this.glFormat=c.UNSIGNED_INT);this.bytesPerIndex=f;b=this.numIndices*f;this.storage=new ArrayBuffer(b);a._vram.ib+=b};e.prototype={destroy:function(){this.bufferId&&(this.device.gl.deleteBuffer(this.bufferId),
this.device._vram.ib-=this.storage.byteLength,this.bufferId=null,this.device.indexBuffer===this&&(this.device.indexBuffer=null))},getFormat:function(){return this.format},getNumIndices:function(){return this.numIndices},lock:function(){return this.storage},unlock:function(){var a=this.device.gl,b;switch(this.usage){case pc.BUFFER_STATIC:b=a.STATIC_DRAW;break;case pc.BUFFER_DYNAMIC:b=a.DYNAMIC_DRAW;break;case pc.BUFFER_STREAM:b=a.STREAM_DRAW;break;case pc.BUFFER_GPUDYNAMIC:b=this.device.webgl2?a.DYNAMIC_COPY:
a.STATIC_DRAW}a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,this.bufferId);a.bufferData(a.ELEMENT_ARRAY_BUFFER,this.storage,b)}};return{IndexBuffer:e}}());pc.extend(pc,function(){var e=function(a,b){b=b||pc.BUFFER_GPUDYNAMIC;this.device=a.device;var c=this.device.gl;this._inputBuffer=a;b===pc.BUFFER_GPUDYNAMIC&&a.usage!==b&&(c.bindBuffer(c.ARRAY_BUFFER,a.bufferId),c.bufferData(c.ARRAY_BUFFER,a.storage,c.DYNAMIC_COPY));this._outputBuffer=new pc.VertexBuffer(a.device,a.format,a.numVertices,b,a.storage)};e.createShader=function(a,b,c){return pc.shaderChunks.createShaderFromCode(a,b,null,c,!0)};e.prototype={destroy:function(){this._outputBuffer.destroy()},
...
uploadTexture:function(a){var b=this.gl;if(a._needsUpload||!(a._needsMipmapsUpload&&a._mipmapsUploaded||!a._pot)){for(var c=0,d,f;a._levels[c]||0===c;){if(a._needsUpload||0!==c){if(c&&(!a._needsMipmapsUpload||!a._mipmaps))break;d=a._levels[c];1!=c||a._compressed||(b.generateMipmap(a._glTarget),a._mipmapsUploaded=!0);if(a._cubemap){var h;b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,!1);b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1);if(d[0]instanceof HTMLCanvasElement||d[0]instanceof HTMLImageElement||d[0]instanceof
HTMLVideoElement)for(h=0;6>h;h++)a._levelsUpdated[0][h]&&(f=d[h],f instanceof HTMLImageElement&&(f.width>this.maxCubeMapSize||f.height>this.maxCubeMapSize)&&(f=m(f,this.maxCubeMapSize),0===c&&(a.width=f.width,a.height=f.height)),b.texImage2D(b.TEXTURE_CUBE_MAP_POSITIVE_X+h,c,a._glInternalFormat,a._glFormat,a._glPixelType,f));else for(f=1/Math.pow(2,c),h=0;6>h;h++)if(a._levelsUpdated[0][h]){var g=d[h];a._compressed?b.compressedTexImage2D(b.TEXTURE_CUBE_MAP_POSITIVE_X+h,c,a._glInternalFormat,Math.max(a._width*
f,1),Math.max(a._height*f,1),0,g):b.texImage2D(b.TEXTURE_CUBE_MAP_POSITIVE_X+h,c,a._glInternalFormat,Math.max(a._width*f,1),Math.max(a._height*f,1),0,a._glFormat,a._glPixelType,g)}}else a._volume?(b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,!1),f=1/Math.pow(2,c),a._compressed?b.compressedTexImage3D(b.TEXTURE_3D,c,a._glInternalFormat,Math.max(a._width*f,1),Math.max(a._height*f,1),Math.max(a._depth*f,1),0,d):b.texImage3D(b.TEXTURE_3D,c,a._glInternalFormat,Math.max(a._width*f,1),Math.max(a._height*f,1),Math.max(a._depth*
f,1),0,a._glFormat,a._glPixelType,d)):(d instanceof HTMLCanvasElement||d instanceof HTMLImageElement||d instanceof HTMLVideoElement?(d instanceof HTMLImageElement&&(d.width>this.maxTextureSize||d.height>this.maxTextureSize)&&(d=m(d,this.maxTextureSize),0===c&&(a.width=d.width,a.height=d.height)),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,!0),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),b.texImage2D(b.TEXTURE_2D,c,a._glInternalFormat,a._glFormat,a._glPixelType,d)):(b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,
...
a._mipmapsUploaded=!0);a._gpuSize&&(this._vram.tex-=a._gpuSize);q||(q={},q[pc.PIXELFORMAT_A8]=1,q[pc.PIXELFORMAT_L8]=1,q[pc.PIXELFORMAT_L8_A8]=1,q[pc.PIXELFORMAT_R5_G6_B5]=2,q[pc.PIXELFORMAT_R5_G5_B5_A1]=2,q[pc.PIXELFORMAT_R4_G4_B4_A4]=2,q[pc.PIXELFORMAT_R8_G8_B8]=4,q[pc.PIXELFORMAT_R8_G8_B8_A8]=4,q[pc.PIXELFORMAT_RGB16F]=8,q[pc.PIXELFORMAT_RGBA16F]=8,q[pc.PIXELFORMAT_RGB32F]=16,q[pc.PIXELFORMAT_RGBA32F]=16,q[pc.PIXELFORMAT_R32F]=4,q[pc.PIXELFORMAT_DEPTH]=4,q[pc.PIXELFORMAT_DEPTHSTENCIL]=4,q[pc.PIXELFORMAT_111110F]=
4,q[pc.PIXELFORMAT_SRGB]=4,q[pc.PIXELFORMAT_SRGBA]=4);c=1;!a._pot||!a._mipmaps&&a._minFilter!==b.NEAREST_MIPMAP_NEAREST&&a._minFilter!==b.NEAREST_MIPMAP_LINEAR&&a._minFilter!==b.LINEAR_MIPMAP_NEAREST&&a._minFilter!==b.LINEAR_MIPMAP_LINEAR||a._compressed&&1===a._levels.length||(c=Math.round(Math.log2(Math.max(a._width,a._height))+1));b=a._width;d=a._height;h=a._depth;for(g=f=0;g<c;g++)f=a._compressed?a._format===pc.PIXELFORMAT_ETC1?f+Math.floor((b+3)/4)*Math.floor((d+3)/4)*8*h:a._format===pc.PIXELFORMAT_PVRTC_2BPP_RGB_1||
a._format===pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1?f+Math.max(b,16)*Math.max(d,8)/4*h:a._format===pc.PIXELFORMAT_PVRTC_4BPP_RGB_1||a._format===pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1?f+Math.max(b,8)*Math.max(d,8)/2*h:f+Math.floor((b+4-1)/4)*Math.floor((d+4-1)/4)*(a._format===pc.PIXELFORMAT_DXT1?8:16)*h:f+b*d*h*q[a._format],b=Math.max(.5*b,1),d=Math.max(.5*d,1),h=Math.max(.5*h,1);a._cubemap&&(f*=6);a._gpuSize=f;this._vram.tex+=a._gpuSize}},setTexture:function(a,b){var c=this.gl;a._glTextureId||this.initializeTexture(a);
...
c.texParameteri(a._glTarget,c.TEXTURE_COMPARE_FUNC,this.glComparison[a._compareFunc]),a._compareModeDirty=!1));a._anisotropyDirty&&((d=this.extTextureFilterAnisotropic)&&c.texParameterf(a._glTarget,d.TEXTURE_MAX_ANISOTROPY_EXT,Math.max(1,Math.min(Math.round(a._anisotropy),this.maxAnisotropy))),a._anisotropyDirty=!1)}if(a._needsUpload||a._needsMipmapsUpload)this.uploadTexture(a),a._needsUpload=!1,a._needsMipmapsUpload=!1},draw:function(a,b){var c=this.gl,d,f,h,g,e,p,k,l;d=this.shader;l=d.samplers;
var r=d.uniforms;1<b&&(this.boundBuffer=null,this.attributesInvalidated=!0);if(this.attributesInvalidated){e=d.attributes;d=0;for(h=e.length;d<h;d++)p=e[d],f=p.scopeId.value,null!==f&&(k=this.vertexBuffers[f.stream],g=this.vbOffsets[f.stream]||0,k=k.bufferId,this.boundBuffer!==k&&(c.bindBuffer(c.ARRAY_BUFFER,k),this.boundBuffer=k),p=p.locationId,this.enabledAttributes[p]||(c.enableVertexAttribArray(p),this.enabledAttributes[p]=!0),c.vertexAttribPointer(p,f.numComponents,this.glType[f.dataType],f.normalize,
f.stride,f.offset+g),1===f.stream&&1<b?this.instancedAttribs[p]||(this.extInstancing.vertexAttribDivisorANGLE(p,1),this.instancedAttribs[p]=!0):this.instancedAttribs[p]&&(this.extInstancing.vertexAttribDivisorANGLE(p,0),this.instancedAttribs[p]=!1));this.attributesInvalidated=!1}var m=0;d=0;for(h=l.length;d<h;d++)if(g=l[d],e=g.scopeId.value)if(e instanceof pc.Texture)p=e,this.setTexture(p,m),g.slot!==m&&(c.uniform1i(g.locationId,m),g.slot=m),m++;else{g.array.length=0;k=e.length;for(f=0;f<k;f++)p=
e[f],this.setTexture(p,m),g.array[f]=m,m++;c.uniform1iv(g.locationId,g.array)}d=0;for(h=r.length;d<h;d++)if(l=r[d],f=l.scopeId,g=l.version,e=f.versionObject.version,g.globalId!==e.globalId||g.revision!==e.revision)if(g.globalId=e.globalId,g.revision=e.revision,null!==f.value)this.commitFunction[l.dataType](l,f.value);this._drawCallsPerFrame++;this._primsPerFrame[a.type]+=a.count*(1<b?b:1);this.webgl2&&this.transformFeedbackBuffer&&(c.bindBufferBase(c.TRANSFORM_FEEDBACK_BUFFER,0,this.transformFeedbackBuffer.bufferId),
c.beginTransformFeedback(c.POINTS));a.indexed?1<b?(this.extInstancing.drawElementsInstancedANGLE(this.glPrimitive[a.type],a.count,this.indexBuffer.glFormat,2*a.base,b),this.boundBuffer=null,this.attributesInvalidated=!0):c.drawElements(this.glPrimitive[a.type],a.count,this.indexBuffer.glFormat,a.base*this.indexBuffer.bytesPerIndex):1<b?(this.extInstancing.drawArraysInstancedANGLE(this.glPrimitive[a.type],a.base,a.count,b),this.boundBuffer=null,this.attributesInvalidated=!0):c.drawArrays(this.glPrimitive[a.type],
a.base,a.count);this.webgl2&&this.transformFeedbackBuffer&&(c.endTransformFeedback(),c.bindBufferBase(c.TRANSFORM_FEEDBACK_BUFFER,0,null))},clear:function(a){var b=this.defaultClearOptions;a=a||b;var c=void 0==a.flags?b.flags:a.flags;if(0!==c){var d=this.gl;if(c&pc.CLEARFLAG_COLOR){var f=void 0==a.color?b.color:a.color;this.setClearColor(f[0],f[1],f[2],f[3])}c&pc.CLEARFLAG_DEPTH&&(this.setClearDepth(void 0==a.depth?b.depth:a.depth),this.depthWrite||d.depthMask(!0));c&pc.CLEARFLAG_STENCIL&&this.setClearStencil(void 0==
a.stencil?b.stencil:a.stencil);d.clear(this.glClearFlag[c]);c&pc.CLEARFLAG_DEPTH&&(this.depthWrite||d.depthMask(!1))}},readPixels:function(a,b,c,d,f){var h=this.gl;h.readPixels(a,b,c,d,h.RGBA,h.UNSIGNED_BYTE,f)},setClearDepth:function(a){a!==this.clearDepth&&(this.gl.clearDepth(a),this.clearDepth=a)},setClearColor:function(a,b,c,d){if(a!==this.clearRed||b!==this.clearGreen||c!==this.clearBlue||d!==this.clearAlpha)this.gl.clearColor(a,b,c,d),this.clearRed=a,this.clearGreen=b,this.clearBlue=c,this.clearAlpha=
d},setClearStencil:function(a){a!==this.clearStencil&&(this.gl.clearStencil(a),this.clearStencil=a)},setRenderTarget:function(a){this.renderTarget=a},getRenderTarget:function(){return this.renderTarget},getDepthTest:function(){return this.depthTest},setDepthTest:function(a){if(this.depthTest!==a){var b=this.gl;a?b.enable(b.DEPTH_TEST):b.disable(b.DEPTH_TEST);this.depthTest=a}},setDepthFunc:function(a){this.depthFunc!==a&&(this.gl.depthFunc(this.glComparison[a]),this.depthFunc=a)},getDepthWrite:function(){return this.depthWrite},
setDepthWrite:function(a){this.depthWrite!==a&&(this.gl.depthMask(a),this.depthWrite=a)},setColorWrite:function(a,b,c,d){if(this.writeRed!==a||this.writeGreen!==b||this.writeBlue!==c||this.writeAlpha!==d)this.gl.colorMask(a,b,c,d),this.writeRed=a,this.writeGreen=b,this.writeBlue=c,this.writeAlpha=d},setAlphaToCoverage:function(a){this.webgl2&&this.alphaToCoverage!==a&&((this.alphaToCoverage=a)?this.gl.enable(this.gl.SAMPLE_ALPHA_TO_COVERAGE):this.gl.disable(this.gl.SAMPLE_ALPHA_TO_COVERAGE))},setTransformFeedbackBuffer:function(a){if(this.transformFeedbackBuffer!==
a&&(this.transformFeedbackBuffer=a,this.webgl2)){var b=this.gl;a?b.bindTransformFeedback(b.TRANSFORM_FEEDBACK,this.feedback):b.bindTransformFeedback(b.TRANSFORM_FEEDBACK,null)}},setRaster:function(a){this.raster!==a&&(this.raster=a,this.webgl2&&(a?this.gl.disable(this.gl.RASTERIZER_DISCARD):this.gl.enable(this.gl.RASTERIZER_DISCARD)))},setDepthBias:function(a){this.depthBiasEnabled!==a&&((this.depthBiasEnabled=a)?this.gl.enable(this.gl.POLYGON_OFFSET_FILL):this.gl.disable(this.gl.POLYGON_OFFSET_FILL))},
...
Object.defineProperty(n.prototype,"width",{get:function(){return this.gl.drawingBufferWidth||this.canvas.width}});Object.defineProperty(n.prototype,"height",{get:function(){return this.gl.drawingBufferHeight||this.canvas.height}});Object.defineProperty(n.prototype,"fullscreen",{get:function(){return!!document.fullscreenElement},set:function(a){a?this.gl.canvas.requestFullscreen():document.exitFullscreen()}});Object.defineProperty(n.prototype,"enableAutoInstancing",{get:function(){return this._enableAutoInstancing},
set:function(a){this._enableAutoInstancing=a&&this.extInstancing}});Object.defineProperty(n.prototype,"maxAnisotropy",{get:function(){var a;return function(){if(void 0===a){a=1;var b=this.gl,c=this.extTextureFilterAnisotropic;c&&(a=b.getParameter(c.MAX_TEXTURE_MAX_ANISOTROPY_EXT))}return a}}()});Object.defineProperty(n.prototype,"maxPixelRatio",{get:function(){return this._maxPixelRatio},set:function(a){this._maxPixelRatio=a;this.resizeCanvas(this._width,this._height)}});return{UnsupportedBrowserError:e,
ContextCreationError:a,GraphicsDevice:n,precalculatedTangents:!0}}());pc.extend(pc,function(){var e={},a={};a.vertex_position=pc.SEMANTIC_POSITION;a.vertex_normal=pc.SEMANTIC_NORMAL;a.vertex_tangent=pc.SEMANTIC_TANGENT;a.vertex_texCoord0=pc.SEMANTIC_TEXCOORD0;a.vertex_texCoord1=pc.SEMANTIC_TEXCOORD1;a.vertex_color=pc.SEMANTIC_COLOR;e.collectAttribs=function(b){for(var c={},d=0,f=b.indexOf("attribute");0<=f&&!(0<f&&"/"===b[f-1]);){var g=b.indexOf(";",f),h=b.lastIndexOf(" ",g),g=b.substr(h+1,g-(h+1)),h=a[g];void 0!==h?c[g]=h:(c[g]="ATTR"+d,d++);f=b.indexOf("attribute",
...
var p,l,k,m,q;d?(b=d.x,p=d.y,l=d.z,d=d.w):(l=null!==b?b.width:a.width,d=null!==b?b.height:a.height,p=b=0);f?(k=f.x,m=f.y,q=f.z,f=f.w):(k=b,m=p,q=l,f=d);a.setViewport(b,p,l,d);a.setScissor(k,m,q,f);f=a.getDepthTest();l=a.getDepthWrite();b=a.getCullMode();a.setDepthTest(!1);a.setDepthWrite(!1);a.setCullMode(pc.CULLFACE_NONE);g||a.setBlending(!1);a.setVertexBuffer(e,0);a.setShader(c);a.draw({type:pc.PRIMITIVE_TRISTRIP,base:0,count:4,indexed:!1});a.setDepthTest(f);a.setDepthWrite(l);a.setCullMode(b);
...
g=b.method,h=b.samples,p=b.cpuSync,l=b.chromeFix;if(p&&!f._levels[0])console.error("ERROR: prefilter: cubemap must have _levels");else{var k=pc.shaderChunks,m=f.rgbm,h=k.createShaderFromCode(c,k.fullscreenQuadVS,k.rgbmPS+k.prefilterCubemapPS.replace(/\$METHOD/g,0===g?"cos":"phong").replace(/\$NUMSAMPLES/g,h).replace(/\$textureCube/g,m?"textureCubeRGBM":"textureCube"),"prefilter"+g+""+h+""+m),q=k.createShaderFromCode(c,k.fullscreenQuadVS,k.outputCubemapPS,"outputCubemap"),n=c.scope.resolve("source"),
r=c.scope.resolve("params"),u=new pc.Vec4,v=f.width,k=f.format,A=[[],b.filteredFixed,b.filteredRgbm,b.filteredFixedRgbm],z=0===g?[.9,.85,.7,.4,.25]:[512,128,32,8,2],t=[64,32,16,8,4],w,y,x;y=k===pc.PIXELFORMAT_R8_G8_B8;w=!1;var B;p&&(w=f._levels[0][0]instanceof HTMLImageElement);if((y||w)&&p){k=pc.PIXELFORMAT_R8_G8_B8_A8;B=new pc.gfx.Texture(c,{cubemap:!0,rgbm:m,format:k,width:v,height:v,mipmaps:!1});for(x=0;6>x;x++)w=new pc.RenderTarget(c,B,{face:x,depth:!1}),u.x=x,u.y=0,n.setValue(f),r.setValue(u.data),
l&&e(),pc.drawQuadWithShader(c,w,q),a(c,w,x);f=B}if(128<v){var C=Math.round(Math.log2(v))-Math.round(Math.log2(128));for(y=0;y<C;y++){var v=.5*f.width,F=0===g?1:Math.pow(2,Math.round(Math.log2(z[0])+2*(C-y)));B=new pc.gfx.Texture(c,{cubemap:!0,rgbm:m,format:k,width:v,height:v,mipmaps:!1});for(x=0;6>x;x++)w=new pc.RenderTarget(c,B,{face:x,depth:!1}),u.x=x,u.y=F,u.z=v,u.w=m?3:0,n.setValue(f),r.setValue(u.data),l&&e(),pc.drawQuadWithShader(c,w,q),y===C-1&&p&&a(c,w,x);f=B}}b.sourceCubemap=f;B=null;if(!m&&
b.filteredFixedRgbm)for(B=new pc.gfx.Texture(c,{cubemap:!0,rgbm:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,width:v,height:v,mipmaps:!1}),x=0;6>x;x++)w=new pc.RenderTarget(c,B,{face:x,depth:!1}),u.x=x,u.w=2,n.setValue(f),r.setValue(u.data),l&&e(),pc.drawQuadWithShader(c,w,q),a(c,w,x);v=0===g?1:2048;w=0===g?0:-1;A[w]=[];for(y=0;5>y;y++)for(q=w;q<A.length;q++)null!=A[q]&&(A[q][y]=new pc.gfx.Texture(c,{cubemap:!0,rgbm:2>q?m:!0,format:2>q?k:pc.PIXELFORMAT_R8_G8_B8_A8,fixCubemapSeams:1===q||3===q,width:t[y],
height:t[y],mipmaps:!1}));for(q=w;q<A.length;q++)if(null!=A[q])if(1<q&&m)A[q]=A[q-2];else for(y=0;5>y;y++)for(x=0;6>x;x++)w=new pc.RenderTarget(c,A[q][y],{face:x,depth:!1}),u.x=x,u.y=0>q?v:z[y],u.z=t[y],u.w=m?3:q,n.setValue(0===y?f:0===g?A[0][y-1]:A[-1][y-1]),r.setValue(u.data),l&&e(),pc.drawQuadWithShader(c,w,h),p&&a(c,w,x);b.filtered=A[0];if(p&&b.singleFilteredFixed){f=[f,b.filteredFixed[0],b.filteredFixed[1],b.filteredFixed[2],b.filteredFixed[3],b.filteredFixed[4],b.filteredFixed[5]];m=new pc.gfx.Texture(c,
{cubemap:!0,rgbm:m,fixCubemapSeams:!0,format:k,width:128,height:128,addressU:pc.ADDRESS_CLAMP_TO_EDGE,addressV:pc.ADDRESS_CLAMP_TO_EDGE});for(y=0;6>y;y++)m._levels[y]=f[y]._levels[0];m.upload();m._prefilteredMips=!0;b.singleFilteredFixed=m}if(p&&b.singleFilteredFixedRgbm&&b.filteredFixedRgbm){f=[B,b.filteredFixedRgbm[0],b.filteredFixedRgbm[1],b.filteredFixedRgbm[2],b.filteredFixedRgbm[3],b.filteredFixedRgbm[4],b.filteredFixedRgbm[5]];m=new pc.gfx.Texture(c,{cubemap:!0,rgbm:!0,fixCubemapSeams:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,
...
var l=c.createShaderFromCode(h,c.fullscreenQuadVS,c.fullscreenQuadPS,"fsQuadSimple"),k=h.scope.resolve("source");for(c=0;6>c;c++){var m=a._levels[0][c],q=new pc.Texture(h,{cubemap:!1,rgbm:!1,format:a.format,width:g,height:g,mipmaps:!1});q._levels[0]=m;q.upload();m=new pc.Texture(h,{cubemap:!1,rgbm:!1,format:a.format,width:g,height:g,mipmaps:!1});m=new pc.RenderTarget(h,m,{depth:!1});k.setValue(q);pc.drawQuadWithShader(h,m,l);var n=new Uint8Array(g*g*4);e.bindFramebuffer(e.FRAMEBUFFER,m._glFrameBuffer);
e.readPixels(0,0,q.width,q.height,e.RGBA,e.UNSIGNED_BYTE,n);a._levels[0][c]=n}}else{console.error("ERROR: SH: cubemap must be composed of arrays or images");return}l=[];for(e=0;e<g;e++)for(h=0;h<g;h++)l[e*g+h]=(new pc.Vec3(h/(g-1)*2-1,e/(g-1)*2-1,1)).normalize();var k=new Float32Array(27),r,u,v,A,z,t,w,y,x,B,C;for(c=m=0;6>c;c++)for(e=0;e<g;e++)for(h=0;h<g;h++){q=e*g+h;n=h;w=e;y=g;u=(2*(n+.5)/y-1)*(1-1/y);C=(2*(w+.5)/y-1)*(1-1/y);r=1/y;x=u-r;B=C-r;u+=r;C+=r;x=b(x,B)-b(x,C)-b(u,B)+b(u,C);if(0===n&&
0===w||n===y-1&&0===w||0===n&&w===y-1||n===y-1&&w===y-1)x/=3;else if(0===n||0===w||n===y-1||w===y-1)x*=.5;n=x;w=4*n/17;y=8*n/17;x=15*n/17;B=5*n/68;C=15*n/68;r=l[q];0==c?(A=r.z,z=-r.y,t=-r.x):1==c?(A=-r.z,z=-r.y,t=r.x):2==c?(A=r.x,z=r.z,t=r.y):3==c?(A=r.x,z=-r.z,t=-r.y):4==c?(A=r.x,z=-r.y,t=r.z):5==c&&(A=-r.x,z=-r.y,t=-r.z);d||(A=-A);u=a._levels[0][c][4*q+3]/255;for(r=0;3>r;r++)v=a._levels[0][c][4*q+r]/255,a.rgbm?(v*=8*u,v*=v):v=Math.pow(v,2.2),k[0+r]+=v*w,k[3+r]+=v*y*A,k[6+r]+=v*y*z,k[9+r]+=v*y*t,
k[12+r]+=v*x*A*t,k[15+r]+=v*x*t*z,k[18+r]+=v*x*z*A,k[21+r]+=v*B*(3*t*t-1),k[24+r]+=v*C*(A*A-z*z),m+=n}for(r=0;r<k.length;r++)k[r]*=4*Math.PI/m;return k}console.error("ERROR: SH: cubemap must be synced to CPU")}}}}());pc.extend(pc,function(){return{paraboloidFromCubemap:function(e,a,b,c){var d=pc.shaderChunks,d=d.createShaderFromCode(e,d.fullscreenQuadVS,(a.fixCubemapSeams?d.fixCubemapSeamsStretchPS:d.fixCubemapSeamsNonePS)+d.genParaboloidPS,"genParaboloid"),f=e.scope.resolve("source"),g=e.scope.resolve("params"),h=new pc.Vec4,p=a.width,l=a.rgbm,k=a.format,p=2*Math.max(p,8),p=new pc.gfx.Texture(e,{rgbm:l,format:k,width:2*p,height:p,mipmaps:!1}),l=new pc.RenderTarget(e,p,{depth:!1});h.x=b;h.y=c?-1:1;f.setValue(a);
g.setValue(h.data);pc.drawQuadWithShader(e,l,d);return p},generateDpAtlas:function(e,a,b){var c,d;d=new pc.Vec4;for(var f=new pc.Vec4,g=4*a[0].width,h=pc.shaderChunks,h=h.createShaderFromCode(e,h.fullscreenQuadVS,h.dpAtlasQuadPS,"dpAtlasQuad"),p=e.scope.resolve("source"),l=e.scope.resolve("params"),k=new pc.gfx.Texture(e,{rgbm:a[0].rgbm,format:a[0].format,width:g,height:g,mipmaps:!1}),m=new pc.RenderTarget(e,k,{depth:!1}),q=(g+2)/g-1,n=0;6>n;n++){c=pc.paraboloidFromCubemap(e,a[n],n,b);p.setValue(c);
c=d;var r=n;c.x=.5*pc.math.clamp(r-2,0,1);var r=r-6*c.x,u=1-c.x;c.y=Math.min(.5*r,.75)*u+c.x;c.z=(1-.5*pc.math.clamp(r,0,1))*u;c.w=.5*c.z;c=1/c.z;f.x=c*q;f.y=2*f.x;f.x+=1;f.y+=1;l.setValue(f.data);d.x*=g;d.y*=g;d.z*=g;d.w*=g;pc.drawQuadWithShader(e,m,h,d)}return k}}}());pc.shaderChunks.TBNPS="void getTBN() {\n    dTBN = mat3(normalize(vTangentW), normalize(vBinormalW), normalize(vNormalW));\n}\n";pc.shaderChunks.TBNfastPS="void getTBN() {\n    dTBN = mat3((vTangentW), (vBinormalW), (vNormalW));\n}\n";pc.shaderChunks.alphaTestPS="uniform float alpha_ref;\nvoid alphaTest(float a) {\n    if (a < alpha_ref) discard;\n}\n";pc.shaderChunks.ambientConstantPS="\nvoid addAmbient() {\n    dDiffuseLight += light_globalAmbient;\n}\n";
...
b},_addVaryingIfNeeded:function(e,a,b){return 0<=e.indexOf(b)?"varying "+a+" "+b+";\n":""},createShaderDefinition:function(e,a){var b,c,d=0<a.lights.length;a.dirLightMap&&(d=!0,a.useSpecular=!0);a.shadingModel===pc.SPECULAR_PHONG?(a.fresnelModel=0,a.specularAA=!1,a.prefilteredCubemap=!1,a.dpAtlas=!1,a.ambientSH=!1):a.fresnelModel=0===a.fresnelModel?pc.FRESNEL_SCHLICK:a.fresnelModel;var f=a.cubeMap||a.prefilteredCubemap&&a.useSpecular,g=a.sphereMap||f||a.dpAtlas,h=pc.precalculatedTangents,p=a.useTexCubeLod;
if(a.cubeMap||a.prefilteredCubemap)a.sphereMap=null;a.dpAtlas&&(a.sphereMap=a.cubeMap=a.prefilteredCubemap=f=null);a.useSpecular||(a.specularMap=a.glossMap=null);var l=d||g||a.ambientSH||a.prefilteredCubemap||a.heightMap;this.options=a;var k="",m="",q="",n=pc.shaderChunks,r;if(a.chunks){var u=[];for(c in n)n.hasOwnProperty(c)&&(a.chunks[c]?(u[c]=a.chunks[c],l||(u[c]=u[c].replace(/vertex_normal/g,"vec3(0)").replace(/vertex_tangent/g,"vec4(0)"))):u[c]=n[c]);n=u}var k=k+n.baseVS,v=-1;if(!a.noShadow){for(b=
0;b<a.lights.length;b++)if(r=a.lights[b]._type,a.lights[b].castShadows&&r===pc.LIGHTTYPE_DIRECTIONAL){k+="uniform mat4 light"+b+"_shadowMatrixVS;\n";k+="uniform vec3 light"+b+"_shadowParamsVS;\n";k+="uniform vec3 light"+b+(r===pc.LIGHTTYPE_DIRECTIONAL?"_directionVS":"_positionVS")+";\n";v=b;break}0<=v&&(k+=n.shadowCoordVS)}u={vertex_position:pc.SEMANTIC_POSITION};m+="   vPositionW    = getWorldPosition();\n";a.useInstancing&&(u.instance_line1=pc.SEMANTIC_TEXCOORD2,u.instance_line2=pc.SEMANTIC_TEXCOORD3,
u.instance_line3=pc.SEMANTIC_TEXCOORD4,u.instance_line4=pc.SEMANTIC_TEXCOORD5,k+=n.instancingVS);l&&(u.vertex_normal=pc.SEMANTIC_NORMAL,m+="   vNormalW    = dNormalW = getNormal();\n",a.sphereMap&&16>=e.fragmentUniformsCount&&(k+=n.viewNormalVS,m+="   vNormalV    = getViewNormal();\n"),(a.heightMap||a.normalMap)&&h&&(u.vertex_tangent=pc.SEMANTIC_TANGENT,k+=n.tangentBinormalVS,m+="   vTangentW   = getTangent();\n   vBinormalW  = getBinormal();\n"),0<=v&&(r=a.lights[v]._type,m=r===pc.LIGHTTYPE_DIRECTIONAL?
m+("   dLightDirNormW = light"+v+"_directionVS;\n"):m+("   getLightDirPoint(light"+v+"_positionVS);\n"),m+=this._nonPointShadowMapProjection(e,a.lights[v],"(light"+v+"_shadowMatrixVS, light"+v+"_shadowParamsVS);\n")));r=[];var A=[],z,t,w;for(c in pc._matTex2D)b=c+"Map",a[b+"VertexColor"]?(z=b+"Channel",a[z]=this._correctChannel(c,a[z])):a[b]&&(z=b+"Channel",t=b+"Transform",w=b+"Uv",a[w]=Math.min(a[w],1),a[z]=this._correctChannel(c,a[z]),w=a[w],r[w]=!0,A[w]=A[w]||a[b]&&!a[t]);a.forceUv1&&(r[1]=!0);
for(b=0;2>b;b++)r[b]&&(u["vertex_texCoord"+b]=pc["SEMANTIC_TEXCOORD"+b],k+=n["uv"+b+"VS"],m+="   vec2 uv"+b+" = getUv"+b+"();\n"),A[b]&&(m+="   vUv"+b+" = uv"+b+";\n");r=[k,q,m,[]];for(c in pc._matTex2D)b=c+"Map",a[b]&&(t=b+"Transform",a[t]&&(w=b+"Uv",this._setMapTransform(r,c,a[t],a[w])));k=r[0];q=r[1];m=r[2];a.vertexColors&&(u.vertex_color=pc.SEMANTIC_COLOR,m+="   vVertexColor = vertex_color;\n");a.screenSpace?(k+=n.transformScreenSpaceVS,l&&(k+=n.normalVS)):a.skin?(u.vertex_boneWeights=pc.SEMANTIC_BLENDWEIGHT,
u.vertex_boneIndices=pc.SEMANTIC_BLENDINDICES,k+=pc.programlib.skinCode(e),k+=n.transformSkinnedVS,l&&(k+=n.normalSkinnedVS)):a.useInstancing?(k+=n.transformInstancedVS,l&&(k+=n.normalInstancedVS)):(k+=n.transformVS,l&&(k+=n.normalVS));k=k+"\n"+n.startVS;c=k=k+m+"}";b=q;q=""+this._addVaryingIfNeeded(k,"vec4","vMainShadowUv");q+=this._addVaryingIfNeeded(k,"vec4","vVertexColor");q+=this._addVaryingIfNeeded(k,"vec3","vPositionW");q+=this._addVaryingIfNeeded(k,"vec3","vNormalV");q+=this._addVaryingIfNeeded(k,
"vec3","vNormalW");q+=this._addVaryingIfNeeded(k,"vec3","vTangentW");q+=this._addVaryingIfNeeded(k,"vec3","vBinormalW");q+=this._addVaryingIfNeeded(k,"vec2","vUv0");q+=this._addVaryingIfNeeded(k,"vec2","vUv1");q+=b;c=q+c;k="";e.webgl2?(k=pc.programlib.versionCode(e),n.extensionVS&&(k+=n.extensionVS+"\n"),c=k+n.gles3VS+c):(n.extensionVS&&(k=n.extensionVS+"\n"),c=k+c);a.forceFragmentPrecision&&"highp"!=a.forceFragmentPrecision&&"mediump"!==a.forceFragmentPrecision&&"lowp"!==a.forceFragmentPrecision&&
(a.forceFragmentPrecision=null);a.forceFragmentPrecision&&("highp"===a.forceFragmentPrecision&&"highp"!==e.maxPrecision&&(a.forceFragmentPrecision="mediump"),"mediump"===a.forceFragmentPrecision&&"lowp"===e.maxPrecision&&(a.forceFragmentPrecision="lowp"));k="";e.webgl2&&(k+=pc.programlib.versionCode(e));e.extStandardDerivatives&&!e.webgl2&&(k+="#extension GL_OES_standard_derivatives : enable\n\n");n.extensionPS&&(k+=n.extensionPS+"\n");e.webgl2&&(k+=n.gles3PS);k+=a.forceFragmentPrecision?"precision "+
a.forceFragmentPrecision+" float;\n\n":pc.programlib.precisionCode(e);if(a.customFragmentShader)return f=k+a.customFragmentShader,{attributes:u,vshader:c,fshader:f,tag:pc.SHADERTAG_MATERIAL};q=k=k+q+n.basePS;k="";A=0;t=[];z=w=!1;for(b=0;b<a.lights.length;b++)if(m=a.lights[b],r=m._type,k+="uniform vec3 light"+b+"_color;\n",r===pc.LIGHTTYPE_DIRECTIONAL?k+="uniform vec3 light"+b+"_direction;\n":(k+="uniform vec3 light"+b+"_position;\n",k+="uniform float light"+b+"_radius;\n",r===pc.LIGHTTYPE_SPOT&&(k+=
"uniform vec3 light"+b+"_direction;\n",k+="uniform float light"+b+"_innerConeAngle;\n",k+="uniform float light"+b+"_outerConeAngle;\n")),m.castShadows&&!a.noShadow&&(k+="uniform mat4 light"+b+"_shadowMatrix;\n",k=r!==pc.LIGHTTYPE_DIRECTIONAL?k+("uniform vec4 light"+b+"_shadowParams;\n"):k+("uniform vec3 light"+b+"_shadowParams;\n"),k=r===pc.LIGHTTYPE_POINT?k+("uniform samplerCube light"+b+"_shadowMap;\n"):m._isPcf&&e.webgl2?k+("uniform sampler2DShadow light"+b+"_shadowMap;\n"):k+("uniform sampler2D light"+
b+"_shadowMap;\n"),A++,t[m._shadowType]=!0,m._isVsm&&(w=!0),m._isPcf&&(e.webgl2||e.extStandardDerivatives)&&r===pc.LIGHTTYPE_SPOT&&(z=!0)),m._cookie)if(m._cookie._cubemap)r===pc.LIGHTTYPE_POINT&&(k+="uniform samplerCube light"+b+"_cookie;\n",k+="uniform float light"+b+"_cookieIntensity;\n",!m.castShadows||a.noShadow)&&(k+="uniform mat4 light"+b+"_shadowMatrix;\n");else if(r===pc.LIGHTTYPE_SPOT){k+="uniform sampler2D light"+b+"_cookie;\n";k+="uniform float light"+b+"_cookieIntensity;\n";if(!m.castShadows||
a.noShadow)k+="uniform mat4 light"+b+"_shadowMatrix;\n";m._cookieTransform&&(k+="uniform vec4 light"+b+"_cookieMatrix;\n",k+="uniform vec2 light"+b+"_cookieOffset;\n")}k+="\n";b=a.heightMap?" + dUvOffset":"";r=a.fastTbn?n.TBNfastPS:n.TBNPS;l&&(a.normalMap&&h?(k+=a.packedNormal?n.normalXYPS:n.normalXYZPS,h=this._uvSource(a.normalMapTransform,a.normalMapUv)+b,k=a.needsNormalFloat?k+(a.fastTbn?n.normalMapFloatTBNfastPS:n.normalMapFloatPS).replace(/\$UV/g,h):k+n.normalMapPS.replace(/\$UV/g,h),k+=r):k+=
n.normalVertexPS);k+=pc.programlib.gammaCode(a.gamma);k+=pc.programlib.tonemapCode(a.toneMap);k+=pc.programlib.fogCode(a.fog);a.useRgbm&&(k+=n.rgbmPS);if(f||a.prefilteredCubemap)k+=a.fixSeams?n.fixCubemapSeamsStretchPS:n.fixCubemapSeamsNonePS;l&&(k+=0<a.cubeMapProjection?n.cubeMapProjectBoxPS:n.cubeMapProjectNonePS,k+=a.skyboxIntensity?n.envMultiplyPS:n.envConstPS);k+=this._addMap("diffuse",a,n,b);if(a.blendType!==pc.BLEND_NONE||a.alphaTest||a.alphaToCoverage)k+=this._addMap("opacity",a,n,b);k+=this._addMap("emissive",
a,n,b,null,a.emissiveFormat);a.useSpecular&&(d||g)&&(k=a.specularAA&&a.normalMap?a.needsNormalFloat&&l?k+n.specularAaToksvigFloatPS:k+n.specularAaToksvigPS:k+n.specularAaNonePS,a.useMetalness&&(k+=n.metalnessPS),k+=this._addMap(a.useMetalness?"metalness":"specular",a,n,b),k+=this._addMap("gloss",a,n,b),0<a.fresnelModel&&(a.fresnelModel===pc.FRESNEL_SIMPLE?k+=n.fresnelSimplePS:a.fresnelModel===pc.FRESNEL_SCHLICK?k+=n.fresnelSchlickPS:a.fresnelModel===pc.FRESNEL_COMPLEX&&(k+=n.fresnelComplexPS)));a.heightMap&&
(a.normalMap||(k+=r),k+=this._addMap("height",a,n,"",n.parallaxPS));if(h=a.aoMap||a.aoMapVertexColor)k+=this._addMap("ao",a,n,b,a.aoMapVertexColor?n.aoVertPS:n.aoTexPS),a.occludeSpecular&&(k=a.occludeSpecular===pc.SPECOCC_AO?k+(a.occludeSpecularFloat?n.aoSpecOccSimplePS:n.aoSpecOccConstSimplePS):k+(a.occludeSpecularFloat?n.aoSpecOccPS:n.aoSpecOccConstPS));var y=a.rgbmReflection?"decodeRGBM":a.hdrReflection?"":"gammaCorrectInput";if(f||a.prefilteredCubemap)k=a.prefilteredCubemap?p?k+n.reflectionPrefilteredCubeLodPS.replace(/\$DECODE/g,
y):k+n.reflectionPrefilteredCubePS.replace(/\$DECODE/g,y):k+n.reflectionCubePS.replace(/\$textureCubeSAMPLE/g,a.rgbmReflection?"textureCubeRGBM":a.hdrReflection?"textureCube":"textureCubeSRGB");a.sphereMap&&(r=16<e.fragmentUniformsCount?n.reflectionSpherePS:n.reflectionSphereLowPS,r=r.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?"texture2D":"texture2DSRGB"),k+=r);a.dpAtlas&&(k+=n.reflectionDpAtlasPS.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?
"texture2D":"texture2DSRGB"));(f||a.sphereMap||a.dpAtlas)&&a.refraction&&(k+=n.refractionPS);0<A&&(t[pc.SHADOW_PCF3]&&(k+=n.shadowStandardPS),t[pc.SHADOW_PCF5]&&(k+=n.shadowStandardGL2PS),w&&(k+=n.shadowVSM_commonPS,t[pc.SHADOW_VSM8]&&(k+=n.shadowVSM8PS),t[pc.SHADOW_VSM16]&&(k+=e.extTextureHalfFloatLinear?n.shadowEVSMPS.replace(/\$/g,"16"):n.shadowEVSMnPS.replace(/\$/g,"16")),t[pc.SHADOW_VSM32]&&(k+=e.extTextureFloatLinear?n.shadowEVSMPS.replace(/\$/g,"32"):n.shadowEVSMnPS.replace(/\$/g,"32"))),e.webgl2||
e.extStandardDerivatives||(k+=n.biasConstPS),k+=n.shadowCoordPS+n.shadowCommonPS,z&&(k+=n.shadowCoordPerspZbufferPS),0<=v&&(t[pc.SHADOW_PCF3]&&(k+=n.shadowStandardVSPS),t[pc.SHADOW_PCF5]&&(k+=n.shadowStandardGL2VSPS),w&&(t[pc.SHADOW_VSM8]&&(k+=n.shadowVSMVSPS.replace(/\$VSM/g,"VSM8").replace(/\$/g,"8")),t[pc.SHADOW_VSM16]&&(k+=n.shadowVSMVSPS.replace(/\$VSM/g,"VSM16").replace(/\$/g,"16")),t[pc.SHADOW_VSM32]&&(k+=n.shadowVSMVSPS.replace(/\$VSM/g,"VSM32").replace(/\$/g,"32")))));d&&(k+=n.lightDiffuseLambertPS);
r=!1;a.useSpecular?(d&&(k+=a.shadingModel===pc.SPECULAR_PHONG?n.lightSpecularPhongPS:n.lightSpecularBlinnPS),a.sphereMap||f||a.dpAtlas||0<a.fresnelModel?k=0<a.fresnelModel?a.conserveEnergy?k+n.combineDiffuseSpecularPS:k+n.combineDiffuseSpecularNoConservePS:k+n.combineDiffuseSpecularOldPS:a.diffuseMap?k+=n.combineDiffuseSpecularNoReflPS:(k+=n.combineDiffuseSpecularNoReflSeparateAmbientPS,r=!0)):k+=n.combineDiffusePS;m=!0;if(a.lightMap||a.lightMapVertexColor)k+=this._addMap("light",a,n,b,a.lightMapVertexColor?
n.lightmapSingleVertPS:a.dirLightMap?n.lightmapDirPS:n.lightmapSinglePS,a.lightMapFormat),m=a.lightMapWithoutAmbient;m&&(k=a.ambientSH?k+n.ambientSHPS:a.prefilteredCubemap?p?k+n.ambientPrefilteredCubeLodPS.replace(/\$DECODE/g,y):k+n.ambientPrefilteredCubePS.replace(/\$DECODE/g,y):k+n.ambientConstantPS);a.modulateAmbient&&!r&&(k+="uniform vec3 material_ambient;\n");a.alphaTest&&(k+=n.alphaTestPS);a.msdf&&(k+=n.msdfPS);l&&(k+=n.viewDirPS,a.useSpecular&&(k+=n.reflDirPS));z=w=t=A=p=!1;k+=n.startPS;b=
!1;a.blendType!==pc.BLEND_NONE||a.alphaTest||a.alphaToCoverage?a.heightMap&&a.opacityMap?b=!0:(k+="   getOpacity();\n",a.alphaTest&&(k+="   alphaTest(dAlpha);\n")):k+="   dAlpha = 1.0;\n";if(l){k+="   getViewDir();\n";if(a.heightMap||a.normalMap)k+="   getTBN();\n";a.heightMap&&(k+="   getParallax();\n");b&&(k+="   getOpacity();\n",a.alphaTest&&(k+="   alphaTest(dAlpha);\n"));k+="   getNormal();\n";a.useSpecular&&(k+="   getReflDir();\n")}k+="   getAlbedo();\n";if(d&&a.useSpecular||g)k+="   getSpecularity();\n",
k+="   getGlossiness();\n",0<a.fresnelModel&&(k+="   getFresnel();\n");m&&(k+="   addAmbient();\n");a.modulateAmbient&&!r&&(k+="   dDiffuseLight *= material_ambient;\n");h&&!a.occludeDirect&&(k+="    applyAO();\n");if(a.lightMap||a.lightMapVertexColor)k+="   addLightMap();\n";if(d||g){if(f||a.sphereMap||a.dpAtlas)k+="   addReflection();\n";a.dirLightMap&&(k+="   addDirLightMap();\n");for(b=0;b<a.lights.length;b++){m=a.lights[b];r=m._type;g=!1;r===pc.LIGHTTYPE_DIRECTIONAL?(k+="   dLightDirNormW = light"+
b+"_direction;\n",k+="   dAtten = 1.0;\n"):(m._cookie&&(r!==pc.LIGHTTYPE_SPOT||m._cookie._cubemap?r===pc.LIGHTTYPE_POINT&&m._cookie._cubemap&&(g=z=!0):g=z=!0),k+="   getLightDirPoint(light"+b+"_position);\n",p=!0,g&&(k=r===pc.LIGHTTYPE_SPOT?k+("   dAtten3 = getCookie2D"+(m._cookieFalloff?"":"Clip")+(m._cookieTransform?"Xform":"")+"(light"+b+"_cookie, light"+b+"_shadowMatrix, light"+b+"_cookieIntensity"+(m._cookieTransform?", light"+b+"_cookieMatrix, light"+b+"_cookieOffset":"")+")."+m._cookieChannel+
";\n"):k+("   dAtten3 = getCookieCube(light"+b+"_cookie, light"+b+"_shadowMatrix, light"+b+"_cookieIntensity)."+m._cookieChannel+";\n")),m._falloffMode===pc.LIGHTFALLOFF_LINEAR?(k+="   dAtten = getFalloffLinear(light"+b+"_radius);\n",A=!0):(k+="   dAtten = getFalloffInvSquared(light"+b+"_radius);\n",t=!0),k+="   if (dAtten > 0.00001) {\n",r!==pc.LIGHTTYPE_SPOT||g&&!m._cookieFalloff||(k+="       dAtten *= getSpotEffect(light"+b+"_direction, light"+b+"_innerConeAngle, light"+b+"_outerConeAngle);\n",
w=!0));k+="       dAtten *= getLightDiffuse();\n";if(m.castShadows&&!a.noShadow){var x;m._shadowType===pc.SHADOW_VSM8?(l="VSM8",x="0.0"):m._shadowType===pc.SHADOW_VSM16?(l="VSM16",x="5.54"):m._shadowType===pc.SHADOW_VSM32?(l="VSM32",x=e.extTextureFloatHighPrecision?"15.0":"5.54"):l=m._shadowType===pc.SHADOW_PCF5?"PCF5x5":"PCF3x3";null!==l&&(r===pc.LIGHTTYPE_POINT?(d="(light"+b+"_shadowMap, light"+b+"_shadowParams);\n",m._normalOffsetBias&&(k+="       normalOffsetPointShadow(light"+b+"_shadowParams);\n"),
k+="       dAtten *= getShadowPoint"+l+d):(v===b?l+="VS":(d="(light"+b+"_shadowMatrix, light"+b+"_shadowParams);\n",k+=this._nonPointShadowMapProjection(e,a.lights[b],d)),r===pc.LIGHTTYPE_SPOT&&(l="Spot"+l),k+="       dAtten *= getShadow"+l+"(light"+b+"_shadowMap, light"+b+"_shadowParams"+(m._isVsm?", "+x:"")+");\n"))}k+="       dDiffuseLight += dAtten * light"+b+"_color"+(g?" * dAtten3":"")+";\n";a.useSpecular&&(k+="       dAtten *= getLightSpecular();\n",k+="       dSpecularLight += dAtten * light"+
b+"_color"+(g?" * dAtten3":"")+";\n");r!==pc.LIGHTTYPE_DIRECTIONAL&&(k+="   }\n");k+="\n"}(f||a.sphereMap||a.dpAtlas)&&a.refraction&&(k+="   addRefraction();\n")}k+="\n";h&&(a.occludeDirect&&(k+="    applyAO();\n"),a.occludeSpecular&&(k+="    occludeSpecular();\n"));k+=n.endPS;k=a.blendType===pc.BLEND_NORMAL||a.blendType===pc.BLEND_ADDITIVEALPHA||a.alphaToCoverage?k+n.outputAlphaPS:a.blendType===pc.BLEND_PREMULTIPLIED?k+n.outputAlphaPremulPS:k+n.outputAlphaOpaquePS;a.msdf&&(k+="   gl_FragColor = applyMsdf(gl_FragColor);\n");
k+="\n";k+=pc.programlib.end();p&&(k=n.lightDirPointPS+k);A&&(k=n.falloffLinearPS+k);t&&(k=n.falloffInvSquaredPS+k);w&&(k=n.spotPS+k);z&&(k=n.cookiePS+k);f="";k.includes("dReflection")&&(f+="vec4 dReflection;\n");k.includes("dTBN")&&(f+="mat3 dTBN;\n");k.includes("dAlbedo")&&(f+="vec3 dAlbedo;\n");k.includes("dEmission")&&(f+="vec3 dEmission;\n");k.includes("dNormalW")&&(f+="vec3 dNormalW;\n");k.includes("dViewDirW")&&(f+="vec3 dViewDirW;\n");k.includes("dReflDirW")&&(f+="vec3 dReflDirW;\n");k.includes("dDiffuseLight")&&
...
c&&d.material.clearVariants(),-1===this.drawCalls.indexOf(d)&&this.drawCalls.push(d),d.castShadow&&-1===this.shadowCasters.indexOf(d)&&this.shadowCasters.push(d);c=a.getLights();b=0;for(a=c.length;b<a;b++)this.addLight(c[b]);this._updateStats()}};e.prototype.addShadowCaster=function(a){for(var b,c=a.meshInstances.length,d=0;d<c;d++)b=a.meshInstances[d],b.castShadow&&-1===this.shadowCasters.indexOf(b)&&this.shadowCasters.push(b)};e.prototype.removeModel=function(a){var b,c,d,f,g,h;d=this._models.indexOf(a);
if(-1!==d){this._models.splice(d,1);d=a.getMaterials();for(b=0;b<d.length;b++)d[b].scene=null;var e,l=a.meshInstances.length;for(b=0;b<l;b++){e=a.meshInstances[b];g=-1;h=0;d=this.drawCalls.length;for(c=0;c<d;c++){f=this.drawCalls[c];if(f===e){g=c;h=1;break}if(f._staticSource===e)0>g&&(g=c),h++;else if(0<=g)break}0<=g&&this.drawCalls.splice(g,h);e.castShadow&&(d=this.shadowCasters.indexOf(e),-1!==d&&this.shadowCasters.splice(d,1))}a=a.getLights();b=0;for(d=a.length;b<d;b++)this.removeLight(a[b]);this._updateStats()}};
...
a.data[8]=b.data[10]}var k=(new pc.Mat4).mul2((new pc.Mat4).setTranslate(.5,.5,.5),(new pc.Mat4).setScale(.5,.5,.5)),m={color:[254/255,254/255,254/255,254/255],depth:1,flags:pc.CLEARFLAG_COLOR|pc.CLEARFLAG_DEPTH},q={r:1,g:2,b:3,a:4},n=[{},{},{},{},{}],r=new pc.Vec2,u={x:1,y:1,z:0,w:0},v=new pc.Mat4,A=new pc.Mat4,z=new pc.Mat4,t=new pc.Mat4,w=new pc.Mat4,y=new pc.Mat3,x=new pc.Mat4,B,C=new pc.Mat4,F=new pc.Mat4,K=new pc.Mat4,L=new pc.Mat4,J=new pc.Vec3,G=new pc.Vec3,D,M,W=new pc.Mat4,Z=new pc.Mat4,
aa=new pc.Mat4,S=new pc.Mat4,X=new pc.Vec3,V={center:null,radius:0},N,ba=new pc.BoundingBox;new pc.BoundingBox;for(var U=[],ca=[],ha=[0,0],E,I,P,da,fa={},ga,Y,T=[],ea=0;8>ea;ea++)T.push(new pc.Vec3);new pc.Vec3;new pc.Vec3;new pc.Vec3;new e(3);new e(3);new e(3);new e(36);var O=[new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3];pc.extend(p.prototype,{sortCompare:function(a,b){if(a.layer===b.layer){if(a.drawOrder&&b.drawOrder)return a.drawOrder-b.drawOrder;
...
var c=this.device,h=a.renderTarget;c.setRenderTarget(h);c.updateBegin();var f=a.getRect(),d=h?h.width:c.width,h=h?h.height:c.height,g=Math.floor(f.x*d),e=Math.floor(f.y*h),p=Math.floor(f.width*d),f=Math.floor(f.height*h);c.setViewport(g,e,p,f);c.setScissor(g,e,p,f);c.clear(a._clearOptions);f=a._scissorRect;g=Math.floor(f.x*d);e=Math.floor(f.y*h);p=Math.floor(f.width*d);f=Math.floor(f.height*h);c.setScissor(g,e,p,f);b&&c.setScissor(1,1,d-2,h-2)},dispatchGlobalLights:function(a){var b;this.mainLight=
...
a.resolve(c+"_outerConeAngle");this.lightPosVsId[b]=a.resolve(c+"_positionVS");this.lightCookieId[b]=a.resolve(c+"_cookie");this.lightCookieIntId[b]=a.resolve(c+"_cookieIntensity");this.lightCookieMatrixId[b]=a.resolve(c+"_cookieMatrix");this.lightCookieOffsetId[b]=a.resolve(c+"_cookieOffset")},dispatchDirectLights:function(a,b){var c=a._globalLights,d=c.length,f,h,g,e=0,p=this.device.scope;for(f=0;f<d;f++)if(c[f]._mask&b){h=c[f];g=h._node.getWorldTransform();this.lightColorId[e]||this._resolveLight(p,
e);this.lightColorId[e].setValue(a.gammaCorrection?h._linearFinalColor.data:h._finalColor.data);g.getY(h._direction).scale(-1);this.lightDirId[e].setValue(h._direction.normalize().data);if(h.castShadows){var k=h._isPcf&&this.device.webgl2?h._shadowCamera.renderTarget.depthBuffer:h._shadowCamera.renderTarget.colorBuffer;h._isVsm?g=-2E-4:(g=h.shadowBias/h._shadowCamera._farClip*100,!this.device.webgl2&&this.device.extStandardDerivatives&&(g*=-100));var l=h._isVsm?h.vsmBias/(h._shadowCamera._farClip/
7):h._normalOffsetBias;this.lightShadowMapId[e].setValue(k);this.lightShadowMatrixId[e].setValue(h._shadowMatrix.data);k=h._rendererParams;3!==k.length&&(k.length=3);k[0]=h._shadowResolution;k[1]=l;k[2]=g;this.lightShadowParamsId[e].setValue(k);0>this.mainLight&&(this.lightShadowMatrixVsId[e].setValue(h._shadowMatrix.data),this.lightShadowParamsVsId[e].setValue(k),this.lightDirVsId[e].setValue(h._direction.normalize().data),this.mainLight=f)}e++}return e},dispatchPointLight:function(a,b,c,d){var f=
...
this.lightCookieOffsetId[d].setValue(c._cookieOffset.data)))},dispatchLocalLights:function(a,b,c,d){var f,h=a._localLights,g=h[pc.LIGHTTYPE_POINT-1],h=h[pc.LIGHTTYPE_SPOT-1],e=g.length,p=h.length,k=c,l=this.device.scope;for(c=0;c<e;c++)f=g[c],f._mask&b&&!f.isStatic&&(this.dispatchPointLight(a,l,f,k),k++);g=0;if(d)for(f=d[g];f&&f._type===pc.LIGHTTYPE_POINT;)this.dispatchPointLight(a,l,f,k),k++,g++,f=d[g];for(c=0;c<p;c++)f=h[c],f._mask&b&&!f.isStatic&&(this.dispatchSpotLight(a,l,f,k),k++);if(d)for(f=
d[g];f&&f._type===pc.LIGHTTYPE_SPOT;)this.dispatchSpotLight(a,l,f,k),k++,g++,f=d[g]},cull:function(a,b){U.length=0;var c,d,f,h=b.length,g=a.cullingMask||4294967295;if(!a.frustumCulling){for(c=0;c<h;c++)if(d=b[c],d.visible||d.command)d.mask&&0===(d.mask&g)||U.push(d);return U}for(c=0;c<h;c++)d=b[c],d.command?U.push(d):d.visible&&(f=!0,d.mask&&0===(d.mask&g)||(d.layer>pc.LAYER_FX&&d.cull&&(f=this._isVisible(a,d)),f&&U.push(d)));return U},calculateSortDistances:function(a,b,c,d){var f,h,g,e,p,k,l=a.length;
for(f=0;f<l;f++)h=a[f],h.command||h.layer<=pc.scene.LAYER_FX||(g=h.material.blendType,g!==pc.BLEND_NONE?(e=h.aabb.center.data,p=e[0]-b[0],k=e[1]-b[1],e=e[2]-b[2],h.zdist=p*c[0]+k*c[1]+e*c[2]):h.material.alphaTest||h.material.alphaToCoverage?h.zdist=Number.MAX_VALUE:void 0!==h.zdist&&delete h.zdist,d&&g===pc.BLEND_NONE&&(e=h.aabb.center.data,p=e[0]-b[0],k=e[1]-b[1],e=e[2]-b[2],h.zdist2=p*c[0]+k*c[1]+e*c[2]))},updateCpuSkinMatrices:function(a){var b=a.length;if(0!==b){var c,d;for(c=0;c<b;c++)if(d=a[c].skinInstance)d.updateMatrices(),
...
d){if(a.extInstancing){var f=b.length,h,g,e,p,k,l,m=0;if(a.enableAutoInstancing){for(h=0;h<f-1;h++){g=b[h];e=g.mesh;l=g._key[c];p=h+1;k=0;if(b[p].mesh===e&&b[p]._key[c]===l){for(h=0;16>h;h++)pc._autoInstanceBufferData[m+h]=g.node.worldTransform.data[h];for(k=1;p!==f&&b[p].mesh===e&&b[p]._key[c]===l;){for(h=0;16>h;h++)pc._autoInstanceBufferData[m+16*k+h]=b[p].node.worldTransform.data[h];k++;p++}e=g.instancingData;e||(g.instancingData=e={});e.count=k;e.offset=4*m;e._buffer=pc._autoInstanceBuffer;h=
p-1}m+=16*k}0<m&&pc._autoInstanceBuffer.unlock()}for(h=0;h<f;h++)g=b[h],g.instancingData?(g._shaderDefs&pc.SHADERDEF_INSTANCING||(g._shaderDefs|=pc.SHADERDEF_INSTANCING,g._shader[d]=null),g.instancingData._buffer||(g.instancingData._buffer=new pc.VertexBuffer(a,pc._instanceVertexFormat,g.instancingData.count,g.instancingData.usage,g.instancingData.buffer))):g._shaderDefs&pc.SHADERDEF_INSTANCING&&(g._shaderDefs&=~pc.SHADERDEF_INSTANCING,g._shader[d]=null)}},setBaseConstants:function(a,b){a.setCullMode(b.cull);
...
b,c,g){var e,p,l,m,n,q,t,w,y,B,x,H,N,E,Q,C,F,I;for(l=0;l<g.length;l++)if(m=g[l],q=m._type,m.castShadows&&m._enabled&&m.shadowUpdateMode!==pc.SHADOWUPDATE_NONE){t=this.getShadowCamera(a,m);w=t._node;y=m._node;B=1;w.setPosition(y.getPosition());w.setRotation(y.getRotation());w.rotateLocal(-90,0,0);if(q===pc.LIGHTTYPE_DIRECTIONAL){C=m.shadowDistance||b._farClip;x=T;H=b._nearClip;N=b._fov*Math.PI/180;e=b._aspect;p=b._projection;F=p===pc.PROJECTION_PERSPECTIVE?Math.tan(N/2)*H:b._orthoHeight;Q=F*e;x[0].x=
Q;x[0].y=-F;x[0].z=-H;x[1].x=Q;x[1].y=F;x[1].z=-H;x[2].x=-Q;x[2].y=F;x[2].z=-H;x[3].x=-Q;x[3].y=-F;x[3].z=-H;p===pc.PROJECTION_PERSPECTIVE&&(F=Math.tan(N/2)*C,Q=F*e);x[4].x=Q;x[4].y=-F;x[4].z=-C;x[5].x=Q;x[5].y=F;x[5].z=-C;x[6].x=-Q;x[6].y=F;x[6].z=-C;x[7].x=-Q;x[7].y=-F;x[7].z=-C;x=X.sub2(T[0],T[6]).length();x=Math.max(x,X.sub2(T[4],T[6]).length());v.copy(w.getWorldTransform()).invert();z.copy(v).mul(b._node.worldTransform);for(e=0;8>e;e++)z.transformPoint(T[e],T[e]);Q=C=F=1E6;N=H=p=-1E6;for(e=0;8>
e;e++)E=T[e],E.x<Q&&(Q=E.x),E.x>N&&(N=E.x),E.y<C&&(C=E.y),E.y>H&&(H=E.y),E.z<F&&(F=E.z),E.z>p&&(p=E.z);e=x/m._shadowResolution;N=.5*(x-(N-Q));Q=Math.floor((Q-N)/e)*e;N=.5*(x-(H-C));C=Math.floor((C-N)/e)*e;N=Q+x;H=C+x;Q=.5*(N+Q);C=.5*(H+C);w.translateLocal(Q,C,1E5);t.projection=pc.PROJECTION_ORTHOGRAPHIC;t.nearClip=0;t.farClip=2E5;t.aspectRatio=1;t.orthoHeight=.5*x}else if(q===pc.LIGHTTYPE_SPOT){if(b.frustumCulling&&m.shadowUpdateMode===pc.SHADOWUPDATE_REALTIME&&(m.getBoundingSphere(V),!b.frustum.containsSphere(V)))continue;
t.projection=pc.PROJECTION_PERSPECTIVE;t.nearClip=m.attenuationEnd/1E3;t.farClip=m.attenuationEnd;t.aspectRatio=1;t.fov=2*m._outerConeAngle;this.viewPosId.setValue(w.getPosition().data);this.shadowMapLightRadiusId.setValue(m.attenuationEnd)}else if(q===pc.LIGHTTYPE_POINT){if(b.frustumCulling&&m.shadowUpdateMode===pc.SHADOWUPDATE_REALTIME&&(m.getBoundingSphere(V),!b.frustum.containsSphere(V)))continue;t.projection=pc.PROJECTION_PERSPECTIVE;t.nearClip=m.attenuationEnd/1E3;t.farClip=m.attenuationEnd;
...
pc.SHADOWUPDATE_THISFRAME&&(m.shadowUpdateMode=pc.SHADOWUPDATE_NONE);this._shadowMapUpdates+=B;for(x=0;x<B;x++){a.setBlending(!1);a.setDepthWrite(!0);a.setDepthTest(!0);m._isPcf&&a.webgl2&&q!==pc.LIGHTTYPE_POINT?a.setColorWrite(!1,!1,!1,!1):a.setColorWrite(!0,!0,!0,!0);q===pc.LIGHTTYPE_POINT&&(0===x?w.setEulerAngles(0,90,180):1===x?w.setEulerAngles(0,-90,180):2===x?w.setEulerAngles(90,0,0):3===x?w.setEulerAngles(-90,0,0):4===x?w.setEulerAngles(0,180,180):5===x&&w.setEulerAngles(0,0,180),w.setPosition(y.getPosition()),
t.renderTarget=m._shadowCubeMap[x]);this.setCamera(t,q!==pc.LIGHTTYPE_POINT);e=U.length=0;for(E=c.length;e<E;e++)p=c[e],H=!0,p.cull&&(H=this._isVisible(t,p)),H&&U.push(p);this.updateGpuSkinMatrices(U);this.updateMorphing(U);H=m._shadowType;N=H+5*q;this.sortDrawCalls(U,this.depthSortCompare,pc.SORTKEY_DEPTH);this.prepareInstancing(a,U,pc.SORTKEY_DEPTH,pc.SHADER_SHADOW+N);if(q===pc.LIGHTTYPE_DIRECTIONAL){E=!0;for(e=0;e<U.length;e++)p=U[e],p=p.aabb,E?(ba.copy(p),E=!1):ba.add(p);e=v;p=ba.getMin();E=ba.getMax();
O[0].x=O[1].x=O[2].x=O[3].x=p.x;O[1].y=O[3].y=O[7].y=O[5].y=p.y;O[2].z=O[3].z=O[6].z=O[7].z=p.z;O[4].x=O[5].x=O[6].x=O[7].x=E.x;O[0].y=O[2].y=O[4].y=O[6].y=E.y;O[0].z=O[1].z=O[4].z=O[5].z=E.z;I=9999999999;p=-9999999999;for(n=0;8>n;++n)e.transformPoint(O[n],O[n]),E=O[n].z,E<I&&(I=E),E>p&&(p=E);e=I;e>F&&(F=e);w.setPosition(y.getPosition());w.translateLocal(Q,C,p+.01);t.farClip=p-F;this.setCamera(t,!0)}q!==pc.LIGHTTYPE_POINT&&(v.setTRS(w.getPosition(),w.getRotation(),pc.Vec3.ONE).invert(),A.mul2(t.getProjectionMatrix(),
v),m._shadowMatrix.mul2(k,A));e=0;for(E=U.length;e<E;e++)p=U[e],I=p.mesh,n=p.material,this.setBaseConstants(a,n),this.setSkinning(a,p,n),n=p._shader[pc.SHADER_SHADOW+N],n||(n=this.findShadowShader(p,q,H),p._shader[pc.SHADER_SHADOW+N]=n,p._key[pc.SORTKEY_DEPTH]=h(p)),a.setShader(n),n=p.renderStyle,a.setVertexBuffer(p.morphInstance&&p.morphInstance._vertexBuffer?p.morphInstance._vertexBuffer:I.vertexBuffer,0),a.setIndexBuffer(I.indexBuffer[n]),e+=this.drawInstance(a,p,I,n),this._shadowDrawCalls++}m._isVsm&&
(q=m._vsmBlurSize,1<q&&(t=t.renderTarget,w=f(a,m._shadowResolution,m._shadowType,1),y=m.vsmBlurMode,B=(m._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[y][q],B||(this.blurVsmWeights[q]=d(q),B=pc.shaderChunks,(m._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[y][q]=B=B.createShaderFromCode(this.device,B.fullscreenQuadVS,"#define SAMPLES "+q+"\n"+(m._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShaderCode:this.blurVsmShaderCode)[y],"blurVsm"+y+""+
q+""+(m._shadowType===pc.SHADOW_VSM8))),u.z=m._shadowResolution-2,u.w=u.z,this.sourceId.setValue(t.colorBuffer),r.x=1/m._shadowResolution,r.y=0,this.pixelOffsetId.setValue(r.data),y===pc.BLUR_GAUSSIAN&&this.weightId.setValue(this.blurVsmWeights[q]),pc.drawQuadWithShader(a,w,B,null,u),this.sourceId.setValue(w.colorBuffer),r.y=r.x,r.x=0,this.pixelOffsetId.setValue(r.data),pc.drawQuadWithShader(a,t,B,null,u)))}a.webgl2?a.setDepthBias(!1):a.extStandardDerivatives&&(this.polygonOffset[0]=0,this.polygonOffset[1]=
0,this.polygonOffsetId.setValue(this.polygonOffset))},findDepthShader:function(a){var b=a.material;return this.library.getProgram("depth",{skin:!!a.skinInstance,opacityMap:!!b.opacityMap,opacityChannel:b.opacityMap?b.opacityMapChannel||"r":null,instancing:a.instancingData})},filterDepthMapDrawCalls:function(a){ca.length=0;for(var b,c=0;c<a.length;c++)b=a[c],!b.command&&b.drawToDepth&&b.material.blendType===pc.BLEND_NONE&&ca.push(b);return ca},renderDepth:function(a,b,c){if(b._renderDepthRequests){var d,
f=b._rect,e=b.renderTarget;d=e?e.width:a.width;var g=e?e.height:a.height;d=Math.floor(f.width*d);var g=Math.floor(f.height*g),p,k,f=b.vrDisplay,e=.5*a.width;c=this.filterDepthMapDrawCalls(c);var l=c.length;this.sortDrawCalls(c,this.depthSortCompare,pc.SORTKEY_DEPTH);this.prepareInstancing(a,c,pc.SORTKEY_DEPTH,pc.SHADER_DEPTH);!b._depthTarget||b._depthTarget.width===d&&b._depthTarget.height===g||(b._depthTarget.destroy(),b._depthTarget=null);b._depthTarget||(d=new pc.Texture(a,{format:pc.PIXELFORMAT_R8_G8_B8_A8,
width:d,height:g}),d.minFilter=pc.FILTER_NEAREST,d.magFilter=pc.FILTER_NEAREST,d.addressU=pc.ADDRESS_CLAMP_TO_EDGE,d.addressV=pc.ADDRESS_CLAMP_TO_EDGE,b._depthTarget=new pc.RenderTarget(a,d,{depth:!0,stencil:a.supportsStencil}));a.setBlending(!1);a.setColorWrite(!0,!0,!0,!0);a.setDepthWrite(!0);a.setDepthTest(!0);var n=b.renderTarget,q=b._clearOptions;b.renderTarget=b._depthTarget;b._clearOptions=m;this.setCamera(b);for(d=0;d<l;d++)g=c[d],p=g.mesh,k=g.material,b._cullFaces?b._flipFaces?a.setCullMode(0<
k.cull?k.cull===pc.CULLFACE_FRONT?pc.CULLFACE_BACK:pc.CULLFACE_FRONT:0):a.setCullMode(k.cull):a.setCullMode(pc.CULLFACE_NONE),k.opacityMap&&(this.opacityMapId.setValue(k.opacityMap),this.alphaTestId.setValue(k.alphaTest)),this.setSkinning(a,g,k),k=g._shader[pc.SHADER_DEPTH],k||(k=this.findDepthShader(g),g._shader[pc.SHADER_DEPTH]=k,g._key[pc.SORTKEY_DEPTH]=h(g)),a.setShader(k),k=g.renderStyle,a.setVertexBuffer(g.morphInstance&&g.morphInstance._vertexBuffer?g.morphInstance._vertexBuffer:p.vertexBuffer,
0),a.setIndexBuffer(p.indexBuffer[k]),f&&f.presenting?(a.setViewport(0,0,e,a.height),this.viewProjId.setValue(aa.data),this.viewPosId.setValue(J.data),d+=this.drawInstance(a,g,p,k,!0),this._depthDrawCalls++,a.setViewport(e,0,e,a.height),this.viewProjId.setValue(S.data),this.viewPosId.setValue(G.data),d+=this.drawInstance2(a,g,p,k)):d+=this.drawInstance(a,g,p,k),this._depthDrawCalls++;b.renderTarget=n;b._clearOptions=q}else b._depthTarget&&(b._depthTarget.destroy(),b._depthTarget=null)},renderForward:function(a,
b,c,d,f){var h=c.length,g=b.vrDisplay;this.sortDrawCalls(c,this.frontToBack?this.sortCompare:this.sortCompareMesh,pc.SORTKEY_FORWARD);this.prepareInstancing(a,c,pc.SORTKEY_FORWARD,f);var e,p,k,l,m,n,q,r;r=null;var u,v,t;a.setColorWrite(!0,!0,!0,!0);this.setCamera(b);this.dispatchGlobalLights(d);if(d.fog!==pc.FOG_NONE){this.fogColor[0]=d.fogColor.data[0];this.fogColor[1]=d.fogColor.data[1];this.fogColor[2]=d.fogColor.data[2];if(d.gammaCorrection)for(e=0;3>e;e++)this.fogColor[e]=Math.pow(this.fogColor[e],
2.2);this.fogColorId.setValue(this.fogColor);d.fog===pc.FOG_LINEAR?(this.fogStartId.setValue(d.fogStart),this.fogEndId.setValue(d.fogEnd)):this.fogDensityId.setValue(d.fogDensity)}this._screenSize.x=a.width;this._screenSize.y=a.height;this._screenSize.z=1/a.width;this._screenSize.w=1/a.height;this.screenSizeId.setValue(this._screenSize.data);var A=.5*a.width;b._depthTarget&&this.depthMapId.setValue(b._depthTarget.colorBuffer);for(e=0;e<h;e++)if(p=c[e],p.command)p.command();else{k=p.mesh;l=p.material;
m=p._shaderDefs;q=p.mask;this.setSkinning(a,p,l);l&&l===r&&m!==n&&(r=null);if(p.isStatic||v)r=null;if(l!==r){this._materialSwitches++;p._shader[f]&&p._shaderDefs===m||(p.isStatic?(l.updateShader(a,d,m,p._staticLightList,f),p._shader[f]=l.shader):(n=f+"_"+m,p._shader[f]=l.variants[n],p._shader[f]||(l.updateShader(a,d,m,null,f),p._shader[f]=l.variants[n]=l.shader)),p._shaderDefs=m);a.setShader(p._shader[f]);n=l.parameters;for(t in n)v=n[t],v.scopeId||(v.scopeId=a.scope.resolve(t)),v.scopeId.setValue(v.data);
r&&q===u||(r=this.dispatchDirectLights(d,q),this.dispatchLocalLights(d,q,r,p._staticLightList));this.alphaTestId.setValue(l.alphaTest);a.setBlending(l.blend);l.blend&&(l.separateAlphaBlend?(a.setBlendFunctionSeparate(l.blendSrc,l.blendDst,l.blendSrcAlpha,l.blendDstAlpha),a.setBlendEquationSeparate(l.blendEquation,l.blendAlphaEquation)):(a.setBlendFunction(l.blendSrc,l.blendDst),a.setBlendEquation(l.blendEquation)));a.setColorWrite(l.redWrite,l.greenWrite,l.blueWrite,l.alphaWrite);b._cullFaces?b._flipFaces?
a.setCullMode(0<l.cull?l.cull===pc.CULLFACE_FRONT?pc.CULLFACE_BACK:pc.CULLFACE_FRONT:0):a.setCullMode(l.cull):a.setCullMode(pc.CULLFACE_NONE);a.setDepthWrite(l.depthWrite);a.setDepthTest(l.depthTest);a.setAlphaToCoverage(l.alphaToCoverage);r=l.stencilFront;u=l.stencilBack;r||u?(a.setStencilTest(!0),r===u?(a.setStencilFunc(r.func,r.ref,r.readMask),a.setStencilOperation(r.fail,r.zfail,r.zpass,r.writeMask)):(r?(a.setStencilFuncFront(r.func,r.ref,r.readMask),a.setStencilOperationFront(r.fail,r.zfail,
r.zpass,r.writeMask)):(a.setStencilFuncFront(pc.FUNC_ALWAYS,0,255),a.setStencilOperationFront(pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,pc.STENCILOP_KEEPP,255)),u?(a.setStencilFuncBack(u.func,u.ref,u.readMask),a.setStencilOperationBack(u.fail,u.zfail,u.zpass,u.writeMask)):(a.setStencilFuncBack(pc.FUNC_ALWAYS,0,255),a.setStencilOperationBack(pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,255)))):a.setStencilTest(!1)}n=p.parameters;for(t in n)v=n[t],v.scopeId||(v.scopeId=a.scope.resolve(t)),v.scopeId.setValue(v.data);
a.setVertexBuffer(p.morphInstance&&p.morphInstance._vertexBuffer?p.morphInstance._vertexBuffer:k.vertexBuffer,0);r=p.renderStyle;a.setIndexBuffer(k.indexBuffer[r]);g&&g.presenting?(a.setViewport(0,0,A,a.height),this.projId.setValue(D.data),this.viewInvId.setValue(C.data),this.viewId.setValue(K.data),this.viewId3.setValue(W.data),this.viewProjId.setValue(aa.data),this.viewPosId.setValue(J.data),e+=this.drawInstance(a,p,k,r,!0),this._forwardDrawCalls++,a.setViewport(A,0,A,a.height),this.projId.setValue(M.data),
this.viewInvId.setValue(F.data),this.viewId.setValue(L.data),this.viewId3.setValue(Z.data),this.viewProjId.setValue(S.data),this.viewPosId.setValue(G.data),e+=this.drawInstance2(a,p,k,r)):e+=this.drawInstance(a,p,k,r,!0);this._forwardDrawCalls++;if(e<h-1&&c[e+1].material===l)for(t in n)(v=l.parameters[t])&&v.scopeId.setValue(v.data);r=l;n=m;u=q;v=p.isStatic}a.setStencilTest(!1);a.setAlphaToCoverage(!1);a.updateEnd()},sortLights:function(a){var b,c=a._lights;a._globalLights.length=0;a._localLights[0].length=
0;for(ea=a._localLights[1].length=0;ea<c.length;ea++)b=c[ea],b._enabled&&(b._type===pc.LIGHTTYPE_DIRECTIONAL?a._globalLights.push(b):a._localLights[b._type===pc.LIGHTTYPE_POINT?0:1].push(b));return c},setupInstancing:function(a){pc._instanceVertexFormat||(pc._instanceVertexFormat=new pc.VertexFormat(a,[{semantic:pc.SEMANTIC_TEXCOORD2,components:4,type:pc.ELEMENTTYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD3,components:4,type:pc.ELEMENTTYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD4,components:4,type:pc.ELEMENTTYPE_FLOAT32},
{semantic:pc.SEMANTIC_TEXCOORD5,components:4,type:pc.ELEMENTTYPE_FLOAT32}]));a.enableAutoInstancing&&!pc._autoInstanceBuffer&&(pc._autoInstanceBuffer=new pc.VertexBuffer(a,pc._instanceVertexFormat,a.autoInstancingMaxObjects,pc.BUFFER_DYNAMIC),pc._autoInstanceBufferData=new Float32Array(pc._autoInstanceBuffer.lock()))},prepareStaticMeshes:function(a,b){var c,d,f,h,e,g=b.drawCalls,p=b._lights,k=g.length,l,m,n=[];if(!b._needsStaticPrepare){var q;for(c=0;c<k;c++)l=g[c],l._staticSource?l._staticSource!==
q&&(n.push(l._staticSource),q=l._staticSource):n.push(l);g=n;k=g.length;n=[]}var r,u,v,t,A,z,w,x,y,X,B,N,E,ba;q=new pc.Vec3;var C=new pc.Vec3;new pc.BoundingBox;var F=new pc.BoundingBox,U=new pc.Mat4,I=[],J,D,ca=[],H=[],K=[];for(c=0;c<k;c++)if(l=g[c],l.isStatic){r=l.aabb;K.length=0;for(J=pc.LIGHTTYPE_POINT;J<=pc.LIGHTTYPE_SPOT;J++)for(d=0;d<p.length;d++)m=p[d],m._type===J&&m._enabled&&m._mask&l.mask&&m.isStatic&&(ca[d]||(ca[d]=new pc.BoundingBox,m._node.getWorldTransform(),m.getBoundingSphere(V),
ca[d].center.copy(V.center),ca[d].halfExtents.x=V.radius,ca[d].halfExtents.y=V.radius,ca[d].halfExtents.z=V.radius),ca[d].intersects(r)&&K.push(d));if(0===K.length)n.push(l);else{r=l.mesh;J=r.vertexBuffer;m=r.indexBuffer[l.renderStyle];u=2===m.bytesPerIndex?new Uint16Array(m.lock()):new Uint32Array(m.lock());v=r.primitive[l.renderStyle].count/3;w=r.primitive[l.renderStyle].base;t=J.format.elements;A=J.format.size/4;r=new Float32Array(J.storage);for(f=0;f<t.length;f++)t[f].name===pc.SEMANTIC_POSITION&&
(z=t[f].offset/4);I.length=v;for(f=0;f<v;f++)I[f]=0;t=!1;H.length=6*v;for(f=0;f<v;f++){B=X=y=Number.MAX_VALUE;N=-Number.MAX_VALUE;E=-Number.MAX_VALUE;ba=-Number.MAX_VALUE;for(h=0;3>h;h++)d=u[3*f+h+w],d=d*A+z,e=r[d],x=r[d+1],d=r[d+2],e<y&&(y=e),x<X&&(X=x),d<B&&(B=d),e>N&&(N=e),x>E&&(E=x),d>ba&&(ba=d);d=6*f;H[d]=y;H[d+1]=X;H[d+2]=B;H[d+3]=N;H[d+4]=E;H[d+5]=ba}for(e=0;e<K.length;e++)for(d=K[e],U.copy(l.node.worldTransform).invert(),F.setFromTransformedAabb(ca[d],U),x=F.getMin().data,y=F.getMax().data,
h=1<<e,f=0;f<v;f++)d=6*f,H[d]<=y[0]&&H[d+3]>=x[0]&&H[d+1]<=y[1]&&H[d+4]>=x[1]&&H[d+2]<=y[2]&&H[d+5]>=x[2]&&(I[f]|=h,t=!0);if(t){t={};for(f=0;f<v;f++)d=3*f+w,D=I[f],t[D]||(t[D]=[]),h=t[D],h.push(u[d]),h.push(u[d+1]),h.push(u[d+2]);for(D in t){h=t[D];u=new pc.IndexBuffer(a,m.format,h.length,m.usage);(2===u.bytesPerIndex?new Uint16Array(u.lock()):new Uint32Array(u.lock())).set(h);u.unlock();B=X=y=Number.MAX_VALUE;N=-Number.MAX_VALUE;E=-Number.MAX_VALUE;ba=-Number.MAX_VALUE;for(f=0;f<h.length;f++)d=h[f],
e=r[d*A+z],x=r[d*A+z+1],d=r[d*A+z+2],e<y&&(y=e),x<X&&(X=x),d<B&&(B=d),e>N&&(N=e),x>E&&(E=x),d>ba&&(ba=d);q.set(y,X,B);C.set(N,E,ba);f=new pc.BoundingBox;f.setMinMax(q,C);v=new pc.Mesh;v.vertexBuffer=J;v.indexBuffer[0]=u;v.primitive[0].type=pc.PRIMITIVE_TRIANGLES;v.primitive[0].base=0;v.primitive[0].count=h.length;v.primitive[0].indexed=!0;v.aabb=f;u=new pc.MeshInstance(l.node,v,l.material);u.isStatic=l.isStatic;u.visible=l.visible;u.layer=l.layer;u.castShadow=l.castShadow;u._receiveShadow=l._receiveShadow;
u.drawToDepth=l.drawToDepth;u.cull=l.cull;u.pick=l.pick;u.mask=l.mask;u.parameters=l.parameters;u._shaderDefs=l._shaderDefs;u._staticSource=l;u._staticLightList=l._staticLightList?l._staticLightList:[];for(f=0;f<K.length;f++)h=1<<f,D&h&&(v=p[K[f]],0>u._staticLightList.indexOf(v)&&u._staticLightList.push(v));u._staticLightList.sort(this.lightCompare);n.push(u)}}else n.push(l)}}else n.push(l);b.drawCalls=n},render:function(a,b){var c=this.device;a._activeCamera=b;a.updateShaders&&(a.updateShadersFunc(c),
a.updateShaders=!1);a._needsStaticPrepare&&(this.prepareStaticMeshes(c,a),a._needsStaticPrepare=!1);var d=b.renderTarget,f=!1,h=a.exposure;d&&d.colorBuffer&&(d=d.colorBuffer.format,d===pc.PIXELFORMAT_RGB16F||d===pc.PIXELFORMAT_RGB32F||d===pc.PIXELFORMAT_RGBA16F||d===pc.PIXELFORMAT_RGBA32F||d===pc.PIXELFORMAT_111110F)&&(f=!0,a.exposure=1);var e,d=a.drawCalls;e=a.shadowCasters;var g=this.sortLights(a),p=b._node.getPosition().data,l=b._node.forward.data;this.setupInstancing(c);this.updateCameraFrustum(b);
this.updateCpuSkinMatrices(d);this.updateMorphedBounds(d);this.renderShadows(c,b,e,g);d=this.cull(b,d);this.calculateSortDistances(d,p,l,this.frontToBack);this.updateGpuSkinMatrices(d);this.updateMorphing(d);for(e=0;e<a.immediateDrawCalls.length;e++)d.push(a.immediateDrawCalls[e]);this._immediateRendered+=a.immediateDrawCalls.length;this.renderDepth(c,b,d);this.renderForward(c,b,d,a,f?pc.SHADER_FORWARDHDR:pc.SHADER_FORWARD);c.setColorWrite(!0,!0,!0,!0);0<a.immediateDrawCalls.length&&(a.immediateDrawCalls=
[]);f&&(a.exposure=h);this._camerasRendered++}});return{ForwardRenderer:p,gaussWeights:d}}());pc.extend(pc,function(){var e=new pc.Mat4,a=new pc.Vec3,b=new pc.Quat,c=new pc.Quat,d=new pc.Vec3,f=new pc.Vec3,g=function(a){this.name="string"===typeof a?a:"Untitled";this.tags=new pc.Tags(this);this._labels={};this.localPosition=new pc.Vec3(0,0,0);this.localRotation=new pc.Quat(0,0,0,1);this.localScale=new pc.Vec3(1,1,1);this.localEulerAngles=new pc.Vec3(0,0,0);this.position=new pc.Vec3(0,0,0);this.rotation=new pc.Quat(0,0,0,1);this.eulerAngles=new pc.Vec3(0,0,0);this.localTransform=new pc.Mat4;
this.dirtyLocal=!1;this._aabbVer=0;this.worldTransform=new pc.Mat4;this.dirtyWorld=!1;this.normalMatrix=new pc.Mat3;this.dirtyNormal=!0;this._right=new pc.Vec3;this._up=new pc.Vec3;this._forward=new pc.Vec3;this._parent=null;this._children=[];this._enabled=!0;this.scaleCompensation=this._enabledInHierarchy=!1};Object.defineProperty(g.prototype,"right",{get:function(){return this.getWorldTransform().getX(this._right).normalize()}});Object.defineProperty(g.prototype,"up",{get:function(){return this.getWorldTransform().getY(this._up).normalize()}});
...
a.copy(b).invert(),this.localRotation.mul2(a,this.localRotation));this.dirtyLocal=!0}}(),addChild:function(a){if(null!==a._parent)throw Error("GraphNode is already parented");this._children.push(a);this._onInsertChild(a)},addChildAndSaveTransform:function(a){var b=a.getPosition(),c=a.getRotation(),d=a._parent;d&&d.removeChild(a);void 0===this.tmpMat4&&(this.tmpMat4=new pc.Mat4,this.tmpQuat=new pc.Quat);a.setPosition(this.tmpMat4.copy(this.worldTransform).invert().transformPoint(b));a.setRotation(this.tmpQuat.copy(this.getRotation()).invert().mul(c));
this._children.push(a);this._onInsertChild(a)},insertChild:function(a,b){if(null!==a._parent)throw Error("GraphNode is already parented");this._children.splice(b,0,a);this._onInsertChild(a)},_onInsertChild:function(a){a._parent=this;var b=a._enabled&&this.enabled;a._enabledInHierarchy!==b&&(a._enabledInHierarchy=b,a._notifyHierarchyStateChanged(a,b));a.dirtyWorld=!0;a.dirtyNormal=!0;a._aabbVer++;a.fire&&a.fire("insert",this)},removeChild:function(a){var b,c=this._children.length;for(b=0;b<c;++b)if(this._children[b]===
a){this._children.splice(b,1);a._parent=null;break}},addLabel:function(a){this._labels[a]=!0},getLabels:function(){return Object.keys(this._labels)},hasLabel:function(a){return!!this._labels[a]},removeLabel:function(a){delete this._labels[a]},findByLabel:function(a,b){var c,d=this._children.length;b=b||[];this.hasLabel(a)&&b.push(this);for(c=0;c<d;++c)b=this._children[c].findByLabel(a,b);return b},sync:function(){this.dirtyLocal&&(this.localTransform.setTRS(this.localPosition,this.localRotation,this.localScale),
this.dirtyLocal=!1,this.dirtyNormal=this.dirtyWorld=!0,this._aabbVer++);if(this.dirtyWorld){if(null===this._parent)this.worldTransform.copy(this.localTransform);else if(this.scaleCompensation){var g=this._parent,p=this.localScale,l=g;if(l){for(;l&&l.scaleCompensation;)l=l._parent;if(l&&(l=l._parent)){var k=l.worldTransform.getScale();d.mul2(k,this.localScale);p=d}}c.setFromMat4(g.worldTransform);b.mul2(c,this.localRotation);l=g.worldTransform;g.scaleCompensation&&(f.mul2(k,g.getLocalScale()),e.setTRS(g.worldTransform.getTranslation(a),
c,f),l=e);l.transformPoint(this.localPosition,a);this.worldTransform.setTRS(a,b,p)}else this.worldTransform.mul2(this._parent.worldTransform,this.localTransform);this.dirtyWorld=!1;p=0;for(k=this._children.length;p<k;p++)g=this._children[p],g.dirtyWorld=!0,g.dirtyNormal=!0,g._aabbVer++}},syncHierarchy:function(){var a=function(){if(this._enabled){this.sync();for(var b=this._children,c=0,d=b.length;c<d;c++)a.call(b[c])}};return a}(),lookAt:function(){var a=new pc.Mat4,b=new pc.Vec3,c=new pc.Vec3,d=
new pc.Quat;return function(f,e,g,h,p,k){if(f instanceof pc.Vec3)b.copy(f),e instanceof pc.Vec3?c.copy(e):c.copy(pc.Vec3.UP);else{if(void 0===g)return;b.set(f,e,g);void 0!==h?c.set(h,p,k):c.copy(pc.Vec3.UP)}a.setLookAt(this.getPosition(),b,c);d.setFromMat4(a);this.setRotation(d)}}(),translate:function(){var a=new pc.Vec3;return function(b,c,d){b instanceof pc.Vec3?a.copy(b):a.set(b,c,d);a.add(this.getPosition());this.setPosition(a)}}(),translateLocal:function(){var a=new pc.Vec3;return function(b,
c,d){b instanceof pc.Vec3?a.copy(b):a.set(b,c,d);this.localRotation.transformVector(a,a);this.localPosition.add(a);this.dirtyLocal=!0}}(),rotate:function(){var a=new pc.Quat,b=new pc.Quat;return function(c,d,f){c instanceof pc.Vec3?a.setFromEulerAngles(c.data[0],c.data[1],c.data[2]):a.setFromEulerAngles(c,d,f);null===this._parent?this.localRotation.mul2(a,this.localRotation):(c=this.getRotation(),d=this._parent.getRotation(),b.copy(d).invert(),a.mul2(b,a),this.localRotation.mul2(a,c));this.dirtyLocal=
!0}}(),rotateLocal:function(){var a=new pc.Quat;return function(b,c,d){b instanceof pc.Vec3?a.setFromEulerAngles(b.data[0],b.data[1],b.data[2]):a.setFromEulerAngles(b,c,d);this.localRotation.mul(a);this.dirtyLocal=!0}}()});return{GraphNode:g}}());pc.extend(pc,function(){var e=new pc.Vec3,a=new pc.Vec3,b=function(){this._projection=pc.PROJECTION_PERSPECTIVE;this._nearClip=.1;this._farClip=1E4;this._fov=45;this._orthoHeight=10;this._aspect=16/9;this.frustumCulling=this._horizontalFov=!1;this.cullingMask=4294967295;this._renderDepthRequests=0;this._projMatDirty=!0;this._projMat=new pc.Mat4;this._viewMat=new pc.Mat4;this._viewProjMat=new pc.Mat4;this.vrDisplay=null;this._rect={x:0,y:0,width:1,height:1};this._scissorRect={x:0,y:0,width:1,height:1};
...
a[1]*c[7]+a[2]*c[11]+1*c[15];e.x=.5*(e.x/a+1)*b;e.y=.5*(1-e.y/a)*f;return e},screenToWorld:function(b,d,f,g,h,p){void 0===p&&(p=new pc.Vec3);var c=this.getProjectionMatrix(),k=this._node.getWorldTransform();this._viewMat.copy(k).invert();this._viewProjMat.mul2(c,this._viewMat);c=this._viewProjMat.clone().invert();this._projection===pc.PROJECTION_PERSPECTIVE?(a.set(b/g*2-1,(h-d)/h*2-1,1),b=c.transformPoint(a),b.scale(1/(a.x*c.data[3]+a.y*c.data[7]+a.z*c.data[11]+c.data[15])),f/=this._farClip,p.lerp(this._node.getPosition(),
b,f)):(e.set(b/g*2-1,(h-d)/h*2-1,(this._farClip-f)/(this._farClip-this._nearClip)*2-1),c.transformPoint(e,p));return p},getClearOptions:function(){return this._clearOptions},getProjectionMatrix:function(){if(this._projMatDirty){if(this._projection===pc.PROJECTION_PERSPECTIVE)this._projMat.setPerspective(this._fov,this._aspect,this._nearClip,this._farClip,this._horizontalFov);else{var a=this._orthoHeight,b=a*this._aspect;this._projMat.setOrtho(-b,b,-a,a,this._nearClip,this._farClip)}this._projMatDirty=
...
(this._scene=b,this._processColor());var e=b._lights;this._mapXForms=[];var g=a.useTexCubeLod,h=!a.extTextureLod,p,k,l,m,n,q;this.useSkybox&&(p=b._skyboxPrefiltered[0],k=b._skyboxPrefiltered[1],l=b._skyboxPrefiltered[2],m=b._skyboxPrefiltered[3],n=b._skyboxPrefiltered[4],q=b._skyboxPrefiltered[5]);var r=this.prefilteredCubeMap128||p;k=this.prefilteredCubeMap64||k;l=this.prefilteredCubeMap32||l;m=this.prefilteredCubeMap16||m;n=this.prefilteredCubeMap8||n;q=this.prefilteredCubeMap4||q;if(r){var u=r&&
k&&l&&m&&n&&q;h&&u?(r.dpAtlas||(r.dpAtlas=pc.generateDpAtlas(a,[r,k,l,m,n,q]),r.sh=pc.shFromCubemap(m)),this.dpAtlas=r.dpAtlas,this.ambientSH=r.sh,this._setParameter("ambientSH[0]",this.ambientSH),this._setParameter("texture_sphereMap",this.dpAtlas)):g?6>r._levels.length?u?this._setParameter("texture_prefilteredCubeMap128",r):console.log("Can't use prefiltered cubemap: "+u+", "+g+", "+r._levels):this._setParameter("texture_prefilteredCubeMap128",r):u?(this._setParameter("texture_prefilteredCubeMap128",
r),this._setParameter("texture_prefilteredCubeMap64",k),this._setParameter("texture_prefilteredCubeMap32",l),this._setParameter("texture_prefilteredCubeMap16",m),this._setParameter("texture_prefilteredCubeMap8",n),this._setParameter("texture_prefilteredCubeMap4",q)):console.log("Can't use prefiltered cubemap: "+u+", "+g+", "+r._levels)}h=!1;(k=(k=(this.useMetalness?!0:!!this.specularMap)||!!this.sphereMap||!!this.cubeMap||!!this.dpAtlas)||(this.useMetalness?!0:!(0===this.specular.data[0]&&0===this.specular.data[1]&&
...
1!==this.diffuse.data[2])&&this.diffuseMapTint,specularTint:h,metalnessTint:this.useMetalness&&1>this.metalness,glossTint:!0,emissiveTint:n,opacityTint:1!==this.opacity&&this.blendType!==pc.BLEND_NONE,alphaTest:0<this.alphaTest,alphaToCoverage:this.alphaToCoverage,needsNormalFloat:this.normalizeNormalMap,sphereMap:!!this.sphereMap,cubeMap:!!this.cubeMap,dpAtlas:!!this.dpAtlas,ambientSH:!!this.ambientSH,useSpecular:k,rgbmReflection:q,hdrReflection:l,fixSeams:r?r.fixCubemapSeams:this.cubeMap?this.cubeMap.fixCubemapSeams:
!1,prefilteredCubemap:!!r,emissiveFormat:this.emissiveMap?this.emissiveMap.rgbm?1:this.emissiveMap.format===pc.PIXELFORMAT_RGBA32F?2:0:null,lightMapFormat:this.lightMap?this.lightMap.rgbm?1:this.lightMap.format===pc.PIXELFORMAT_RGBA32F?2:0:null,useRgbm:q||(this.emissiveMap?this.emissiveMap.rgbm:0)||(this.lightMap?this.lightMap.rgbm:0),specularAA:this.specularAntialias,conserveEnergy:this.conserveEnergy,occludeSpecular:this.occludeSpecular,occludeSpecularFloat:1!==this.occludeSpecularIntensity,occludeDirect:this.occludeDirect,
shadingModel:this.shadingModel,fresnelModel:this.fresnelModel,packedNormal:this.normalMap?this.normalMap.format===pc.PIXELFORMAT_DXT5:!1,forceFragmentPrecision:this.forceFragmentPrecision,fastTbn:this.fastTbn,cubeMapProjection:this.cubeMapProjection,chunks:this.chunks,customFragmentShader:this.customFragmentShader,refraction:!!this.refraction,useMetalness:this.useMetalness,blendType:this.blendType,skyboxIntensity:r===p&&r&&1!==b.skyboxIntensity,forceUv1:this.forceUv1,useTexCubeLod:g,msdf:!!this.msdfMap};
f===pc.SHADER_FORWARDHDR&&(b.gamma&&(b.gamma=pc.GAMMA_SRGBHDR),b.toneMap=pc.TONEMAP_LINEAR);p=g=f=!1;c&&(b.noShadow=0!==(c&pc.SHADERDEF_NOSHADOW),b.screenSpace=0!==(c&pc.SHADERDEF_SCREENSPACE),b.skin=0!==(c&pc.SHADERDEF_SKIN),b.useInstancing=0!==(c&pc.SHADERDEF_INSTANCING),0!==(c&pc.SHADERDEF_LM)&&(b.lightMapFormat=1,b.lightMap=!0,b.lightMapChannel="rgb",b.lightMapUv=1,b.lightMapTransform=0,b.lightMapWithoutAmbient=!this.lightMap,b.useRgbm=!0,0!==(c&pc.SHADERDEF_DIRLM)&&(b.dirLightMap=!0)),f=0!==
(c&pc.SHADERDEF_UV0),g=0!==(c&pc.SHADERDEF_UV1),p=0!==(c&pc.SHADERDEF_VCOLOR));for(var v in pc._matTex2D)if("opacity"!==v||this.blendType!==pc.BLEND_NONE||0!==this.alphaTest||this.alphaToCoverage)r=v+"Map",h=r+"VertexColor","height"!==v&&this[h]?p&&(r+="Channel",b[h]=this[h],b[r]=this[r],b.vertexColors=!0):this[r]&&(h=r+"Uv",k=!0,0!==this[h]||f||(k=!1),1!==this[h]||g||(k=!1),k&&(b[r]=!!this[r],k=r+"Transform",r+="Channel",b[k]=this._getMapTransformID(this[k],this[h]),b[r]=this[r],b[h]=this[h]));b.aoMapUv=
b.aoMapUv||this.aoUvSet;this._mapXForms=null;this.useLighting?(v=[],f=c?c>>16:1,this._collectLights(pc.LIGHTTYPE_DIRECTIONAL,e,v,f),this._collectLights(pc.LIGHTTYPE_POINT,e,v,f,d),this._collectLights(pc.LIGHTTYPE_SPOT,e,v,f,d),b.lights=v):b.lights=[];0===b.lights.length&&(b.noShadow=!1);this.shader=a.getProgramLibrary().getProgram("standard",b);c||(this.clearVariants(),this.variants[0]=this.shader);this.dirtyShader=!1}});(function(c){c.dirtyShader=!0;c.dirtyColor=!0;c._scene=null;p(c,"ambient",new pc.Color(.7,
.7,.7));p(c,"diffuse",new pc.Color(1,1,1));p(c,"specular",new pc.Color(0,0,0));p(c,"emissive",new pc.Color(0,0,0),!0);l(c,"shininess",25,function(a,b){return{name:"material_shininess",value:a.shadingModel===pc.SPECULAR_PHONG?Math.pow(2,.11*b):.01*b}});l(c,"heightMapFactor",1,function(a,b){return{name:"material_heightMapFactor",value:.025*b}});l(c,"opacity",1);l(c,"alphaTest",0);l(c,"bumpiness",1);l(c,"reflectivity",1);l(c,"occludeSpecularIntensity",1);l(c,"refraction",0);l(c,"refractionIndex",1/1.5);
...
m(c);q(c,"ambientTint",!1);q(c,"diffuseMapTint",!1);q(c,"specularMapTint",!1);q(c,"emissiveMapTint",!1);q(c,"fastTbn",!1);q(c,"specularAntialias",!1);q(c,"useMetalness",!1);q(c,"occludeDirect",!1);q(c,"normalizeNormalMap",!0);q(c,"conserveEnergy",!0);q(c,"occludeSpecular",pc.SPECOCC_AO);q(c,"shadingModel",pc.SPECULAR_BLINN);q(c,"fresnelModel",pc.FRESNEL_NONE);q(c,"cubeMapProjection",pc.CUBEPROJ_NONE);q(c,"customFragmentShader",null);q(c,"forceFragmentPrecision",null);q(c,"useFog",!0);q(c,"useLighting",
!0);q(c,"useGammaTonemap",!0);q(c,"useSkybox",!0);q(c,"forceUv1",!1);g(c,"diffuse",0,3);g(c,"specular",0,3);g(c,"emissive",0,3);g(c,"normal",0,-1);g(c,"metalness",0,1);g(c,"gloss",0,1);g(c,"opacity",0,1);g(c,"height",0,1);g(c,"ao",0,1);g(c,"light",1,3);g(c,"msdf",0,3);k(c,"cubeMap");k(c,"sphereMap");k(c,"dpAtlas");k(c,"prefilteredCubeMap128");k(c,"prefilteredCubeMap64");k(c,"prefilteredCubeMap32");k(c,"prefilteredCubeMap16");k(c,"prefilteredCubeMap8");k(c,"prefilteredCubeMap4");for(var d=0;d<a.length;d++)b[d]=
...
c}},addPrimitive:function(a,b,c,e){var d,f,g=[],h=0,q=a.length;for(d=0;d<q;d++)for(var n=a[d].index,r=0;4>r;r++)if(0<c.blendWeight.data[4*n+r]){var u=c.blendIndices.data[4*n+r],v=!0;for(f=0;f<h;f++)if(g[f]==u){v=!1;break}v&&(g[h]=u,f=this.getBoneRemap(u),h+=-1===f?1:0)}if(this.boneIndices.length+h>e)return!1;for(d=0;d<h;d++)this.boneIndices.push(g[d]);for(d=0;d<q;d++)this.addVertex(a[d],b[d],c);return!0},getBoneRemap:function(a){for(var b=0;b<this.boneIndices.length;b++)if(this.boneIndices[b]===a)return b;
return-1}};return{partitionSkin:function(d,f,g){var h,p,l,k;b(d);var m=d.vertices,q=d.skins,n,r=d.meshes,u=d.meshInstances,v=function(a){var b=new e;b.index=a;return b};for(h=q.length-1;0<=h;h--)if(q[h].boneNames.length>g){var A=q.splice(h,1)[0],z=[];for(p=0;p<r.length;p++)r[p].skin===A&&z.push(r[p]);for(p=0;p<z.length;p++)k=r.indexOf(z[p]),-1!==k&&r.splice(k,1);if(0===z.length)throw Error("partitionSkin: There should be at least one mesh that references a skin");var t=z[0].vertices;for(p=1;p<z.length;p++)if(z[p].vertices!==
t)throw Error("partitionSkin: All meshes that share a skin should also share the same vertex buffer");var w=[],y=[];l=[];var x=0;for(p=0;p<z.length;p++){n=z[p];for(var B=n.indices,C=n.base;C<n.base+n.count;){k=B[C++];y[0]=v(k);l[0]=k;k=B[C++];y[1]=v(k);l[1]=k;k=B[C++];y[2]=v(k);l[2]=k;for(var F=!1,K=x;K<w.length;K++)if(k=w[K],k.addPrimitive(y,l,t,g)){F=!0;break}F||(k=new a,k.originalMesh=n,k.addPrimitive(y,l,t,g),w.push(k))}x=w.length}n=[];z=[];for(p=0;p<w.length;p++)if(k=w[p],k.vertices.length&&
k.indices.length){y=n.length;l=k.vertices.length;x=z.length;B=k.indices.length;k.partition=p;k.vertexStart=y;k.vertexCount=l;k.indexStart=x;k.indexCount=B;C=0;for(F=y;C<l;)n[F++]=k.vertices[C++];C=0;for(F=x;C<B;)z[F++]=k.indices[C++]+y}y=[];for(p=0;p<w.length;p++){k=w[p];x=[];B=[];for(l=0;l<k.boneIndices.length;l++)x.push(A.inverseBindMatrices[k.boneIndices[l]]),B.push(A.boneNames[k.boneIndices[l]]);k={inverseBindMatrices:x,boneNames:B};y.push(k);q.push(k)}var L,A={};for(L in t)A[L]={components:t[L].components,
data:[],type:t[L].type};for(L in t)if("blendIndices"===L)for(k=A[L].data,p=0;p<n.length;p++)l=n[p].boneIndices,k.push(l[0],l[1],l[2],l[3]);else for(p=t[L],x=p.data,B=p.components,p=0;p<n.length;p++)for(k=n[p].index,l=0;l<B;l++)A[L].data.push(x[k*B+l]);m[m.indexOf(t)]=A;for(p=0;p<w.length;p++)for(k=w[p],n={aabb:{min:[0,0,0],max:[0,0,0]},vertices:A,skin:y[p],indices:z.splice(0,k.indexCount),type:"triangles",base:0,count:k.indexCount},r.push(n),l=u.length-1;0<=l;l--)u[l].mesh===k.originalMesh&&(u.push({mesh:n,
node:u[l].node}),f&&f.push({material:f[l].material,path:f[l].path}));for(p=0;p<w.length;p++)for(k=w[p],l=u.length-1;0<=l;l--)u[l].mesh===k.originalMesh&&(u.splice(l,1),f&&f.splice(l,1))}c(d)}}}());pc.extend(pc,function(){var e=new pc.Vec3,a=new pc.Vec3,b=function(a){this.aabb=new pc.BoundingBox;this._baseAabb=this._baseBuffer=null;this._targets=a;this._aabbDirty=this._dirty=!0;this._baseData=null;this._vertSizeF=this._offsetTF=this._offsetNF=this._offsetPF=0};pc.extend(b.prototype,{_setBaseMesh:function(a){this._baseBuffer=a.vertexBuffer;this._baseAabb=a._aabb;this._baseData=new Float32Array(this._baseBuffer.storage);for(var b=a=-1,c=-1,d=this._baseBuffer.format.elements,e=this._baseBuffer.format.size,
l=0;l<d.length;l++)d[l].name===pc.SEMANTIC_POSITION?a=d[l].offset:d[l].name===pc.SEMANTIC_NORMAL?b=d[l].offset:d[l].name===pc.SEMANTIC_TANGENT&&(c=d[l].offset);this._offsetPF=a/4;this._offsetNF=b/4;this._offsetTF=c/4;this._vertSizeF=e/4;this._dirty=!0},_calculateAabb:function(){if(this._baseBuffer){this.aabb.copy(this._baseAabb);var b,c,g,h,p,l,k,m=this._vertSizeF,q=this._offsetPF,n=this._baseData;for(c=0;c<this._targets.length;c++){h=this._targets[c];if(!h.aabb&&0<h.indices.length){h.aabb=this.aabb.clone();
e.set(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE);a.set(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE);b=h.indices.length;for(g=0;g<b;g++)p=h.indices[g],l=p*m+q,p=n[l]+h.deltaPositions[3*g],k=n[l+1]+h.deltaPositions[3*g+1],l=n[l+2]+h.deltaPositions[3*g+2],e.x>p&&(e.x=p),e.y>k&&(e.y=k),e.z>l&&(e.z=l),a.x<p&&(a.x=p),a.y<k&&(a.y=k),a.z<l&&(a.z=l);h.aabb.setMinMax(e,a)}h.aabb&&this.aabb.add(h.aabb)}this._aabbDirty=!1}},addTarget:function(a){this._targets.push(a);this._aabbDirty=!0},removeTarget:function(a){a=
...
update:function(a){this.morph._baseBuffer!==a.vertexBuffer&&this.morph._setBaseMesh(a);this._vertexData||this._setBaseMesh(a);var b,c=this.morph._targets,d=this._weights,e,l,k,m,q,n=this.morph._vertSizeF,r=this.morph._offsetPF,u=this.morph._offsetNF,v=this.morph._offsetTF,A=this._vertexData;A.set(this.morph._baseData);for(var z=0;z<c.length;z++)if(l=d[z],0!==l)for(e=c[z],a=e.indices.length,k=0;k<a;k++)q=3*k,b=e.indices[k],m=b*n+r,A[m]+=e.deltaPositions[q]*l,A[m+1]+=e.deltaPositions[q+1]*l,A[m+2]+=
e.deltaPositions[q+2]*l,e.deltaNormals&&(m=b*n+u,A[m]+=e.deltaNormals[q]*l,A[m+1]+=e.deltaNormals[q+1]*l,A[m+2]+=e.deltaNormals[q+2]*l,e.deltaTangents&&(q=4*k,m=b*n+v,A[m]+=e.deltaTangents[q]*l,A[m+1]+=e.deltaTangents[q+1]*l,A[m+2]+=e.deltaTangents[q+2]*l,A[m+3]+=e.deltaTangents[q+3]*l,A[m+3]=0<A[m+3]?1:-1));this._vertexBuffer.unlock()}};return{MorphTarget:function(a){if(a.indices)this.indices=a.indices;else{var b=a.deltaPositions;this.indices=[];this.indices.length=b.length;for(var c=0;c<b.length;c++)this.indices[c]=
...
this.meshInstances[a];-1===b.indexOf(c.material)&&b.push(c.material)}return b},clone:function(){var a,b,c=[],d=[],f=function(a){var b=a.clone();c.push(a);d.push(b);for(var e=0;e<a._children.length;e++)b.addChild(f(a._children[e]));return b},e=f(this.graph),h=[],p=[],l=[];for(a=0;a<this.skinInstances.length;a++){var k=this.skinInstances[a].skin,m=new pc.SkinInstance(k,e),q=[];for(b=0;b<k.boneNames.length;b++){var n=e.findByName(k.boneNames[b]);q.push(n)}m.bones=q;p.push(m)}for(a=0;a<this.morphInstances.length;a++)b=
new pc.MorphInstance(this.morphInstances[a].morph),l.push(b);for(a=0;a<this.meshInstances.length;a++)b=this.meshInstances[a],k=c.indexOf(b.node),k=new pc.MeshInstance(d[k],b.mesh,b.material),b.skinInstance&&(m=this.skinInstances.indexOf(b.skinInstance),k.skinInstance=p[m]),b.morphInstance&&(b=this.morphInstances.indexOf(b.morphInstance),k.morphInstance=l[b]),h.push(k);a=new pc.Model;a.graph=e;a.meshInstances=h;a.skinInstances=p;a.morphInstances=l;a.getGraph().syncHierarchy();return a},destroy:function(){for(var a=
this.meshInstances,b,c,d,f,e=0;e<a.length;e++){b=a[e];if(c=b.mesh)if(c._refCount--,1>c._refCount){c.vertexBuffer&&(c.vertexBuffer.destroy(),c.vertexBuffer=null);for(f=0;f<c.indexBuffer.length;f++)(d=c.indexBuffer[f])&&d.destroy();c.indexBuffer.length=0}(c=b.skinInstance)&&(c=c.boneTexture)&&c.destroy();b.skinInstance=null;(c=b.morphInstance)&&c.destroy();b.morphInstance=null;b.material=null}},generateWireframe:function(){var a,b,c,d,f,e,h,p,l,k,m=[];for(a=0;a<this.meshInstances.length;a++)e=this.meshInstances[a].mesh,
-1===m.indexOf(e)&&m.push(e);var q=[[0,1],[1,2],[2,0]];for(a=0;a<m.length;a++){e=m[a];h=e.primitive[pc.RENDERSTYLE_SOLID].base;p=e.primitive[pc.RENDERSTYLE_SOLID].count;l=e.indexBuffer[pc.RENDERSTYLE_SOLID];k=new Uint16Array(l.lock());var n={},r=[];for(b=h;b<h+p;b+=3)for(c=0;3>c;c++){d=k[b+q[c][0]];f=k[b+q[c][1]];var u=d>f?f<<16|d:d<<16|f;void 0===n[u]&&(n[u]=0,r.push(d,f))}l.unlock();b=new pc.IndexBuffer(l.device,pc.INDEXFORMAT_UINT16,r.length);c=new Uint16Array(b.lock());c.set(r);b.unlock();e.primitive[pc.RENDERSTYLE_WIREFRAME]=
...
a("startAngle",0);a("startAngle2",this.startAngle);a("animTilesX",1);a("animTilesY",1);a("animNumFrames",1);a("animSpeed",1);a("animLoop",!0);this.frameRandom=new pc.Vec3(0,0,0);a("colorGraph",m);a("colorGraph2",this.colorGraph);a("scaleGraph",l);a("scaleGraph2",this.scaleGraph);a("alphaGraph",l);a("alphaGraph2",this.alphaGraph);a("localVelocityGraph",k);a("localVelocityGraph2",this.localVelocityGraph);a("velocityGraph",k);a("velocityGraph2",this.velocityGraph);a("rotationSpeedGraph",p);a("rotationSpeedGraph2",
...
this.precision,p=[this.qVelocity,this.qVelocity2,this.qLocalVelocity,this.qLocalVelocity2],k=[0,0,0,0],l=[0,0,0,0],m=[0,0,0,0],n,q,r,u,t,v;for(n=0;n<this.precision+1;n++){r=Math.min(n,this.precision-1);for(q=0;4>q;q++)u=p[q][3*r]*h+k[q],t=p[q][3*r+1]*h+l[q],v=p[q][3*r+2]*h+m[q],a>u&&(a=u),b>t&&(b=t),c>v&&(c=v),d<u&&(d=u),f<t&&(f=t),e<v&&(e=v),k[q]=u,l[q]=t,m[q]=v;g=Math.max(g,this.qScale[r])}this.emitterShape===pc.EMITTERSHAPE_BOX?(u=.5*this.emitterExtents.x,t=.5*this.emitterExtents.y,v=.5*this.emitterExtents.z):
...
this.frameRandom.x=Math.random();this.frameRandom.y=Math.random();this.frameRandom.z=Math.random();this.particleTex=new Float32Array(this.numParticlesPot*q*4);var c=null===this.node||this.localSpace?pc.Vec3.ZERO:this.node.getPosition();this.emitterShape===pc.EMITTERSHAPE_BOX&&(null===this.node?L.setTRS(pc.Vec3.ZERO,pc.Quat.IDENTITY,this.spawnBounds):L.setTRS(pc.Vec3.ZERO,this.node.getRotation(),D.copy(this.spawnBounds).mul(this.node.localScale)));for(a=0;a<this.numParticles;a++)this.calcSpawnPosition(c,
...
this.qAlpha2,this.alphaUMax);if(this.pack8){var g=[0,0,0];c(this.qVelocity,g);var p=[0,0,0];c(this.qVelocity2,p);e=[0,0,0];c(this.qLocalVelocity,e);var k=[0,0,0];c(this.qLocalVelocity2,k);var l=Math.max(g[0],p[0]),l=Math.max(l,g[1]),l=Math.max(l,p[1]),l=Math.max(l,g[2]),l=Math.max(l,p[2]),g=Math.max(e[0],k[0]),g=Math.max(g,e[1]),g=Math.max(g,k[1]),g=Math.max(g,e[2]),g=Math.max(g,k[2]);this.maxVel=l+g}if(!this.useCpu){this.internalTex0=h(f,a,1,b(this.qLocalVelocity,this.qLocalVelocityDiv));this.internalTex1=
h(f,a,1,b(this.qVelocity,this.qVelocityDiv));e=this.qRotSpeed;for(var k=this.qScale,l=this.qScaleDiv,g=this.qRotSpeedDiv,p=this.qAlphaDiv,m=Array(4*e.length),n=0;n<e.length;n++)m[4*n]=e[n],m[4*n+1]=k[n],m[4*n+2]=0,m[4*n+3]=(255*l[n]<<16|255*g[n]<<8|255*p[n])/16777216;this.internalTex2=h(f,a,1,m)}e=this.qColor;k=this.qAlpha;l=Array(4*k.length);for(g=0;g<k.length;g++)l[4*g]=e[3*g],l[4*g+1]=e[3*g+1],l[4*g+2]=e[3*g+2],l[4*g+3]=k[g];this.internalTex3=h(f,a,1,l,pc.PIXELFORMAT_R8_G8_B8_A8,1,!0)},_initializeTextures:function(){this.colorMap&&
...
this.lightCube[3*c+2]=this.scene.ambientLight.data[2];d=this.scene._globalLights;for(c=0;c<d.length;c++)for(var h=0;6>h;h++){var p=Math.max(this.lightCubeDir[h].dot(d[c]._direction),0)*d[c]._intensity;this.lightCube[3*h]+=d[c]._color.data[0]*p;this.lightCube[3*h+1]+=d[c]._color.data[1]*p;this.lightCube[3*h+2]+=d[c]._color.data[2]*p}this.constantLightCube.setValue(this.lightCube)}this.scene&&this.camera!=this.scene._activeCamera&&(this.camera=this.scene._activeCamera,this.onChangeCamera());this.emitterShape===
...
new Float32Array(this.vertexBuffer.lock());if(this.meshInstance.node){c=this.meshInstance.node.worldTransform;for(d=0;12>d;d++)x.data[d]=c.data[d];K=this.meshInstance.node.localScale;F=Math.max(Math.max(K.x,K.y),K.z)}d=null===this.meshInstance.node||this.localSpace?pc.Vec3.ZERO:this.meshInstance.node.getPosition();var p=this.camera?this.camera._node.getPosition():pc.Vec3.ZERO,k,l,m,q,G,M,Y,T,W,O=this.precision-1;for(c=0;c<this.numParticles;c++){var H=Math.floor(this.vbCPU[c*this.numParticleVerts*
4+3]),S=this.particleTex[4*H+0+8*this.numParticlesPot];A.data[0]=S;A.data[1]=this.particleTex[4*H+1+8*this.numParticlesPot];A.data[2]=this.particleTex[4*H+2+8*this.numParticlesPot];var V=this.rate+(this.rate2-this.rate)*S,Q=this.lifetime,R=this.particleTex[4*H+3+4*this.numParticlesPot]+a,Z=Math.max(Math.min(R/Q,1),0),X=0,h=0,aa=0<R&&R<Q;aa?(h=Z*O,m=Math.floor(h),q=Math.ceil(h),h%=1,k=this.qRotSpeed[m],l=this.qRotSpeed[q],G=k+(l-k)*h,k=this.qRotSpeed2[m],l=this.qRotSpeed2[q],M=k+(l-k)*h,k=this.qScale[m],
l=this.qScale[q],X=k+(l-k)*h,k=this.qScale2[m],l=this.qScale2[q],Y=k+(l-k)*h,k=this.qAlpha[m],l=this.qAlpha[q],T=k+(l-k)*h,k=this.qAlpha2[m],l=this.qAlpha2[q],W=k+(l-k)*h,m*=3,q*=3,k=this.qLocalVelocity[m],l=this.qLocalVelocity[q],r.data[0]=k+(l-k)*h,k=this.qLocalVelocity[m+1],l=this.qLocalVelocity[q+1],r.data[1]=k+(l-k)*h,k=this.qLocalVelocity[m+2],l=this.qLocalVelocity[q+2],r.data[2]=k+(l-k)*h,k=this.qLocalVelocity2[m],l=this.qLocalVelocity2[q],v.data[0]=k+(l-k)*h,k=this.qLocalVelocity2[m+1],l=
this.qLocalVelocity2[q+1],v.data[1]=k+(l-k)*h,k=this.qLocalVelocity2[m+2],l=this.qLocalVelocity2[q+2],v.data[2]=k+(l-k)*h,k=this.qVelocity[m],l=this.qVelocity[q],n.data[0]=k+(l-k)*h,k=this.qVelocity[m+1],l=this.qVelocity[q+1],n.data[1]=k+(l-k)*h,k=this.qVelocity[m+2],l=this.qVelocity[q+2],n.data[2]=k+(l-k)*h,k=this.qVelocity2[m],l=this.qVelocity2[q],u.data[0]=k+(l-k)*h,k=this.qVelocity2[m+1],l=this.qVelocity2[q+1],u.data[1]=k+(l-k)*h,k=this.qVelocity2[m+2],l=this.qVelocity2[q+2],u.data[2]=k+(l-k)*
h,r.data[0]+=(v.data[0]-r.data[0])*A.data[0],r.data[1]+=(v.data[1]-r.data[1])*A.data[1],r.data[2]+=(v.data[2]-r.data[2])*A.data[2],0<this.initialVelocity&&(this.emitterShape===pc.EMITTERSHAPE_SPHERE?(J.copy(A).scale(2).sub(pc.Vec3.ONE).normalize(),r.add(J.scale(this.initialVelocity))):r.add(pc.Vec3.FORWARD.scale(this.initialVelocity))),n.data[0]+=(u.data[0]-n.data[0])*A.data[0],n.data[1]+=(u.data[1]-n.data[1])*A.data[1],n.data[2]+=(u.data[2]-n.data[2])*A.data[2],G+=(M-G)*A.data[1],X=(X+1E4*S%1*(Y-
X))*F,h=1E3*S%1*(W-T),this.meshInstance.node&&x.transformPoint(r,r),r.add(n.mul(K)),y.copy(r),z.data[0]=this.particleTex[4*H],z.data[1]=this.particleTex[4*H+1],z.data[2]=this.particleTex[4*H+2],t.copy(z).add(r.scale(a)),w.copy(t),this.particleTex[4*H]=w.data[0],this.particleTex[4*H+1]=w.data[1],this.particleTex[4*H+2]=w.data[2],this.particleTex[4*H+3]+=G*a,this.wrap&&this.wrapBounds&&(w.sub(d),w.data[0]=e(w.data[0],this.wrapBounds.data[0])-.5*this.wrapBounds.data[0],w.data[1]=e(w.data[1],this.wrapBounds.data[1])-
.5*this.wrapBounds.data[1],w.data[2]=e(w.data[2],this.wrapBounds.data[2])-.5*this.wrapBounds.data[2],w.add(d)),0<this.sort&&(1===this.sort?(D.copy(w).sub(p),this.particleDistance[H]=-(D.data[0]*D.data[0]+D.data[1]*D.data[1]+D.data[2]*D.data[2])):2===this.sort?this.particleDistance[H]=R:3===this.sort&&(this.particleDistance[H]=-R))):this.calcSpawnPosition(d,H);b?0>R&&(this.particleTex[4*H+3+8*this.numParticlesPot]=-1):(R>=Q&&(R-=Math.max(Q,(this.numParticles-1)*V),this.particleTex[4*H+3+8*this.numParticlesPot]=
...
function encodeFloatRGBA(e){var a=frac(e),b=frac(255*e),c=frac(65025*e);e=frac(160581375*e);a-=b/255;b-=c/255;return[a,b,c-e/255,e-e/255]}function encodeFloatRG(e){var a=frac(e);e=frac(255*e);return[a-e/255,e-e/255]};pc.extend(pc,function(){function e(a,c){return a.layer===c.layer&&a.drawOrder&&c.drawOrder?a.drawOrder-c.drawOrder:c.key-a.key}var a=function(a,c,d){this.device=a;this.library=a.getProgramLibrary();this.pickColor=new Float32Array(4);this.scene=null;this.drawCalls=[];this.clearOptions={color:[1,1,1,1],depth:1,flags:pc.CLEARFLAG_COLOR|pc.CLEARFLAG_DEPTH};this.resize(c,d);this._ignoreOpacityFor=null};a.prototype.getSelection=function(a,c,d,f){var b=this.device;"object"===typeof a?(f=a,a=f.x,c=f.y,d=
f.width,f=f.height):c=this._pickBufferTarget.height-(c+(f||1));d=d||1;f=f||1;var e=b.renderTarget;b.setRenderTarget(this._pickBufferTarget);b.updateBegin();var p=new Uint8Array(4*d*f);b.readPixels(a,c,d,f,p);b.updateEnd();b.setRenderTarget(e);a=[];for(c=0;c<d*f;c++)b=p[4*c+0]<<16|p[4*c+1]<<8|p[4*c+2],16777215!==b&&(b=this.drawCalls[b],-1===a.indexOf(b)&&a.push(b));return a};a.prototype.prepare=function(a,c){var b=this.device;this.scene=c;var f=b.renderTarget;b.setRenderTarget(this._pickBufferTarget);
b.updateBegin();b.setViewport(0,0,this._pickBufferTarget.width,this._pickBufferTarget.height);b.setScissor(0,0,this._pickBufferTarget.width,this._pickBufferTarget.height);b.clear(this.clearOptions);var g,h,p,l,k,m=b.scope,q=m.resolve("matrix_model"),n=m.resolve("texture_poseMap"),r=m.resolve("texture_poseMapSize"),u=m.resolve("skinPosOffset"),v=m.resolve("matrix_pose[0]"),A=m.resolve("uColor");g=m.resolve("matrix_projection");h=m.resolve("matrix_viewProjection");var z=m.resolve("texture_opacityMap"),
m=m.resolve("alpha_ref");l=a._node.getWorldTransform();p=a.getProjectionMatrix();l=l.clone().invert();k=new pc.Mat4;k.mul2(p,l);g.setValue(p.data);h.setValue(k.data);this.drawCalls=c.drawCalls.slice(0);this.drawCalls.sort(e);for(g=0;g<this.drawCalls.length;g++)if(this.drawCalls[g].command)this.drawCalls[g].command();else if(this.drawCalls[g].pick){p=this.drawCalls[g];h=p.mesh;l=p.material;k=h.primitive[pc.RENDERSTYLE_SOLID].type;var t=l instanceof pc.StandardMaterial||l instanceof pc.BasicMaterial;
k!==pc.PRIMITIVE_TRIANGLES&&k!==pc.PRIMITIVE_TRISTRIP&&k!==pc.PRIMITIVE_TRIFAN||!t||(b.setBlending(!1),b.setCullMode(l.cull),b.setDepthWrite(l.depthWrite),b.setDepthTest(l.depthTest),q.setValue(p.node.worldTransform.data),p.skinInstance&&(u.setValue(p.node.getPosition().data),b.supportsBoneTextures?(n.setValue(p.skinInstance.boneTexture),r.setValue([p.skinInstance.boneTexture.width,p.skinInstance.boneTexture.height])):v.setValue(p.skinInstance.matrixPalette)),l.opacityMap&&(z.setValue(l.opacityMap),
m.setValue(p===this._ignoreOpacityFor?0:l.alphaTest)),this.pickColor[0]=(g>>16&255)/255,this.pickColor[1]=(g>>8&255)/255,this.pickColor[2]=(g&255)/255,this.pickColor[3]=1,A.setValue(this.pickColor),k=p._shader[pc.SHADER_PICK],k||(k=this.library.getProgram("pick",{skin:!!p.skinInstance,screenSpace:p.screenSpace,opacityMap:!!l.opacityMap,opacityChannel:l.opacityMap?l.opacityMapChannel||"r":null}),p._shader[pc.SHADER_PICK]=k),b.setShader(k),b.setVertexBuffer(p.morphInstance&&p.morphInstance._vertexBuffer?
p.morphInstance._vertexBuffer:h.vertexBuffer,0),b.setIndexBuffer(h.indexBuffer[pc.RENDERSTYLE_SOLID]),b.draw(h.primitive[pc.RENDERSTYLE_SOLID]))}b.setViewport(0,0,b.width,b.height);b.setScissor(0,0,b.width,b.height);b.updateEnd();b.setRenderTarget(f)};a.prototype.resize=function(a,c){var b=new pc.Texture(this.device,{format:pc.PIXELFORMAT_R8_G8_B8_A8,width:a,height:c,mipmaps:!1,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST});this._pickBufferTarget=new pc.RenderTarget(this.device,b,{depth:!0})};
Object.defineProperty(a.prototype,"renderTarget",{get:function(){return this._pickBufferTarget}});Object.defineProperty(a.prototype,"width",{get:function(){return this._pickBufferTarget.width}});Object.defineProperty(a.prototype,"height",{get:function(){return this._pickBufferTarget.height}});return{Picker:a}}());var primitiveUv1Padding=.0625,primitiveUv1PaddingScale=1-2*primitiveUv1Padding;
pc.calculateNormals=function(e,a){var b=a.length/3,c=e.length/3,d,f,g,h,p=new pc.Vec3,l=new pc.Vec3,k=new pc.Vec3,m=new pc.Vec3,q=new pc.Vec3,n=new pc.Vec3;new pc.Vec3;var r=[];for(h=0;h<e.length;h++)r[h]=0;for(h=0;h<b;h++)d=a[3*h],f=a[3*h+1],g=a[3*h+2],p.set(e[3*d],e[3*d+1],e[3*d+2]),l.set(e[3*f],e[3*f+1],e[3*f+2]),k.set(e[3*g],e[3*g+1],e[3*g+2]),m.sub2(l,p),q.sub2(k,p),n.cross(m,q).normalize(),r[3*d]+=n.x,r[3*d+1]+=n.y,r[3*d+2]+=n.z,r[3*f]+=n.x,r[3*f+1]+=n.y,r[3*f+2]+=n.z,r[3*g]+=n.x,r[3*g+1]+=
n.y,r[3*g+2]+=n.z;for(h=0;h<c;h++)b=r[3*h],d=r[3*h+1],f=r[3*h+2],b=1/Math.sqrt(b*b+d*d+f*f),r[3*h]*=b,r[3*h+1]*=b,r[3*h+2]*=b;return r};
pc.calculateTangents=function(e,a,b,c){var d=c.length/3,f=e.length/3,g,h,p,l,k,m,q,n,r,u,v,A,z,t,w=new pc.Vec3,y=new pc.Vec3,x=new pc.Vec3,B=new pc.Vec3,C=new pc.Vec3,F=new pc.Vec2,K=new pc.Vec2,L=new pc.Vec2,J,G=new Float32Array(3*f),D=new Float32Array(3*f),M=[];for(J=0;J<d;J++)g=c[3*J],h=c[3*J+1],p=c[3*J+2],x.set(e[3*g],e[3*g+1],e[3*g+2]),B.set(e[3*h],e[3*h+1],e[3*h+2]),C.set(e[3*p],e[3*p+1],e[3*p+2]),F.set(b[2*g],b[2*g+1]),K.set(b[2*h],b[2*h+1]),L.set(b[2*p],b[2*p+1]),l=B.x-x.x,k=C.x-x.x,m=B.y-
x.y,q=C.y-x.y,n=B.z-x.z,r=C.z-x.z,u=K.x-F.x,v=L.x-F.x,A=K.y-F.y,z=L.y-F.y,t=u*z-v*A,0==t?(w.set(0,1,0),y.set(1,0,0)):(t=1/t,w.set((z*l-A*k)*t,(z*m-A*q)*t,(z*n-A*r)*t),y.set((u*k-v*l)*t,(u*q-v*m)*t,(u*r-v*n)*t)),G[3*g+0]+=w.x,G[3*g+1]+=w.y,G[3*g+2]+=w.z,G[3*h+0]+=w.x,G[3*h+1]+=w.y,G[3*h+2]+=w.z,G[3*p+0]+=w.x,G[3*p+1]+=w.y,G[3*p+2]+=w.z,D[3*g+0]+=y.x,D[3*g+1]+=y.y,D[3*g+2]+=y.z,D[3*h+0]+=y.x,D[3*h+1]+=y.y,D[3*h+2]+=y.z,D[3*p+0]+=y.x,D[3*p+1]+=y.y,D[3*p+2]+=y.z;A=new pc.Vec3;z=new pc.Vec3;e=new pc.Vec3;
...
n],g[2*n+1]),null!==h&&q.element[pc.SEMANTIC_TEXCOORD1].set(h[2*n],h[2*n+1]),null!==l&&q.element[pc.SEMANTIC_BLENDINDICES].set(l[2*n],l[2*n+1]),null!==k&&q.element[pc.SEMANTIC_BLENDWEIGHT].set(k[2*n],k[2*n+1]),q.next();q.end();c=null;if(d=null!==p)c=new pc.IndexBuffer(e,pc.INDEXFORMAT_UINT16,p.length),(new Uint16Array(c.lock())).set(p),c.unlock();e=new pc.BoundingBox;e.compute(a);a=new pc.Mesh;a.vertexBuffer=m;a.indexBuffer[0]=c;a.primitive[0].type=pc.PRIMITIVE_TRIANGLES;a.primitive[0].base=0;a.primitive[0].count=
d?p.length:b;a.primitive[0].indexed=d;a.aabb=e;return a};
pc.createTorus=function(e,a){var b=a&&void 0!==a.tubeRadius?a.tubeRadius:.2,c=a&&void 0!==a.ringRadius?a.ringRadius:.3,d=a&&void 0!==a.segments?a.segments:30,f=a&&void 0!==a.sides?a.sides:20,g,h,p,l,k,m,q,n,r,u,v=[],A=[],z=[],t=[];for(g=0;g<=f;g++)for(h=0;h<=d;h++)p=Math.cos(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),l=Math.sin(2*Math.PI*g/f)*b,k=Math.sin(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),m=Math.cos(2*Math.PI*h/d)*Math.cos(2*Math.PI*g/f),q=Math.sin(2*Math.PI*g/f),n=Math.sin(2*Math.PI*
h/d)*Math.cos(2*Math.PI*g/f),r=g/f,u=1-h/d,v.push(p,l,k),A.push(m,q,n),z.push(r,u),g<f&&h<d&&(p=g*(d+1)+h,l=(g+1)*(d+1)+h,k=g*(d+1)+(h+1),m=(g+1)*(d+1)+(h+1),t.push(p,l,k),t.push(l,m,k));b={normals:A,uvs:z,indices:t};pc.precalculatedTangents&&(b.tangents=pc.calculateTangents(v,A,z,t));return pc.createMesh(e,v,b)};
pc._createConeData=function(e,a,b,c,d,f){var g,h,p,l,k,m=new pc.Vec3,q=new pc.Vec3;p=new pc.Vec3;var n,r=[],u=[],v=[],A=[],z=[],t;if(0<b)for(g=0;g<=c;g++)for(h=0;h<=d;h++)t=h/d*2*Math.PI-Math.PI,n=Math.sin(t),t=Math.cos(t),k=new pc.Vec3(n*e,-b/2,t*e),l=new pc.Vec3(n*a,b/2,t*a),m.lerp(k,l,g/c),q.sub2(l,k).normalize(),n=new pc.Vec3(t,0,-n),p.cross(n,q).normalize(),r.push(m.x,m.y,m.z),u.push(p.x,p.y,p.z),l=h/d,k=g/c,v.push(l,k),n=k,k=l,l=n,l/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+
primitiveUv1Padding,A.push(l,k),g<c&&h<d&&(n=g*(d+1)+h,t=g*(d+1)+(h+1),l=(g+1)*(d+1)+h,k=(g+1)*(d+1)+(h+1),z.push(n,t,l),z.push(t,k,l));if(f){e=Math.floor(d/2);g=b/2;for(b=0;b<=e;b++)for(t=b*Math.PI*.5/e,n=Math.sin(t),t=Math.cos(t),m=0;m<=d;m++)f=2*m*Math.PI/d-Math.PI/2,l=Math.sin(f),f=Math.cos(f),f*=n,h=t,p=l*n,l=1-m/d,k=1-b/e,r.push(f*a,h*a+g,p*a),u.push(f,h,p),v.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=1/3,A.push(l,
k);q=(c+1)*(d+1);for(b=0;b<e;++b)for(m=0;m<d;++m)n=b*(d+1)+m,t=n+d+1,z.push(q+n+1,q+t,q+n),z.push(q+n+1,q+t+1,q+t);for(b=0;b<=e;b++)for(t=.5*Math.PI+b*Math.PI*.5/e,n=Math.sin(t),t=Math.cos(t),m=0;m<=d;m++)f=2*m*Math.PI/d-Math.PI/2,l=Math.sin(f),f=Math.cos(f),f*=n,h=t,p=l*n,l=1-m/d,k=1-b/e,r.push(f*a,h*a-g,p*a),u.push(f,h,p),v.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=2/3,A.push(l,k);q=(c+1)*(d+1)+(d+1)*(e+1);for(b=0;b<
e;++b)for(m=0;m<d;++m)n=b*(d+1)+m,t=n+d+1,z.push(q+n+1,q+t,q+n),z.push(q+n+1,q+t+1,q+t)}else{q=(c+1)*(d+1);if(0<e)for(g=0;g<d;g++)t=g/d*2*Math.PI,f=Math.sin(t),h=-b/2,p=Math.cos(t),l=1-(f+1)/2,k=(p+1)/2,r.push(f*e,h,p*e),u.push(0,-1,0),v.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=1/3,A.push(l,k),1<g&&z.push(q,q+g,q+g-1);q+=d;if(0<a)for(g=0;g<d;g++)t=g/d*2*Math.PI,f=Math.sin(t),h=b/2,p=Math.cos(t),l=1-(f+1)/2,k=(p+1)/2,r.push(f*
a,h,p*a),u.push(0,1,0),v.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=2/3,A.push(l,k),1<g&&z.push(q,q+g-1,q+g)}return{positions:r,normals:u,uvs:v,uvs1:A,indices:z}};
...
pc.createSphere=function(e,a){var b=a&&void 0!==a.radius?a.radius:.5,c=a&&void 0!==a.latitudeBands?a.latitudeBands:16,d=a&&void 0!==a.longitudeBands?a.longitudeBands:16,f,g,h,p,l,k,m,q,n,r=[],u=[],v=[],A=[];for(g=0;g<=c;g++)for(f=g*Math.PI/c,h=Math.sin(f),p=Math.cos(f),f=0;f<=d;f++)l=2*f*Math.PI/d-Math.PI/2,k=Math.sin(l),l=Math.cos(l),l*=h,m=p,k*=h,q=1-f/d,n=1-g/c,r.push(l*b,m*b,k*b),u.push(l,m,k),v.push(q,n);for(g=0;g<c;++g)for(f=0;f<d;++f)b=g*(d+1)+f,h=b+d+1,A.push(b+1,h,b),A.push(b+1,h+1,h);c=
...
pc.createPlane=function(e,a){var b=a&&void 0!==a.halfExtents?a.halfExtents:new pc.Vec2(.5,.5),c=a&&void 0!==a.widthSegments?a.widthSegments:5,d=a&&void 0!==a.lengthSegments?a.lengthSegments:5,f,g,h,p,l,k,m=[],q=[],n=[],r=[];for(f=0;f<=c;f++)for(g=0;g<=d;g++)h=-b.x+2*b.x*f/c,p=-(-b.y+2*b.y*g/d),l=f/c,k=g/d,m.push(h,0,p),q.push(0,1,0),n.push(l,k),f<c&&g<d&&(r.push(g+f*(c+1),g+(f+1)*(c+1),g+f*(c+1)+1),r.push(g+(f+1)*(c+1),g+(f+1)*(c+1)+1,g+f*(c+1)+1));b={normals:q,uvs:n,uvs1:n,indices:r};pc.precalculatedTangents&&
(b.tangents=pc.calculateTangents(m,q,n,r));return pc.createMesh(e,m,b)};
...
[5,0,6]],p=[[0,0,1],[0,0,-1],[0,1,0],[0,-1,0],[1,0,0],[-1,0,0]],l=[],k=[],m=[],q=[],n=[],b=function(a,b,c){var d,f,e,r,u=l.length/3;for(e=0;e<=b;e++)for(r=0;r<=c;r++){d=new pc.Vec3;f=new pc.Vec3;var v=new pc.Vec3,B=new pc.Vec3;d.lerp(g[h[a][0]],g[h[a][1]],e/b);f.lerp(g[h[a][0]],g[h[a][2]],r/c);v.sub2(f,g[h[a][0]]);B.add2(d,v);d=e/b;f=r/c;l.push(B.x,B.y,B.z);k.push(p[a][0],p[a][1],p[a][2]);m.push(d,f);d/=3;f/=3;d=d*primitiveUv1PaddingScale+primitiveUv1Padding;f=f*primitiveUv1PaddingScale+primitiveUv1Padding;
d+=a%3/3;f+=Math.floor(a/3)/3;q.push(d,f);e<b&&r<c&&(n.push(u+r+e*(b+1),u+r+(e+1)*(b+1),u+r+e*(b+1)+1),n.push(u+r+(e+1)*(b+1),u+r+(e+1)*(b+1)+1,u+r+e*(b+1)+1))}};b(0,c,f);b(1,c,f);b(2,c,d);b(3,c,d);b(4,d,f);b(5,d,f);c={normals:k,uvs:m,uvs1:q,indices:n};pc.precalculatedTangents&&(c.tangents=pc.calculateTangents(l,k,m,n));return pc.createMesh(e,l,c)};pc.Scene.defaultMaterial=new pc.StandardMaterial;pc.Scene.defaultMaterial.shadingModel=pc.SPECULAR_BLINN;pc.extend(pc,function(){var e=function(){this.name="";this.duration=0;this._nodes=[];this._nodeDict={}};e.prototype.getDuration=function(){return this.duration};e.prototype.getName=function(){return this.name};e.prototype.getNode=function(a){return this._nodeDict[a]};Object.defineProperty(e.prototype,"nodes",{get:function(){return this._nodes}});e.prototype.getNodes=function(){return this._nodes};e.prototype.setDuration=function(a){this.duration=a};e.prototype.setName=function(a){this.name=a};e.prototype.addNode=
...
0;this.looping=!0;this._interpolatedKeys=[];this._interpolatedKeyDict={};this._currKeyIndices={};this.graph=null;var d=this;b(a)};a.prototype.addTime=function(a){if(null!==this._animation){var b,d,f,e,h,p,l,k=this._animation._nodes;b=this._animation.duration;if(this._time!==b||this.looping){this._time+=a;if(this._time>b)for(this._time=this.looping?0:b,b=0;b<k.length;b++)d=k[b],f=d._name,this._currKeyIndices[f]=0;else if(0>this._time)for(this._time=this.looping?b:0,b=0;b<k.length;b++)d=k[b],f=d._name,
this._currKeyIndices[f]=d._keys.length-2;a=0<=a?1:-1;for(b=0;b<k.length;b++){d=k[b];f=d._name;d=d._keys;e=this._interpolatedKeyDict[f];l=!1;if(1!==d.length)for(var m=this._currKeyIndices[f];m<d.length-1&&0<=m;m+=a)if(h=d[m],p=d[m+1],h.time<=this._time&&p.time>=this._time){l=(this._time-h.time)/(p.time-h.time);e._pos.lerp(h.position,p.position,l);e._quat.slerp(h.rotation,p.rotation,l);e._scale.lerp(h.scale,p.scale,l);e._written=!0;this._currKeyIndices[f]=m;l=!0;break}if(1===d.length||!l&&0===this._time&&
...
function(f,e){f?b&&b(f):this._preloadScripts(e,function(){var f=d.open(a,e);c.loader.clearCache(a,"scene");c.loader.patch({resource:f,type:"scene"},c.assets);c.root.addChild(f.root);c.systems.rigidbody&&"undefined"!==typeof Ammo&&c.systems.rigidbody.setGravity(f._gravity.x,f._gravity.y,f._gravity.z);b&&b(null,f)})}.bind(this))},_preloadScripts:function(b,c){if(pc.script.legacy){var d=this;d.systems.script.preloading=!0;var f=this._getScriptReferences(b),e=0,l=f.length,k=new a(l),m,q=/^http(s)?:\/\//;
if(l)for(var n=function(a,b){a&&console.error(a);k.inc();k.done()&&(d.systems.script.preloading=!1,c())},e=0;e<l;e++)m=f[e],!q.test(m.toLowerCase())&&d._scriptPrefix&&(m=pc.path.join(d._scriptPrefix,f[e])),this.loader.load(m,"script",n);else d.systems.script.preloading=!1,c()}else c()},_parseApplicationProperties:function(a,b){a.useDevicePixelRatio||(a.useDevicePixelRatio=a.use_device_pixel_ratio);a.resolutionMode||(a.resolutionMode=a.resolution_mode);a.fillMode||(a.fillMode=a.fill_mode);a.vrPolyfillUrl||
...
if(c)for(var k=function(a,c){d--;a?b(a):0===d&&(f.onLibrariesLoaded(),b(null))},m=0;m<c;++m){var q=a[m];!e.test(q.toLowerCase())&&f._scriptPrefix&&(q=pc.path.join(f._scriptPrefix,q));this.loader.load(q,"script",k)}else b(null)},_parseAssets:function(a){var b=[],c={};if(pc.script.legacy)for(e in a)b.push(a[e]);else{for(var d=0;d<this.scriptsOrder.length;d++){var e=this.scriptsOrder[d];a[e]&&(c[e]=!0,b.push(a[e]))}for(e in a)c[e]||b.push(a[e])}for(d=0;d<b.length;d++)a=b[d],c=new pc.Asset(a.name,a.type,
...
a.animation.loop;c.animation.data.activate=a.animation.activate;c.animation.data.enabled=a.animation.enabled;var b={},f=a.animation.animations,e;for(e in f)f.hasOwnProperty(e)&&(b[e]=f[e]);c.animation.animations=b;b={};f=a.animation.animationsIndex;for(e in f)f.hasOwnProperty(e)&&(b[e]=f[e]);c.animation.animationsIndex=b},onBeforeRemove:function(a,c){c.onBeforeRemove()},onUpdate:function(a){var b=this.store,d;for(d in b)if(b.hasOwnProperty(d)){var f=b[d],e=f.data;e.enabled&&e.playing&&f.entity.enabled&&
...
var f={};d.forEach(function(a){f[a]=c[a]});if(f.clearColor&&"array"===pc.type(f.clearColor)){var e=f.clearColor;f.clearColor=new pc.Color(e[0],e[1],e[2],e[3])}f.rect&&"array"===pc.type(f.rect)&&(e=f.rect,f.rect=new pc.Vec4(e[0],e[1],e[2],e[3]));f.scissorRect&&"array"===pc.type(f.scissorRect)&&(e=f.scissorRect,f.scissorRect=new pc.Vec4(e[0],e[1],e[2],e[3]));f.activate&&(console.warn("WARNING: activate: Property is deprecated. Set enabled property instead."),f.enabled=f.activate);f.camera=new pc.Camera;
f._node=b.entity;f.camera.calculateTransform=function(a,c){return b._calculateTransform?b._calculateTransform(a,c):null};f.camera.calculateProjection=function(a,c){return b._calculateProjection?b._calculateProjection(a,c):null};f.postEffects=new pc.PostEffectQueue(this.app,b);a._super.initializeComponentData.call(this,b,f,d)},onBeforeRemove:function(a,c){this.removeCamera(c)},onRemove:function(a,c){c.camera=null},onUpdate:function(a){a=this.store;var b,d,e,g;if(this.app.vr)for(var h in a)b=a[h],d=
...
c){for(var b=[],e={},g=0;g<a.script._scripts.length;g++){var h=a.script._scripts[g],p=h.__scriptType.__name;b.push(p);var l={},k;for(k in h.__attributes)l[k]=h.__attributes[k];e[p]={enabled:h._enabled,attributes:l}}for(k in a.script._scriptsIndex)k.awayting&&b.splice(k.ind,0,k);return this.addComponent(c,{enabled:a.script.enabled,order:b,scripts:e})},_callComponentMethod:function(a,c){for(var b=0;b<this._components.length;b++)if(this._components[b].entity.enabled&&this._components[b].enabled)this._components[b][a](c)},
...
if(h.name&&b){for(var p in b)b.hasOwnProperty(p)&&this._createAccessor(b[p],c);a.script.data.attributes[h.name]=this._cloneAttributes(b)}break}}},_createAccessor:function(a,c){var b=this;a={name:a.name,value:a.value,type:a.type};b._convertAttributeValue(a);Object.defineProperty(c.instance,a.name,{get:function(){return a.value},set:function(d){var e=a.value;a.value=d;b._convertAttributeValue(a);c.instance.fire("set",a.name,e,a.value)},configurable:!0})},_updateAccessors:function(a,c){var b,e=a.script.scripts.length,
g,h=c.url,p,l;for(b=0;b<e;b++)if(p=a.script,l=p.scripts[b],l.url===h){b=l.name;l=l.attributes;if(b){if(l)for(g in l)l.hasOwnProperty(g)&&this._createAccessor(l[g],c);if(e=p.data.attributes[b])for(g in e)if(h=e[g],!(g in l))delete c.instance[h.name];else if(l[g].value!==h.value&&c.instance.onAttributeChanged)c.instance.onAttributeChanged(h.name,h.value,l[g].value);l?p.data.attributes[b]=this._cloneAttributes(l):delete p.data.attributes[b]}break}},_convertAttributeValue:function(a){if("rgb"===a.type||
...
d;b.collision&&(d=b.collision.shape,b.trigger&&(b.trigger.destroy(),delete b.trigger));if(d){this.body&&(this.system.removeBody(this.body),Ammo.destroy(this.body));var e=this.isStaticOrKinematic(),f=e?0:this.mass,k=new Ammo.btVector3(0,0,0);e||d.calculateLocalInertia(f,k);var e=b.getPosition(),m=b.getRotation();c.setValue(m.x,m.y,m.z,m.w);m=new Ammo.btTransform;m.setIdentity();m.getOrigin().setValue(e.x,e.y,e.z);m.setRotation(c);e=new Ammo.btDefaultMotionState(m);d=new Ammo.btRigidBodyConstructionInfo(f,
...
this.body;a&&this.data.simulationEnabled&&(this.system.removeBody(a),a.forceActivationState(pc.BODYSTATE_DISABLE_SIMULATION),this.data.simulationEnabled=!1)},applyForce:function(){var c,e,f,l,k,m;switch(arguments.length){case 1:c=arguments[0].x;e=arguments[0].y;f=arguments[0].z;break;case 2:c=arguments[0].x;e=arguments[0].y;f=arguments[0].z;l=arguments[1].x;k=arguments[1].y;m=arguments[1].z;break;case 3:c=arguments[0];e=arguments[1];f=arguments[2];break;case 6:c=arguments[0],e=arguments[1],f=arguments[2],
l=arguments[3],k=arguments[4],m=arguments[5]}var q=this.body;q&&(q.activate(),a.setValue(c,e,f),void 0!==l?(b.setValue(l,k,m),q.applyForce(a,b)):q.applyForce(a,d))},applyTorque:function(){var b,c,d;switch(arguments.length){case 1:b=arguments[0].x;c=arguments[0].y;d=arguments[0].z;break;case 3:b=arguments[0];c=arguments[1];d=arguments[2];break;default:console.error("ERROR: applyTorque: function takes 1 or 3 arguments");return}var e=this.body;e&&(e.activate(),a.setValue(b,c,d),e.applyTorque(a))},applyImpulse:function(){var c,
e,f,l,k,m;switch(arguments.length){case 1:c=arguments[0].x;e=arguments[0].y;f=arguments[0].z;break;case 2:c=arguments[0].x;e=arguments[0].y;f=arguments[0].z;l=arguments[1].x;k=arguments[1].y;m=arguments[1].z;break;case 3:c=arguments[0];e=arguments[1];f=arguments[2];break;case 6:c=arguments[0],e=arguments[1],f=arguments[2],l=arguments[0],k=arguments[1],m=arguments[2]}var q=this.body;q&&(q.activate(),a.setValue(c,e,f),void 0!==l?(b.setValue(l,k,m),q.applyImpulse(a,b)):q.applyImpulse(a,d))},applyTorqueImpulse:function(){var b,
...
b[d].entity,f=b[d].data;f.body&&f.body.isActive()&&f.enabled&&e.enabled&&(f.type===pc.BODYTYPE_DYNAMIC?e.rigidbody.syncBodyToEntity():f.type===pc.BODYTYPE_KINEMATIC&&e.rigidbody._updateKinematic(a))}a=this.dynamicsWorld.getDispatcher();var b=a.getNumManifolds(),g;c={};for(d=0;d<b;d++){var h=a.getManifoldByIndexInternal(d),k=h.getBody0(),l=h.getBody1(),e=Ammo.castObject(k,Ammo.btRigidBody),f=Ammo.castObject(l,Ammo.btRigidBody),e=e.entity,f=f.entity;if(e&&f){g=k.getCollisionFlags();var p=l.getCollisionFlags(),
m=h.getNumContacts(),x=[],l=[],B;if(0<m)if(g&pc.BODYFLAG_NORESPONSE_OBJECT||p&pc.BODYFLAG_NORESPONSE_OBJECT)B=e.collision?e.collision.hasEvent("triggerenter")||e.collision.hasEvent("triggerleave"):!1,k=f.collision?f.collision.hasEvent("triggerenter")||f.collision.hasEvent("triggerleave"):!1,B&&(h=this._storeCollision(e,f))&&(!e.collision||p&pc.BODYFLAG_NORESPONSE_OBJECT||e.collision.fire("triggerenter",f)),k&&(h=this._storeCollision(f,e))&&(!f.collision||g&pc.BODYFLAG_NORESPONSE_OBJECT||f.collision.fire("triggerenter",
e));else if(B=e.collision?e.collision.hasEvent("collisionstart")||e.collision.hasEvent("collisionend")||e.collision.hasEvent("contact"):!1,k=f.collision?f.collision.hasEvent("collisionstart")||f.collision.hasEvent("collisionend")||f.collision.hasEvent("contact"):!1,(p=this.hasEvent("contact"))||B||k){for(g=0;g<m;g++){var C=h.getContactPoint(g),F=this._createContactPointFromAmmo(C);if(B||k)C=this._createReverseContactPointFromAmmo(C),x.push(F),l.push(C);p&&(F=this._createSingleContactResult(e,f,F),
this.fire("contact",F))}B&&(m=this._createContactResult(f,x),e.collision&&e.collision.fire("contact",m),(h=this._storeCollision(e,f))&&e.collision&&e.collision.fire("collisionstart",m));k&&(l=this._createContactResult(e,l),f.collision&&f.collision.fire("contact",l),(h=this._storeCollision(f,e))&&f.collision&&f.collision.fire("collisionstart",l))}}}this._cleanOldCollisions();this.contactPointPool.freeAll();this.contactResultPool.freeAll();this.singleContactResultPool.freeAll()}});return{RIGIDBODY_TYPE_STATIC:"static",
...
b){if("undefined"!==typeof Ammo&&b.model){var c=b.model,d=new Ammo.btCompoundShape,e,f;for(e=0;e<c.meshInstances.length;e++){var g=c.meshInstances[e],h=g.mesh,l=h.indexBuffer[pc.RENDERSTYLE_SOLID],p=h.vertexBuffer,z=p.getFormat(),t=z.size/4,w;for(f=0;f<z.elements.length;f++){var y=z.elements[f];y.name===pc.SEMANTIC_POSITION&&(w=new Float32Array(p.lock(),y.offset))}var l=new Uint16Array(l.lock()),p=h.primitive[0].count/3,z=new Ammo.btVector3,y=new Ammo.btVector3,x=new Ammo.btVector3,B,C,F=h.primitive[0].base,
K=new Ammo.btTriangleMesh;for(f=0;f<p;f++)h=l[F+3*f]*t,B=l[F+3*f+1]*t,C=l[F+3*f+2]*t,z.setValue(w[h],w[h+1],w[h+2]),y.setValue(w[B],w[B+1],w[B+2]),x.setValue(w[C],w[C+1],w[C+2]),K.addTriangle(z,y,x,!0);f=new Ammo.btBvhTriangleMeshShape(K,!0);t=g.node.getWorldTransform().getScale();f.setLocalScaling(new Ammo.btVector3(t.x,t.y,t.z));t=g.node.getPosition();g=g.node.getRotation();l=new Ammo.btTransform;l.setIdentity();l.getOrigin().setValue(t.x,t.y,t.z);t=new Ammo.btQuaternion;t.setValue(g.x,g.y,g.z,
...
rotationSpeedGraph2:"curve",scaleGraph:"curve",scaleGraph2:"curve"};this.on("beforeremove",this.onRemove,this);pc.ComponentSystem.on("update",this.onUpdate,this)},a=pc.inherits(a,pc.ComponentSystem);pc.Component._buildAccessors(pc.ParticleSystemComponent.prototype,e);pc.extend(a.prototype,{initializeComponentData:function(b,c,d){var e={};d=[];var g=this.propertyTypes,h,p;for(p in c)c.hasOwnProperty(p)&&(d.push(p),e[p]=c[p]),"vec3"===g[p]?"array"===pc.type(e[p])&&(e[p]=new pc.Vec3(e[p][0],e[p][1],
e[p][2])):"curve"===g[p]?e[p]instanceof pc.Curve||(h=e[p].type,e[p]=new pc.Curve(e[p].keys),e[p].type=h):"curveset"!==g[p]||e[p]instanceof pc.CurveSet||(h=e[p].type,e[p]=new pc.CurveSet(e[p].keys),e[p].type=h);a._super.initializeComponentData.call(this,b,e,d)},cloneComponent:function(a,c){for(var b=a.particlesystem.data,e=this.schema,g={},h=0,p=e.length;h<p;h++){var l=e[h],k=b[l];k instanceof pc.Vec3||k instanceof pc.Curve||k instanceof pc.CurveSet?(k=k.clone(),g[l]=k):null!==k&&void 0!==k&&(g[l]=
k)}return this.addComponent(c,g)},onUpdate:function(a){var b=this.store,d,e,g=this.app.stats.particles,h;for(h in b)if(b.hasOwnProperty(h)){d=b[h];var p=d.entity;d=d.data;if(d.enabled&&p.enabled&&(p=d.model.emitter,p.meshInstance.visible&&!d.paused)){p.simTime+=a;d=0;p.simTime>p.fixedTimeStep&&(d=Math.floor(p.simTime/p.fixedTimeStep),p.simTime-=d*p.fixedTimeStep);if(d){d=Math.min(d,p.maxSubSteps);for(e=0;e<d;e++)p.addTime(p.fixedTimeStep);g._updatesPerFrame+=d;g._frameTime+=p._addTimeTime;p._addTimeTime=
0}p.finishFrame()}}},onRemove:function(a,c){var b=c.data;b.model&&(this.app.scene.removeModel(b.model),a.removeChild(b.model.getGraph()),b.model=null);c.emitter&&(c.emitter.destroy(),c.emitter=null)}});return{ParticleSystemComponentSystem:a}}());pc.extend(pc,function(){return{ParticleSystemComponentData:pc.inherits(function(){this.rate=this.numParticles=1;this.rate2=null;this.startAngle=0;this.startAngle2=null;this.lifetime=50;this.emitterExtents=new pc.Vec3;this.emitterRadius=0;this.emitterShape=pc.EMITTERSHAPE_BOX;this.initialVelocity=0;this.wrapBounds=new pc.Vec3;this.localSpace=!1;this.normalMapAsset=this.normalMap=this.colorMapAsset=this.colorMap=null;this.loop=!0;this.preWarm=!1;this.sort=0;this.mode=pc.PARTICLEMODE_GPU;this.scene=
...
e=b.length,g=0,h=0;this._positions.length=0;this._normals.length=0;this._uvs.length=0;for(var p=Number.MAX_VALUE,l=Number.MIN_VALUE,k=1,m=0;m<e;m++){var q=b.charCodeAt(m);if(10===q||13===q)h-=this._lineHeight,g=0,k++;else{var n,r,u,v;(r=c.chars[q])&&r.scale?(v=this._fontSize/r.scale,u=this._fontSize*r.xadvance/r.width,n=this._fontSize*r.xoffset/r.width,r=this._fontSize*r.yoffset/r.height):(u=.5,r=n=0,v=this._fontSize);this._positions[12*m+0]=g-n;this._positions[12*m+1]=h-r;this._positions[12*m+2]=
0;this._positions[12*m+3]=g-(n-v);this._positions[12*m+4]=h-r;this._positions[12*m+5]=0;this._positions[12*m+6]=g-(n-v);this._positions[12*m+7]=h-r+v;this._positions[12*m+8]=0;this._positions[12*m+9]=g-n;this._positions[12*m+10]=h-r+v;this._positions[12*m+11]=0;this.width=g-(n-v);this._positions[12*m+7]>l&&(l=this._positions[12*m+7]);this._positions[12*m+1]<p&&(p=this._positions[12*m+1]);this.height=l-p;g+=this._spacing*u;this._normals[12*m+0]=0;this._normals[12*m+1]=0;this._normals[12*m+2]=-1;this._normals[12*
m+3]=0;this._normals[12*m+4]=0;this._normals[12*m+5]=-1;this._normals[12*m+6]=0;this._normals[12*m+7]=0;this._normals[12*m+8]=-1;this._normals[12*m+9]=0;this._normals[12*m+10]=0;this._normals[12*m+11]=-1;q=this._getUv(q);this._uvs[8*m+0]=q[0];this._uvs[8*m+1]=q[1];this._uvs[8*m+2]=q[2];this._uvs[8*m+3]=q[1];this._uvs[8*m+4]=q[2];this._uvs[8*m+5]=q[3];this._uvs[8*m+6]=q[0];this._uvs[8*m+7]=q[3];this._indices.push(4*m,4*m+1,4*m+3);this._indices.push(4*m+2,4*m+3,4*m+1)}}c=this._element.pivot.data[0];
g=this._element.pivot.data[1];for(m=0;m<this._positions.length;m+=3)this._positions[m]-=c*this.width,this._positions[m+1]+=((1-g)*k-1)*this._lineHeight;this._noResize=!0;this._element.width=this.width;this._element.height=this.height;this._noResize=!1;e*=4;for(m=0;m<e;m++)d.element[pc.SEMANTIC_POSITION].set(this._positions[3*m+0],this._positions[3*m+1],this._positions[3*m+2]),d.element[pc.SEMANTIC_NORMAL].set(this._normals[3*m+0],this._normals[3*m+1],this._normals[3*m+2]),d.element[pc.SEMANTIC_TEXCOORD0].set(this._uvs[2*
m+0],this._uvs[2*m+1]),d.next();d.end();a.aabb.compute(this._positions)},_onFontAdded:function(a){this._system.app.assets.off("add:"+a.id,this._onFontAdded,this);a.id===this._fontAsset&&this._bindFont(a)},_bindFont:function(a){a.on("load",this._onFontLoad,this);a.on("change",this._onFontChange,this);a.on("remove",this._onFontRemove,this);a.resource?this._onFontLoad(a):this._system.app.assets.load(a)},_onFontLoad:function(a){this.font!==a.resource&&(this.font=a.resource)},_onFontChange:function(a){},
...
e,h){var f=d.resource,g;d.file&&(g=pc.path.getDirectory(d.getFileUrl()));e.name=d.name;e.parameters||this._createParameters(e);var k="path"===e.mapping_format;e.chunks=d.resource.chunks;e.parameters.forEach(function(l,q){var m;if("texture"===l.type){f._assetHandlers||(f._assetHandlers={});var p=f._assetHandlers[l.name];if(!l.data||l.data instanceof pc.Texture)p&&!l.data&&(h.off("load:"+p.id,p.bind),h.off("add:"+p.id,p.add),h.off("remove:"+p.id,p.remove),p.url&&(h.off("add:url:"+p.url,p.add),h.off("remove:url:"+
p.url,p.remove)),f._assetHandlers[l.name]=null);else if(k?d=h.getByUrl(pc.path.join(g,l.data)):(m=l.data,d=h.get(l.data)),p&&(h.off("load:"+p.id,p.bind),h.off("add:"+p.id,p.add),h.off("remove:"+p.id,p.remove),p.url&&(h.off("add:url:"+p.url,p.add),h.off("remove:url:"+p.url,p.remove)),f._assetHandlers[l.name]=null),p=f._assetHandlers[l.name]={id:m,url:k?pc.path.join(g,l.data):"",bind:function(a){e.parameters[q].data=a.resource;f[e.parameters[q].name]=a.resource;f.update()},add:function(a){h.load(a)},
remove:function(a){f[e.parameters[q].name]===a.resource&&(e.parameters[q].data=null,f[e.parameters[q].name]=null,f.update())}},m?(h.on("load:"+m,p.bind),h.on("remove:"+m,p.remove)):k&&(h.on("load:url:"+pc.path.join(g,l.data),p.bind),h.on("remove:url:"+pc.path.join(g,l.data),p.remove)),d)d.resource?p.bind(d):b[e.parameters[q].name]&&(m=a[b[e.parameters[q].name]])&&(e.parameters[q].data=m,f[e.parameters[q].name]=m),h.load(d);else if(m)h.once("add:"+m,p.add);else if(k)h.once("add:url:"+p.url,p.add)}else if("cubemap"===
l.type&&l.data&&!(l.data instanceof pc.Texture)){k?d=h.getByUrl(pc.path.join(g,l.data)):(m=l.data,d=h.get(l.data));var p=function(a){e.shadingModel===pc.SPECULAR_PHONG&&(a.loadFaces=!0);a.ready(u);h.load(a)},u=function(a){l.data=a.resource;1<a.resources.length&&(e.parameters.push({name:"prefilteredCubeMap128",data:a.resources[1]}),e.parameters.push({name:"prefilteredCubeMap64",data:a.resources[2]}),e.parameters.push({name:"prefilteredCubeMap32",data:a.resources[3]}),e.parameters.push({name:"prefilteredCubeMap16",
data:a.resources[4]}),e.parameters.push({name:"prefilteredCubeMap8",data:a.resources[5]}),e.parameters.push({name:"prefilteredCubeMap4",data:a.resources[6]}));f.init(e);a.off("load",c,f);a.on("load",c,f)};if(d)p(d);else if(m)h.once("add:"+m,p);else if(k)h.once("add:url:"+pc.path.join(g,l.data),function(a){a.ready(function(a){e.parameters[q].data=a.resource;f.init(e);a.off("load",c,f);a.on("load",c,f)});h.load(a)})}});f.init(e)}};return{MaterialHandler:d,getMaterialParamType:function(a){return e[a]}}}());pc.extend(pc,function(){var e=function(a){this._device=a};e.DEFAULT_MATERIAL=pc.Scene.defaultMaterial;e.prototype={load:function(a,b){pc.http.get(a,function(c,d){b&&(c?b(pc.string.format("Error loading model: {0} [{1}]",a,c)):b(null,d))})},open:function(a,b){if(b.model){if(1>=b.model.version)logERROR(pc.string.format("Asset: {0}, is an old model format. Upload source assets to re-import.",a));else if(2<=b.model.version)return(new pc.JsonModelParser(this._device)).parse(b);return null}},patch:function(a,
b){if(a.resource){var c=a.data;a.resource.meshInstances.forEach(function(d,e){if(c.mapping){var f=function(a){a.resource?d.material=a.resource:(a.once("load",f),b.load(a));a.once("remove",function(a){d.material===a.resource&&(d.material=pc.ModelHandler.DEFAULT_MATERIAL)})};if(c.mapping[e]){var h=c.mapping[e].material,p=c.mapping[e].path;if(void 0!==h)if(h)if(p=b.get(h))f(p);else b.once("add:"+h,f);else d.material=pc.ModelHandler.DEFAULT_MATERIAL;else if(p)if(h=a.getFileUrl(),h=pc.path.getDirectory(h),
...
d=Module._malloc(c),l=Module.HEAPU8,k,m=d/4,q=c%4,n=new Uint32Array(p.buffer,0,(c-q)/4),r=new Uint32Array(l.buffer);for(k=0;k<n.length;k++)r[m+k]=n[k];for(k=c-q;k<c;k++)l[d+k]=p[k];p=Module._crn_decompress_get_data(d,c);c=Module._crn_decompress_get_size(d,c);b=Module.HEAPU8.buffer.slice(p,p+c)}c=new Uint32Array(b,0,32);var d=c[4],p=c[3],l=Math.max(c[7],1),u=c[21],v=c[22];k=65024===c[28];var A=r=n=q=m=!1;if(4===c[20])if(827611204===u)e=pc.PIXELFORMAT_DXT1,m=!0;else if(894720068===u)e=pc.PIXELFORMAT_DXT5,
m=!0;else if(116===u)e=pc.PIXELFORMAT_RGBA32F,q=!0;else if(826496069===u)e=pc.PIXELFORMAT_ETC1,n=m=!0;else if(825438800===u||825504336===u)e=825438800===u?pc.PIXELFORMAT_PVRTC_2BPP_RGB_1:pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1,r=m=!0;else{if(825439312===u||825504848===u)e=825439312===u?pc.PIXELFORMAT_PVRTC_4BPP_RGB_1:pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1,A=m=!0}else 32===v&&(e=pc.PIXELFORMAT_R8_G8_B8_A8);if(!e)return c=new pc.Texture(this._device,{width:4,height:4,format:pc.PIXELFORMAT_R8_G8_B8});c=new pc.Texture(this._device,
{width:d,height:p,format:e,cubemap:k});k&&(c.addressU=pc.ADDRESS_CLAMP_TO_EDGE,c.addressV=pc.ADDRESS_CLAMP_TO_EDGE);for(var e=128,v=k?6:1,z,u=827611204===u?8:16,t,w=0;w<v;w++)for(var y=d,x=p,B=0;B<l;B++)m?n?z=Math.floor((y+3)/4)*Math.floor((x+3)/4)*8:r?z=Math.max(y,16)*Math.max(x,8)/4:A?z=Math.max(y,8)*Math.max(x,8)/2:(z=Math.floor((y+4-1)/4),t=Math.floor((x+4-1)/4),z*=t,z*=u):z=y*x*4,t=q?new Float32Array(b,e,z):new Uint8Array(b,e,z),k?(c._levels[B]||(c._levels[B]=[]),c._levels[B][w]=t):c._levels[B]=
t,e+=q?4*z:z,y=Math.max(.5*y,1),x=Math.max(.5*x,1);c.upload()}return c}},patch:function(b,d){var c=b.resource;c&&(c.name!==b.name&&(c.name=b.name),b.data.hasOwnProperty("minfilter")&&c.minFilter!==a[b.data.minfilter]&&(c.minFilter=a[b.data.minfilter]),b.data.hasOwnProperty("magfilter")&&c.magFilter!==a[b.data.magfilter]&&(c.magFilter=a[b.data.magfilter]),b.data.hasOwnProperty("addressu")&&c.addressU!==e[b.data.addressu]&&(c.addressU=e[b.data.addressu]),b.data.hasOwnProperty("addressv")&&c.addressV!==
...
this._parseNodes(a),c=this._parseSkins(a,b),e=this._parseMorphs(a,b),h=this._parseVertexBuffers(a,e.morphs),p=this._parseIndexBuffers(a,h),h=this._parseMeshes(a,c.skins,e.morphs,h,p.buffer,p.data);a=this._parseMeshInstances(a,b,h,c.skins,c.instances,e.morphs,e.instances);h=new pc.Model;h.graph=b[0];h.meshInstances=a;h.skinInstances=c.instances;h.morphInstances=e.instances;h.getGraph().syncHierarchy();return h},_parseNodes:function(a){a=a.model;var b=[],c;for(c=0;c<a.nodes.length;c++){var e=a.nodes[c],
h=new pc.GraphNode;h.setName(e.name);h.setLocalPosition(e.position[0],e.position[1],e.position[2]);h.setLocalEulerAngles(e.rotation[0],e.rotation[1],e.rotation[2]);h.setLocalScale(e.scale[0],e.scale[1],e.scale[2]);h.scaleCompensation=!!e.scaleCompensation;b.push(h)}for(c=1;c<a.parents.length;c++)b[a.parents[c]].addChild(b[c]);return b},_parseSkins:function(a,b){var c=a.model,d=[],e=[],p,l;!this._device.supportsBoneTextures&&0<c.skins.length&&(p=this._device.getBoneLimit(),pc.partitionSkin(c,null,
p));for(p=0;p<c.skins.length;p++){var k=c.skins[p],m=[];for(l=0;l<k.inverseBindMatrices.length;l++){var q=k.inverseBindMatrices[l];m[l]=new pc.Mat4(q[0],q[1],q[2],q[3],q[4],q[5],q[6],q[7],q[8],q[9],q[10],q[11],q[12],q[13],q[14],q[15])}k=new pc.Skin(this._device,m,k.boneNames);d.push(k);m=new pc.SkinInstance(k,b[0]);q=[];for(l=0;l<k.boneNames.length;l++){var n=b[0].findByName(k.boneNames[l]);q.push(n)}m.bones=q;e.push(m)}return{skins:d,instances:e}},_parseMorphs:function(a,b){var c=a.model,d=[],e=
[],p,l,k,m,q;if(c.morphs)for(p=0;p<c.morphs.length;p++){k=c.morphs[p].targets;q=[];for(l=0;l<k.length;l++){var n=k[l].aabb;m=n.min;n=n.max;m=new pc.BoundingBox(new pc.Vec3(.5*(n[0]+m[0]),.5*(n[1]+m[1]),.5*(n[2]+m[2])),new pc.Vec3(.5*(n[0]-m[0]),.5*(n[1]-m[1]),.5*(n[2]-m[2])));m=new pc.MorphTarget({indices:k[l].indices,deltaPositions:k[l].deltaPositions,deltaNormals:k[l].deltaNormals,name:k[l].name,aabb:m});q.push(m)}l=new pc.Morph(q);d.push(l);l=new pc.MorphInstance(l);e.push(l)}return{morphs:d,instances:e}},
_parseVertexBuffers:function(b,d){var c=b.model,e=[],h,p,l={position:pc.SEMANTIC_POSITION,normal:pc.SEMANTIC_NORMAL,tangent:pc.SEMANTIC_TANGENT,blendWeight:pc.SEMANTIC_BLENDWEIGHT,blendIndices:pc.SEMANTIC_BLENDINDICES,color:pc.SEMANTIC_COLOR,texCoord0:pc.SEMANTIC_TEXCOORD0,texCoord1:pc.SEMANTIC_TEXCOORD1,texCoord2:pc.SEMANTIC_TEXCOORD2,texCoord3:pc.SEMANTIC_TEXCOORD3,texCoord4:pc.SEMANTIC_TEXCOORD4,texCoord5:pc.SEMANTIC_TEXCOORD5,texCoord6:pc.SEMANTIC_TEXCOORD6,texCoord7:pc.SEMANTIC_TEXCOORD7},k,
m,q,n,r;for(k=0;k<c.vertices.length;k++){var u=c.vertices[k];if(u.position&&u.normal&&u.texCoord0){var v=[];for(m=0;m<c.meshes.length;m++)c.meshes[m].vertices===k&&(v=v.concat(c.meshes[m].indices));var A=pc.calculateTangents(u.position.data,u.normal.data,u.texCoord0.data,v);u.tangent={type:"float32",components:4,data:A};for(m=0;m<d.length;m++)for(q=0;q<d[m]._targets.length;q++){h=d[m]._targets[q];var z=new Float32Array(u.position.data.length);z.set(u.position.data);var t=new Float32Array(u.position.data.length);
t.set(u.normal.data);h.deltaTangents=new Float32Array(4*h.indices.length);for(n=0;n<h.indices.length;n++)r=h.indices[n],z[3*r]=u.position.data[3*r]+h.deltaPositions[3*n],z[3*r+1]=u.position.data[3*r+1]+h.deltaPositions[3*n+1],z[3*r+2]=u.position.data[3*r+2]+h.deltaPositions[3*n+2],t[3*r]=u.normal.data[3*r]+h.deltaNormals[3*n],t[3*r+1]=u.normal.data[3*r+1]+h.deltaNormals[3*n+1],t[3*r+2]=u.normal.data[3*r+2]+h.deltaNormals[3*n+2];z=pc.calculateTangents(z,t,u.texCoord0.data,v);for(n=0;n<h.indices.length;n++)r=
h.indices[n],h.deltaTangents[4*n]=z[4*r]-A[4*r],h.deltaTangents[4*n+1]=z[4*r+1]-A[4*r+1],h.deltaTangents[4*n+2]=z[4*r+2]-A[4*r+2],h.deltaTangents[4*n+3]=z[4*r+3]-A[4*r+3]}}m=[];for(p in u)h=u[p],q=h.type,this._device.supportsUnsignedByte||("uint8"===q&&(q="float32"),"int8"===q&&(q="float32")),m.push({semantic:l[p],components:h.components,type:a[q],normalize:l[p]===pc.SEMANTIC_COLOR});m=new pc.VertexFormat(this._device,m);q=u.position.data.length/u.position.components;n=new pc.VertexBuffer(this._device,
m,q);r=new pc.VertexIterator(n);for(m=0;m<q;m++){for(p in u)switch(h=u[p],h.components){case 1:r.element[l[p]].set(h.data[m]);break;case 2:r.element[l[p]].set(h.data[2*m],h.data[2*m+1]);break;case 3:r.element[l[p]].set(h.data[3*m],h.data[3*m+1],h.data[3*m+2]);break;case 4:r.element[l[p]].set(h.data[4*m],h.data[4*m+1],h.data[4*m+2],h.data[4*m+3])}r.next()}r.end();e.push(n)}return e},_parseIndexBuffers:function(a,b){var c=a.model,d=null,e=null,p,l=0;for(p=0;p<c.meshes.length;p++){var k=c.meshes[p];
void 0!==k.indices&&(l+=k.indices.length)}for(p=c=0;p<b.length;p++)c=Math.max(c,b[p].numVertices);0<l&&(65535<c&&this._device.extUintElement?(d=new pc.IndexBuffer(this._device,pc.INDEXFORMAT_UINT32,l),e=new Uint32Array(d.lock())):(d=new pc.IndexBuffer(this._device,pc.INDEXFORMAT_UINT16,l),e=new Uint16Array(d.lock())));return{buffer:d,data:e}},_parseMeshes:function(a,b,f,g,h,p){a=a.model;var c=[],d=0,m;for(m=0;m<a.meshes.length;m++){var q=a.meshes[m],n=q.aabb,r=n.min,n=n.max,r=new pc.BoundingBox(new pc.Vec3(.5*
(n[0]+r[0]),.5*(n[1]+r[1]),.5*(n[2]+r[2])),new pc.Vec3(.5*(n[0]-r[0]),.5*(n[1]-r[1]),.5*(n[2]-r[2]))),n=void 0!==q.indices,u=new pc.Mesh;u.vertexBuffer=g[q.vertices];u.indexBuffer[0]=n?h:null;u.primitive[0].type=e[q.type];u.primitive[0].base=n?q.base+d:q.base;u.primitive[0].count=q.count;u.primitive[0].indexed=n;u.skin=void 0!==q.skin?b[q.skin]:null;u.morph=void 0!==q.morph?f[q.morph]:null;u.aabb=r;n&&(p.set(q.indices,d),d+=q.indices.length);c.push(u)}null!==h&&h.unlock();return c},_parseMeshInstances:function(a,
b,e,g,h,p,l){a=a.model;var c=[],d;for(d=0;d<a.meshInstances.length;d++){var f=a.meshInstances[d],n=e[f.mesh],f=new pc.MeshInstance(b[f.node],n,pc.ModelHandler.DEFAULT_MATERIAL);if(n.skin){var r=g.indexOf(n.skin);f.skinInstance=h[r]}n.morph&&(n=p.indexOf(n.morph),f.morphInstance=l[n]);c.push(f)}return c}};return{JsonModelParser:b}}());pc.extend(pc,function(){var e=function(a){this._app=a};e.prototype={parse:function(a){var b={},c,d,e=null;for(c in a.entities)b[c]=this._createEntity(a.entities[c]),null===a.entities[c].parent&&(e=b[c]);for(c in a.entities){var g=a.entities[c].children.length;for(d=0;d<g;d++){var h=a.entities[c].children[d];b[h]&&b[c].addChild(b[h])}}this._openComponentData(e,a.entities);return e},_createEntity:function(a){var b=new pc.Entity,c=a.position,d=a.rotation,e=a.scale;b.name=a.name;b._guid=a.resource_id;
...
h.area&&(c=h.area.x,e=h.area.y,f=h.area.z,g=h.area.uv)}else a.model._area&&(h=a.model,h._area&&(c=h._area.x,e=h._area.y,f=h._area.z,g=h._area.uv));h=a.model.lightmapSizeMultiplier||1;c*=h;e*=h;f*=h;d.copy(a.localScale);for(a=a._parent;a;)d.mul(a.localScale),a=a._parent;d.x=Math.abs(d.x);d.y=Math.abs(d.y);d.z=Math.abs(d.z);c=c*d.y*d.z+e*d.x*d.z+f*d.x*d.y;c=Math.sqrt(c/g);return Math.min(pc.math.nextPowerOfTwo(c*b),this.scene.lightmapMaxResolution||2048)},bake:function(k,q){var n,m,u=this.device,v=
this.scene,A=this._stats,z=1;void 0===q&&(q=pc.BAKE_COLORDIR);q===pc.BAKE_COLORDIR&&(z=2);var t,w=[],y=[];if(k){var x;for(n=b.length-1;0<=n;n--)for(m=0;m<k.length;m++)if(b[n]===k[m]){for(x=0;x<a[n].length;x++)a[n][x].destroy();a.splice(n,1);b.splice(n,1)}x=[];for(n=0;n<k.length;n++)e(k[n],x,y);k=x;e(this.root,null,null,w)}else{for(n=0;n<a.length;n++)for(m=0;m<a[n].length;m++)a[n][m].destroy();a=[];b=[];k=[];e(this.root,k,y,w)}if(0===k.length)u.fire("lightmapper:end",{timestamp:pc.now(),target:this});
else{x=!1;v._needsStaticPrepare&&(v._needsStaticPrepare=!1,x=!0);var B=[],C=[[],[]],F={},K,L;m=new pc.Texture(this.device,{width:4,height:4,format:pc.PIXELFORMAT_R8_G8_B8_A8,rgbm:!0});for(n=0;n<k.length;n++){K=this.calculateLightmapSize(k[n]);B.push(K);for(t=0;t<z;t++)L=new pc.Texture(u,{width:K,height:K,format:pc.PIXELFORMAT_R8_G8_B8_A8,mipmaps:!1,rgbm:0===t,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),C[t].push(L);if(!F[K]){var J=new pc.Texture(u,{width:K,height:K,format:pc.PIXELFORMAT_R8_G8_B8_A8,
mipmaps:!1,rgbm:!0,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),J=new pc.RenderTarget(u,J,{depth:!1});F[K]=J}}B=[];K=[];var J=[],G=[],D=v._lights;for(n=0;n<D.length;n++)D[n]._enabled&&(L=D[n]._mask,0!==(L&4)&&(K.push(L),J.push(D[n].shadowUpdateMode),D[n]._mask=4294967295,D[n].shadowUpdateMode=D[n]._type===pc.LIGHTTYPE_DIRECTIONAL?pc.SHADOWUPDATE_REALTIME:pc.SHADOWUPDATE_THISFRAME,B.push(D[n]),D[n].isStatic=!1)),G.push(D[n]._enabled),D[n].enabled=!1;var M=pc.shaderChunks,W=M.transformUv1VS,
Z=M.bakeLmEndPS;L=M.createShaderFromCode(u,M.fullscreenQuadVS,M.dilatePS,"lmDilate");var aa=u.scope.resolve("source"),S=u.scope.resolve("pixelOffset"),X=u.scope.resolve("bakeDir"),V=new pc.Vec2,N=v.drawCalls;for(n=0;n<N.length;n++)N[n].node&&N[n].node.getWorldTransform();var N=v.fog,ba=v.ambientLight.data[0],U=v.ambientLight.data[1],ca=v.ambientLight.data[2],ha=v.drawCalls;v.fog=pc.FOG_NONE;v.ambientLight.data[0]=0;v.ambientLight.data[1]=0;v.ambientLight.data[2]=0;c||(c=new pc.Camera,c._node=new pc.GraphNode,
c.clearColor[0]=0,c.clearColor[1]=0,c.clearColor[2]=0,c.clearColor[3]=0,c.clearDepth=1,c.clearFlags=pc.CLEARFLAG_COLOR,c.clearStencil=null,c.frustumCulling=!1);var E,I,P,da=[];da.length=b.length;var fa;for(E=0;E<w.length;E++){I=w[E].model.model.meshInstances;fa=[];for(n=0;n<I.length;n++)fa.push(I[n]._shaderDefs),I[n]._shaderDefs&=~(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM);for(n=0;n<b.length;n++)if(b[n]===w[E]){da[n]=fa;break}}fa=[];var ga=v.shadowCasters.slice();for(E=0;E<w.length;E++)fa[E]=w[E].model.castShadows,
w[E].model.castShadows=w[E].model.data.castShadowsLightmap;E=v.shadowCasters;I=[];var Y,T;for(n=0;n<E.length;n++){P=E[n];Y=new pc.MeshInstance(P.node,P.mesh,P.material);for(T in P)P.hasOwnProperty(T)&&(Y[T]=P[T]);I.push(Y)}v.shadowCasters=I;T=[];var ea=[];Y=[[],[]];var O,H,ia=[];ia.length=k.length;v.updateShadersFunc(u);for(E=0;E<k.length;E++)for(I=y[E],n=0;n<I.length;n++)t=I[n].material,T.push(t);for(t=0;t<z;t++)l[t]||(n=new pc.StandardMaterial,n.chunks.transformVS=W,0===t?(n.chunks.endPS=Z,n.ambient=
new pc.Color(0,0,0),n.ambientTint=!0,n.lightMap=m):(n.chunks.basePS=M.basePS+"\nuniform sampler2D texture_dirLightMap;\nuniform float bakeDir;\n",n.chunks.endPS=M.bakeDirLmEndPS),n.chunks.outputAlphaPS="\n",n.chunks.outputAlphaOpaquePS="\n",n.chunks.outputAlphaPremulPS="\n",n.cull=pc.CULLFACE_NONE,n.forceUv1=!0,n.update(),n.updateShader(u,v),n.name="lmMaterial"+t,l[t]=n);for(E=Z=0;E<k.length;E++){I=y[E];ia[E]=0;if(0<I.length)for(f.copy(I[0].aabb),n=0;n<I.length;n++)I[n].node.getWorldTransform(),f.add(I[n].aabb);
n=new pc.BoundingBox;n.copy(f);ea.push(n);for(n=0;n<I.length;n++)P=I[n],P._shaderDefs&=~(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM),P.mask=4,P.deleteParameter("texture_lightMap"),P.deleteParameter("texture_dirLightMap"),P.setParameter("texture_lightMap",T[Z].lightMap?T[Z].lightMap:m),P.setParameter("texture_dirLightMap",m),Z++;for(t=0;t<z;t++)M=C[t][E],W=new pc.RenderTarget(u,M,{depth:!1}),Y[t].push(W)}for(m=0;m<B.length;m++)B[m].enabled=!1;Z=!1;for(n=0;n<B.length;n++){B[n].enabled=!0;B[n]._cacheShadowMap=
!0;B[n]._type!==pc.LIGHTTYPE_DIRECTIONAL&&(B[n]._node.getWorldTransform(),B[n].getBoundingSphere(h),g.center=h.center,g.halfExtents.x=h.radius,g.halfExtents.y=h.radius,g.halfExtents.z=h.radius);B[n]._type===pc.LIGHTTYPE_SPOT&&(m=B[n],H=this.renderer.getShadowCamera(u,m),H._node.setPosition(m._node.getPosition()),H._node.setRotation(m._node.getRotation()),H._node.rotateLocal(-90,0,0),H.projection=pc.PROJECTION_PERSPECTIVE,H.nearClip=m.attenuationEnd/1E3,H.farClip=m.attenuationEnd,H.aspectRatio=1,H.fov=
2*m._outerConeAngle,this.renderer.updateCameraFrustum(H));for(E=0;E<k.length;E++){I=y[E];f=ea[E];v.drawCalls=[];for(m=0;m<I.length;m++)v.drawCalls.push(I[m]);v.updateShaders=!0;if(B[n]._type===pc.LIGHTTYPE_DIRECTIONAL)d.copy(f.center),d.y+=f.halfExtents.y,c._node.setPosition(d),c._node.setEulerAngles(-90,0,0),m=Math.max(f.halfExtents.x,f.halfExtents.z),c.projection=pc.PROJECTION_ORTHOGRAPHIC,c.nearClip=0,c.farClip=2*f.halfExtents.y,c.aspectRatio=1,c.orthoHeight=m;else if(!g.intersects(f))continue;
if(B[n]._type===pc.LIGHTTYPE_SPOT){t=!1;for(m=0;m<I.length;m++)if(this.renderer._isVisible(H,I[m])){t=!0;break}if(!t)continue}for(t=0;t<z;t++){M=C[t][E];W=Y[t][E];P=F[M.width];O=P.colorBuffer;0===t?Z=v.updateShaders:Z&&(v.updateShaders=!0);for(m=0;m<I.length;m++)I[m].material=l[t];c.renderTarget=P;1===t&&X.setValue(B[n].bakeDir?1:0);this.renderer._forwardTime=0;this.renderer._shadowMapTime=0;this.renderer.render(v,c);A.shadowMapTime+=this.renderer._shadowMapTime;A.forwardTime+=this.renderer._forwardTime;
A.renderPasses++;C[t][E]=O;Y[t][E]=P;F[M.width]=W;for(m=0;m<I.length;m++)P=I[m],P.setParameter(p[t],O),P._shaderDefs|=pc.SHADERDEF_LM}ia[E]++}B[n].enabled=!1;B[n]._cacheShadowMap=!1;B[n]._isCachedShadowMap&&B[n]._destroyShadowMap()}for(E=A=0;E<k.length;E++){I=y[E];H=[];for(t=0;t<z;t++){M=C[t][E];W=Y[t][E];P=F[M.width];O=P.colorBuffer;V.set(1/M.width,1/M.height);S.setValue(V.data);for(n=0;4>n;n++)aa.setValue(M),pc.drawQuadWithShader(u,P,L),aa.setValue(O),pc.drawQuadWithShader(u,W,L);for(n=0;n<I.length;n++)P=
I[n],0===t&&(P.mask=2,I[n].material=T[A],A++),I[n].setParameter(p[t],M),1===t&&(I[n]._shaderDefs|=pc.SHADERDEF_DIRLM);H[t]=M;t===z-1&&W.destroy()}a.push(H);b.push(k[E])}for(var ja in F)F.hasOwnProperty(ja)&&(F[ja].colorBuffer.destroy(),F[ja].destroy());for(n=0;n<a.length;n++)for(m=0;m<a[n].length;m++)L=a[n][m],L.minFilter=pc.FILTER_LINEAR,L.magFilter=pc.FILTER_LINEAR;for(E=0;E<w.length;E++)w[E].model.castShadows=fa[E];v.shadowCasters=ga;for(n=0;n<da.length;n++)if(da[n])for(I=b[n].model.model.meshInstances,
m=0;m<I.length;m++)I[m]._shaderDefs|=da[n][m]&(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM);for(n=0;n<B.length;n++)B[n]._mask=K[n],B[n].shadowUpdateMode=J[n];for(n=0;n<D.length;n++)D[n].enabled=G[n];v.drawCalls=ha;v.fog=N;v.ambientLight.data[0]=ba;v.ambientLight.data[1]=U;v.ambientLight.data[2]=ca;x&&(v._needsStaticPrepare=!0)}}};return{Lightmapper:k,MASK_DYNAMIC:1,MASK_BAKED:2,MASK_LIGHTMAP:4}}());
